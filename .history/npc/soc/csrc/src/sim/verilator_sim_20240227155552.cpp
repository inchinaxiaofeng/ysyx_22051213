...
#endif
VTopMain *sim_cpu = NULL;

extern CPU_state env_cpu;

inline void get_debug (CPU_state *state) {
    env_cpu.gpr[0]  = sim_cpu->gpr_zero;
    env_cpu.gpr[1]  = sim_cpu->gpr_ra;
    env_cpu.gpr[2]  = sim_cpu->gpr_sp;
    env_cpu.gpr[3]  = sim_cpu->gpr_gp;
    env_cpu.gpr[4]  = sim_cpu->gpr_tp;
    env_cpu.gpr[5]  = sim_cpu->gpr_t0;
    env_cpu.gpr[6]  = sim_cpu->gpr_t1;
    env_cpu.gpr[7]  = sim_cpu->gpr_t2;
    env_cpu.gpr[8]  = sim_cpu->gpr_s0;
    env_cpu.gpr[9]  = sim_cpu->gpr_s1;
    env_cpu.gpr[10] = sim_cpu->gpr_a0;
    env_cpu.gpr[11] = sim_cpu->gpr_a1;
    env_cpu.gpr[12] = sim_cpu->gpr_a2;
    env_cpu.gpr[13] = sim_cpu->gpr_a3;
    env_cpu.gpr[14] = sim_cpu->gpr_a4;
    env_cpu.gpr[15] = sim_cpu->gpr_a5;
    env_cpu.gpr[16] = sim_cpu->gpr_a6;
    env_cpu.gpr[17] = sim_cpu->gpr_a7;
    env_cpu.gpr[18] = sim_cpu->gpr_s2;
    env_cpu.gpr[19] = sim_cpu->gpr_s3;
    env_cpu.gpr[20] = sim_cpu->gpr_s4;
    env_cpu.gpr[21] = sim_cpu->gpr_s5;
    env_cpu.gpr[22] = sim_cpu->gpr_s6;
    env_cpu.gpr[23] = sim_cpu->gpr_s7;
    env_cpu.gpr[24] = sim_cpu->gpr_s8;
    env_cpu.gpr[25] = sim_cpu->gpr_s9;
    env_cpu.gpr[26] = sim_cpu->gpr_s10;
    env_cpu.gpr[27] = sim_cpu->gpr_s11;
    env_cpu.gpr[28] = sim_cpu->gpr_t3;
    env_cpu.gpr[29] = sim_cpu->gpr_t4;
    env_cpu.gpr[30] = sim_cpu->gpr_t5;
    env_cpu.gpr[31] = sim_cpu->gpr_t6;
