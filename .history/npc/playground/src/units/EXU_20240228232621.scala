...
//	val lsuTlbPF = WireInit(false.B)
	...
	csr.io.cfIn.exceptionVec(loadAddrMisaligned) := 0.U // lsu.io.ioLoadAddrMisaligned
	csr.io.cfIn.exceptionVec(storeAddrMisaligned) := 0.U // lsu.io.ioStoreAddrMisaligned
