...
class GPRState extends DifftestBaseBundle {
	val zero = Wire(UInt(XLEN.W)); val ra   = Wire(UInt(XLEN.W))
	val sp   = Wire(UInt(XLEN.W)); val gp   = Wire(UInt(XLEN.W))
	val tp   = Wire(UInt(XLEN.W)); val t0   = Wire(UInt(XLEN.W))
	val t1   = Wire(UInt(XLEN.W)); val t2   = Wire(UInt(XLEN.W))
	val s0   = Wire(UInt(XLEN.W)); val s1   = Wire(UInt(XLEN.W))
	val a0   = Wire(UInt(XLEN.W)); val a1   = Wire(UInt(XLEN.W))
	val a2   = Wire(UInt(XLEN.W)); val a3   = Wire(UInt(XLEN.W))
	val a4   = Wire(UInt(XLEN.W)); val a5   = Wire(UInt(XLEN.W))
	val a6   = Wire(UInt(XLEN.W)); val a7   = Wire(UInt(XLEN.W))
	val s2   = Wire(UInt(XLEN.W)); val s3   = Wire(UInt(XLEN.W))
	val s4   = Wire(UInt(XLEN.W)); val s5   = Wire(UInt(XLEN.W))
