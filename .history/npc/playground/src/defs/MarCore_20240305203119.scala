...
trait HasColorfulLog {
	val enable = Settings.get("IsChiselTest")
	val blackFG		= if (enable) "\u001b[30m" else "\\33[1;30m"
	val redFG		= if (enable) "\u001b[31m" else "\\33[1;31m"
	val greenFG		= if (enable) "\u001b[32m" else "\\33[1;32m"
	val yellowFG	= if (enable) "\u001b[33m" else "\\33[1;33m"
