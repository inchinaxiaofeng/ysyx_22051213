...
#define OLEN(cache_line_size) ceil(log2(cache_line_size))
#define ILEN(set_num) ceil(log2(set_num))
#define TLEN(olen, ilen) paddr_t-olen-ilen

#define SET_OFFSET_MASK(olen) (paddr_t)(pow(2, OLEN)-1)
