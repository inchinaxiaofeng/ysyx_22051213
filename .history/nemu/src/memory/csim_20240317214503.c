...
返回值
	当offset所指示的读取范围超出当前line的大小，返回false，表示cacheline越界读取
	当offset所指示的读取返回没有超出当前line的大小，返回true
行为
	当越界读取时，仅读取从offset开始的line内的内容，并设置返回值
*/
