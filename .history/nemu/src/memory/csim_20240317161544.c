...
*/
word_t do_cache_read_line(uint8_t level, paddr_t offset, paddr_t index, paddr_t way, int byte_len) {
...
void do_cache_write_line(uint8_t level, paddr_t offset, paddr_t index, paddr_t way, int byte_len) {
