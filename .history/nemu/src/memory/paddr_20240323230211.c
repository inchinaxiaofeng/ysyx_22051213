...
void static mtrace_display(paddr_t addr, int len, word_t data, bool is_write) {
  if (true == is_write) printf(ANSI_FG_MAGENTA"write:"ANSI_NONE"\n");
  else printf(ANSI_FG_MAGENTA"read:"ANSI_NONE"\n");
  printf(ANSI_FG_GREEN"paddr_t:"ANSI_NONE"\t"ANSI_FG_YELLOW"HEX:"ANSI_NONE ANSI_FG_YELLOW" 0x\033[0m%08x\t\n", addr);
