...
module AXI4Lite_Arbiter(	// <stdin>:4470:10
  ...
  wire _T = InstFetch_ar_valid & LoadStore_ar_valid;	// AXI4_Arbiter.scala:38:33
  wire _T_2 = InstFetch_ar_valid & ~LoadStore_ar_valid;	// AXI4_Arbiter.scala:45:{39,42}
  wire _T_4 = ~InstFetch_ar_valid & LoadStore_ar_valid;	// AXI4_Arbiter.scala:52:{20,40}
  wire _GEN = _T | ~_T_2 & _T_4;	// AXI4.scala:96:27, AXI4_Arbiter.scala:38:{33,56}, :40:33, :45:{39,63}, :49:41, :52:{40,63}
  assign InstFetch_ar_ready = ~_T & _T_2 & Arbiter_ar_ready;	// <stdin>:4470:10, AXI4_Arbiter.scala:38:{33,56}, :42:41, :45:{39,63}
  assign InstFetch_r_valid = ~_T & _T_2 & Arbiter_r_valid;	// <stdin>:4470:10, AXI4_Arbiter.scala:38:{33,56}, :42:41, :43:41, :45:{39,63}
  assign InstFetch_r_bits_data = _T | ~_T_2 ? 64'h0 : Arbiter_r_bits_data;	// <stdin>:4470:10, AXI4.scala:96:27, AXI4_Arbiter.scala:38:{33,56}, :45:{39,63}
  ...
  assign LoadStore_ar_ready = _GEN & Arbiter_ar_ready;	// <stdin>:4470:10, AXI4_Arbiter.scala:38:56, :40:33, :45:63
  assign LoadStore_r_valid = _GEN & Arbiter_r_valid;	// <stdin>:4470:10, AXI4_Arbiter.scala:38:56, :40:33, :41:41, :45:63
  assign LoadStore_r_bits_data = _T | ~(_T_2 | ~_T_4) ? Arbiter_r_bits_data : 64'h0;	// <stdin>:4470:10, AXI4.scala:96:27, AXI4_Arbiter.scala:38:{33,56}, :41:41, :45:{39,63}, :52:{40,63}
  ...
  assign Arbiter_ar_valid = _T ? LoadStore_ar_valid : _T_2 ? InstFetch_ar_valid : _T_4 & LoadStore_ar_valid;	// <stdin>:4470:10, AXI4_Arbiter.scala:38:{33,56}, :40:33, :45:{39,63}, :47:33, :52:{40,63}, :54:33, :61:41
  assign Arbiter_ar_bits_addr = _T ? LoadStore_ar_bits_addr : _T_2 ? InstFetch_ar_bits_addr : _T_4 ? LoadStore_ar_bits_addr
                : 32'h0;	// <stdin>:4470:10, AXI4.scala:73:27, AXI4_Arbiter.scala:38:{33,56}, :40:33, :45:{39,63}, :47:33, :52:{40,63}, :54:33
  assign Arbiter_r_ready = _T ? LoadStore_r_ready : _T_2 ? InstFetch_r_ready : _T_4 & LoadStore_r_ready;	// <stdin>:4470:10, AXI4_Arbiter.scala:38:{33,56}, :41:41, :45:{39,63}, :48:41, :52:{40,63}, :55:41, :62:41
endmodule

// external module MEM

module TP_SRAM(	// <stdin>:4537:10
  input         clock,
                reset,
                io_aw_valid,
  ...
  `ifndef SYNTHESIS	// <stdin>:4537:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
    ...
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4537:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4537:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4537:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4537:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4537:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4537:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4537:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4537:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4537:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4537:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4537:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4537:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4537:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4537:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  assign io_aw_ready = ~state_store;	// <stdin>:4537:10, TP_SRAM.scala:31:34, :47:30
  assign io_w_ready = ~state_store;	// <stdin>:4537:10, TP_SRAM.scala:31:34, :47:30
  assign io_b_valid = state_store;	// <stdin>:4537:10, TP_SRAM.scala:31:34
  assign io_ar_ready = ~state_load;	// <stdin>:4537:10, TP_SRAM.scala:30:33, :37:29
  assign io_r_valid = state_load;	// <stdin>:4537:10, TP_SRAM.scala:30:33
endmodule

module SimTop(	// <stdin>:4615:10
  input         clock,
                reset,
  output        io_commit,
  output [63:0] io_pc,
  ...
  `ifndef SYNTHESIS	// <stdin>:4615:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4615:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4615:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4615:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4615:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4615:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4615:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4615:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4615:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4615:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4615:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4615:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4615:10
        io_commit_REG = _RANDOM_0[0];	// SimTop.scala:50:29
        io_pc_REG = {_RANDOM_0[31:1], _RANDOM_1, _RANDOM_2[0]};	// SimTop.scala:50:29, :51:25
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4615:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4615:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  assign io_commit = io_commit_REG;	// <stdin>:4615:10, SimTop.scala:50:29
  assign io_pc = io_pc_REG;	// <stdin>:4615:10, SimTop.scala:51:25
  assign io_gpr_regs_0 = 64'h0;	// <stdin>:4615:10, SimTop.scala:28:29
endmodule
