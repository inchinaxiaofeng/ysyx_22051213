...
module IFU_embedded(	// <stdin>:2:10
  ...
  wire        _io_imem_r_ready_T_1;	// IFU.scala:52:41
  reg  [63:0] pc;	// IFU.scala:29:25
  wire        _T_5 = _io_imem_r_ready_T_1 & io_imem_r_valid;	// Decoupled.scala:52:35, IFU.scala:52:41
  wire [63:0] snpc = pc + 64'h4;	// IFU.scala:29:25, :31:23
  reg  [63:0] c;	// GTimer.scala:8:32
  assign _io_imem_r_ready_T_1 = io_out_ready | io_redirect_valid;	// IFU.scala:52:41
  ...
  `ifndef SYNTHESIS	// <stdin>:2:10
    always @(posedge clock) begin	// Debug.scala:34:43
      automatic logic [63:0] npc;	// IFU.scala:37:22
      ...
      npc = io_redirect_valid ? io_redirect_target : snpc;	// IFU.scala:31:23, :37:22
  ...
  assign io_flushVec = {4{io_redirect_valid}};	// <stdin>:2:10, IFU.scala:46:27
endmodule
...
module ISU(	// <stdin>:1744:10
  ...
  wire        forwardRfWen = io_forward_wb_rfWen & io_forward_valid;	// ISU.scala:30:48
  wire        dontForward = (|io_forward_fuType) & io_forward_fuType != 3'h1;	// ISU.scala:31:{46,62,84}
  wire        srcADependEX = (|io_in_0_bits_ctrl_rfSrcA) & io_in_0_bits_ctrl_rfSrcA == io_forward_wb_rfDest &
                forwardRfWen;	// ISU.scala:28:{75,94,106}, :30:48
  wire        srcBDependEX = (|io_in_0_bits_ctrl_rfSrcB) & io_in_0_bits_ctrl_rfSrcB == io_forward_wb_rfDest &
                forwardRfWen;	// ISU.scala:28:{75,94,106}, :30:48
  wire        srcAForwardNextCycle = srcADependEX & ~dontForward;	// ISU.scala:28:106, :31:62, :37:{49,52}
  wire        srcBForwardNextCycle = srcBDependEX & ~dontForward;	// ISU.scala:28:106, :31:62, :37:52, :38:49
  wire        srcAForward = (|io_in_0_bits_ctrl_rfSrcA) & io_in_0_bits_ctrl_rfSrcA == io_wb_rfDest & io_wb_rfWen &
                (~dontForward | ~srcADependEX);	// ISU.scala:28:{75,94,106}, :31:62, :39:{40,46,60}
  wire        srcBForward = (|io_in_0_bits_ctrl_rfSrcB) & io_in_0_bits_ctrl_rfSrcB == io_wb_rfDest & io_wb_rfWen &
                (~dontForward | ~srcBDependEX);	// ISU.scala:28:{75,94,106}, :31:62, :39:46, :40:{40,46,60}
  ...
  wire        _io_out_valid_T_1 = io_in_0_valid & (~(_srcAReady_T[0]) | srcAForwardNextCycle | srcAForward) &
                (~(_srcBReady_T[0]) | srcBForwardNextCycle | srcBForward);	// ISU.scala:37:49, :38:49, :39:40, :40:40, :43:{25,68}, :44:{25,68}, :45:53, RegisterFile.scala:28:43
  wire        _io_in_0_ready_T_1 = io_out_ready & _io_out_valid_T_1;	// Decoupled.scala:52:35, ISU.scala:45:53
  always @(posedge clock) begin
    if (reset)
      ...
      busy <= {busy[31:1] & ~(io_wb_rfWen & ~((|io_wb_rfDest) & io_wb_rfDest == io_forward_wb_rfDest &
                                                ...
                                                _isuFireSetMask_T_1[31:1] : 31'h0), 1'h0};	// <stdin>:1744:10, Cat.scala:33:92, Decoupled.scala:52:35, ISU.scala:28:{75,94,106}, :30:48, :71:{30,43,46}, :72:33, RegisterFile.scala:27:27, :29:{45,52}, :35:{36,38,50}
    end
  end // always @(posedge)
  ...
  assign io_in_0_ready = ~io_in_0_valid | _io_in_0_ready_T_1;	// <stdin>:1744:10, Decoupled.scala:52:35, ISU.scala:76:{27,43}
  assign io_out_valid = _io_out_valid_T_1;	// <stdin>:1744:10, ISU.scala:45:53
  ...
  assign io_out_bits_data_srcA = (io_in_0_bits_ctrl_srcAType ? io_in_0_bits_cf_pc : 64'h0) | (srcAForwardNextCycle ?
                ...
                io_in_0_bits_ctrl_rfSrcA == 5'h0 ? 64'h0 : _rf_ext_R32_data);	// <stdin>:1744:10, ISU.scala:37:49, :39:40, :53:{30,33}, Mux.scala:27:73, RegisterFile.scala:15:21, :16:{47,63}
  assign io_out_bits_data_srcB = (io_in_0_bits_ctrl_srcBType ? 64'h0 : io_in_0_bits_data_imm) | (srcBForwardNextCycle ?
                ...
                io_in_0_bits_ctrl_rfSrcB == 5'h0 ? 64'h0 : _rf_ext_R33_data);	// <stdin>:1744:10, ISU.scala:38:49, :40:40, :59:{30,33}, Mux.scala:27:73, RegisterFile.scala:15:21, :16:{47,63}
  assign io_out_bits_data_imm = io_in_0_bits_data_imm;	// <stdin>:1744:10
endmodule

module ALU(	// <stdin>:2065:10
  input         clock,
                reset,
                io_in_valid,
  ...
  wire [64:0]  adderRes = {1'h0, io_in_bits_srcA} + {1'h0, io_in_bits_srcB ^ {64{~(io_in_bits_ctrl[6])}}} + {64'h0,
                ~(io_in_bits_ctrl[6])};	// <stdin>:2065:10, ALU.scala:48:37, :77:27, :78:{33,42,68}, Bitwise.scala:77:12
  ...
  wire [5:0]   shamt = io_in_bits_ctrl[5] ? {1'h0, io_in_bits_srcB[4:0]} : io_in_bits_srcB[5:0];	// <stdin>:2065:10, ALU.scala:50:40, :91:{24,53,81}
  ...
  `ifndef SYNTHESIS	// <stdin>:2065:10
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_out_valid = io_in_valid;	// <stdin>:2065:10
  assign io_out_bits = io_in_bits_ctrl[4] ? ((&(io_cfIn_instr[1:0])) ? io_cfIn_pc + 64'h4 : io_cfIn_pc + 64'h2) :
                io_in_bits_ctrl[5] ? {{32{_GEN_0[31]}}, _GEN_0[31:0]} : _GEN_0;	// <stdin>:2065:10, ALU.scala:50:40, :51:37, :106:{25,61}, :122:{35,42}, :125:{77,95}, :134:{27,38,77,114}, BitUtils.scala:17:32, Bitwise.scala:77:12, Mux.scala:81:58
  assign io_redirect_target = _io_redirect_target_T & io_in_bits_ctrl[3] ? ((&(io_cfIn_instr[1:0])) ? io_cfIn_pc + 64'h4
                : io_cfIn_pc + 64'h2) : io_in_bits_ctrl[3] ? io_cfIn_pc + io_offset : adderRes[63:0];	// <stdin>:2065:10, ALU.scala:52:40, :78:68, :117:{25,47}, :121:32, :122:{35,42}, :125:{34,42,58,77,95}
  assign io_redirect_valid = io_in_valid & io_in_bits_ctrl[4] & ~(_io_redirect_target_T & io_in_bits_ctrl[3]);	// <stdin>:2065:10, ALU.scala:51:37, :52:40, :121:{31,32,39}, :127:45
endmodule

module LSExecUnit(	// <stdin>:2224:10
  input         clock,
                reset,
                io_in_valid,
  input  [63:0] io_in_bits_srcA,
  ...
  `ifndef SYNTHESIS	// <stdin>:2224:10
    always @(posedge clock) begin	// Debug.scala:34:43
    ...
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2224:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2224:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2224:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2224:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2224:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2224:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2224:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2224:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2224:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2224:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2224:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2224:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2224:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2224:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2224:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2224:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2224:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2224:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2224:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2224:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2224:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2224:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2224:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2224:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_out_valid = _io_out_valid_T_10;	// <stdin>:2224:10, UnpipelinedLSU.scala:367:28
  assign io_out_bits = partialLoad ? (io_in_bits_ctrl == 7'h0 ? {{56{_rdataPartialLoad_T_20[7]}},
                ...
                64'h0) : io_dmem_r_bits_data;	// <stdin>:2224:10, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:282:20, :313:36, :399:52, :400:52, :413:27
  assign io_dmem_aw_valid = wValid;	// <stdin>:2224:10, UnpipelinedLSU.scala:357:89
  assign io_dmem_aw_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2224:10, AXI4.scala:73:27
  assign io_dmem_w_valid = wValid;	// <stdin>:2224:10, UnpipelinedLSU.scala:357:89
  assign io_dmem_w_bits_data = ((|(io_in_bits_ctrl[1:0])) ? 64'h0 : {2{{2{{2{io_wdata[7:0]}}}}}}) | (_reqWmask_T_1 ?
                ...
                ((&(io_in_bits_ctrl[1:0])) ? io_wdata : 64'h0);	// <stdin>:2224:10, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:287:48, :288:48, :289:48, :353:24
  assign io_dmem_w_bits_strb = reqWmask[7:0];	// <stdin>:2224:10, AXI4.scala:83:27, UnpipelinedLSU.scala:282:20
  assign io_dmem_ar_valid = io_in_valid & _io_in_ready_T & ~isStore & ~_io_ioLoadAddrMisaligned_T_3 &
                ~_io_ioStoreAddrMisaligned_T_2;	// <stdin>:2224:10, UnpipelinedLSU.scala:312:29, :313:27, :329:24, :357:{64,92}, :358:90, :421:69, :422:69
  assign io_dmem_ar_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2224:10, AXI4.scala:73:27
  assign io_ioLoadAddrMisaligned = _io_ioLoadAddrMisaligned_T_3;	// <stdin>:2224:10, UnpipelinedLSU.scala:421:69
  assign io_ioStoreAddrMisaligned = _io_ioStoreAddrMisaligned_T_2;	// <stdin>:2224:10, UnpipelinedLSU.scala:422:69
endmodule

module UnpipelinedLSU(	// <stdin>:2509:10
  input         clock,
                reset,
                io_in_valid,
  input  [63:0] io_in_bits_srcA,
...
module Multiplier(	// <stdin>:2623:10
  input  [64:0]  io_in_bits_0,
                 io_in_bits_1,
  output [129:0] io_out_bits);

  assign io_out_bits = {{65{io_in_bits_0[64]}}, io_in_bits_0} * {{65{io_in_bits_1[64]}}, io_in_bits_1};	// <stdin>:2623:10, MDU.scala:48:44
endmodule

module Divider(	// <stdin>:2636:10
  ...
  assign io_out_bits = {63'h0, $signed({io_in_bits_0[63], io_in_bits_0}) / $signed({io_in_bits_1[63],
                io_in_bits_1})};	// <stdin>:2636:10, MDU.scala:57:{21,46}
endmodule

module MDU(	// <stdin>:2649:10
  input  [63:0] io_in_bits_srcA,
                io_in_bits_srcB,
  input  [6:0]  io_in_bits_ctrl,
  output [63:0] io_out_bits);
  ...
  assign io_out_bits = io_in_bits_ctrl[3] ? {{32{res[31]}}, res[31:0]} : res;	// <stdin>:2649:10, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, MDU.scala:35:31, :120:18, :121:{27,44}
endmodule

module CSR(	// <stdin>:2758:10
  input         clock,
                reset,
                io_in_valid,
  input  [63:0] io_in_bits_srcA,
  ...
  wire [63:0] _wdata_T_22 = (io_in_bits_ctrl == 7'h1 ? io_in_bits_srcA : 64'h0) | (_justRead_T ? _rdata_T_18 |
                ...
                ~(io_cfIn_instr[19:15])} : 64'h0);	// <stdin>:2758:10, CSR.scala:232:41, :235:43, :236:{43,45}, :238:43, :239:{43,45}, Cat.scala:33:92, LookupTree.scala:8:38, Mux.scala:27:73
  wire        _wen_T_4 = io_in_valid & (|io_in_bits_ctrl) & (io_in_bits_srcB[11:0] != 12'h180 | _wdata_T_22[63:60]
                == 4'h0 | _wdata_T_22[63:60] == 4'h8);	// <stdin>:2758:10, CSR.scala:230:24, :243:{44,66,93,115}, :246:{34,51,60,71}, Mux.scala:27:73
  wire        isIllegalAccess = priviledgeMode < io_in_bits_srcB[9:8] | _wen_T_4 & (&(io_in_bits_srcB[11:10])) &
                ~((_justRead_T | _justRead_T_1) & io_in_bits_srcA == 64'h0);	// <stdin>:2758:10, CSR.scala:213:37, :246:51, :247:{44,50}, :248:{46,72,80}, :249:{42,51,64,67}, :250:45, LookupTree.scala:8:38
  ...
  assign _rdata_T_18 = (_resetSatp_T ? satp : 64'h0) | (_isIllegalAddr_illegalAddr_T_2 ? mcause : 64'h0) |
                ...
                mstatus : 64'h0) | (_isIllegalAddr_illegalAddr_T_8 ? mepc : 64'h0);	// <stdin>:2758:10, CSR.scala:172:34, :173:34, :175:34, :176:34, :206:27, LookupTree.scala:8:38, Mux.scala:27:73
  wire        resetSatp = _resetSatp_T & _wen_T_4;	// CSR.scala:246:51, :254:41, LookupTree.scala:8:38
  wire        _T_33 = io_in_bits_ctrl == 7'h0;	// CSR.scala:246:34, :259:52
  wire        _isEcall_T_2 = io_in_bits_srcB[11:0] == 12'h0 & _T_33;	// CSR.scala:230:24, :259:52, :260:{28,42}
  wire        _csrExpectionVec_3_T = io_in_valid & io_in_bits_srcB[11:0] == 12'h1 & _T_33;	// CSR.scala:230:24, :259:{29,52}, :272:52
  ...
  wire        _csrExpectionVec_2_T_1 = (~_isIllegalAddr_illegalAddr_T_8 & ~_isIllegalAddr_illegalAddr_T_6 &
  ...
  reg  [63:0] c_2;	// GTimer.scala:8:32
  reg  [63:0] c_3;	// GTimer.scala:8:32
  wire        _T_45 = io_in_valid & io_in_bits_srcB[11:0] == 12'h302 & _T_33;	// CSR.scala:230:24, :259:52, :261:27, :306:21
  reg  [63:0] c_4;	// GTimer.scala:8:32
  reg  [63:0] c_5;	// GTimer.scala:8:32
  always @(posedge clock) begin
    if (reset) begin
      mtvec <= 64'h0;	// <stdin>:2758:10, CSR.scala:172:34
      mcause <= 64'h0;	// <stdin>:2758:10, CSR.scala:173:34
      mepc <= 64'h0;	// <stdin>:2758:10, CSR.scala:175:34
      mstatus <= 64'hA00001800;	// CSR.scala:176:34
      satp <= 64'h0;	// <stdin>:2758:10, CSR.scala:206:27
      priviledgeMode <= 2'h3;	// CSR.scala:213:37
      c <= 64'h0;	// <stdin>:2758:10, GTimer.scala:8:32
      c_1 <= 64'h0;	// <stdin>:2758:10, GTimer.scala:8:32
      c_2 <= 64'h0;	// <stdin>:2758:10, GTimer.scala:8:32
      c_3 <= 64'h0;	// <stdin>:2758:10, GTimer.scala:8:32
      c_4 <= 64'h0;	// <stdin>:2758:10, GTimer.scala:8:32
      c_5 <= 64'h0;	// <stdin>:2758:10, GTimer.scala:8:32
    end
    else begin
      ...
      if (raiseExceptionIntr) begin	// CSR.scala:289:64
        ...
        mstatus <= {mstatus[63:13], priviledgeMode, mstatus[10:8], mstatus[3], mstatus[6:4], 1'h0,
                                                                mstatus[2:0]};	// <stdin>:2758:10, CSR.scala:176:34, :213:37, :313:39, :320:59, :334:39
        priviledgeMode <= 2'h3;	// CSR.scala:213:37
      end
        ...
        if (_T_45) begin	// CSR.scala:306:21
          mstatus <= {mstatus[63:13], 2'h0, mstatus[10:8], 1'h1, mstatus[6:4], mstatus[7], mstatus[2:0]};	// <stdin>:2758:10, CSR.scala:176:34, :279:74, :307:59, :313:39
          priviledgeMode <= mstatus[12:11];	// CSR.scala:176:34, :213:37, :307:59
        end
        else if (_T_10 & _isIllegalAddr_illegalAddr_T_6)	// CSR.scala:252:57, :306:21, LookupTree.scala:8:38, RegMap.scala:34:74
  ...
  `ifndef SYNTHESIS	// <stdin>:2758:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "raiseExceptionIntr ((%d||%d)&&%d)\n", |_GEN, 1'h0, io_instrValid);	// <stdin>:2758:10, CSR.scala:279:56, :282:48, Debug.scala:34:43, :35:31
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] CSR: ", c_2);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "valid (%d||%d||%d)\n", io_in_valid & _T_33, raiseExceptionIntr, resetSatp);	// CSR.scala:254:41, :259:52, :289:64, :294:44, Debug.scala:34:43, :35:31
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] CSR: ", c_3);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "resetSatp %b, raiseExceptionIntr %b\n", resetSatp, raiseExceptionIntr);	// CSR.scala:254:41, :289:64, Debug.scala:34:43, :35:31
      if ((`PRINTF_COND_) & _T_45 & ~reset)	// CSR.scala:306:21, Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] CSR: ", c_4);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_45 & ~reset)	// CSR.scala:306:21, Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "{Mret, set retTarget}\n");	// Debug.scala:34:43, :35:31
      if ((`PRINTF_COND_) & raiseExceptionIntr & ~reset)	// CSR.scala:289:64, Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] CSR: ", c_5);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & raiseExceptionIntr & ~reset)	// CSR.scala:289:64, Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "mepc: %x\n", io_cfIn_pc);	// Debug.scala:34:43, :35:31
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2758:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2758:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_21;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_22;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_23;	// <stdin>:2758:10
      automatic logic [31:0] _RANDOM_24;	// <stdin>:2758:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2758:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2758:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2758:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_9 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_10 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_11 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_12 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_13 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_14 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_15 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_16 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_17 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_18 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_19 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_20 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_21 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_22 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_23 = `RANDOM;	// <stdin>:2758:10
        _RANDOM_24 = `RANDOM;	// <stdin>:2758:10
        ...
        c_1 = {_RANDOM_14[31:2], _RANDOM_15, _RANDOM_16[1:0]};	// GTimer.scala:8:32
        c_2 = {_RANDOM_16[31:2], _RANDOM_17, _RANDOM_18[1:0]};	// GTimer.scala:8:32
        c_3 = {_RANDOM_18[31:2], _RANDOM_19, _RANDOM_20[1:0]};	// GTimer.scala:8:32
        c_4 = {_RANDOM_20[31:2], _RANDOM_21, _RANDOM_22[1:0]};	// GTimer.scala:8:32
        c_5 = {_RANDOM_22[31:2], _RANDOM_23, _RANDOM_24[1:0]};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2758:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2758:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_out_bits = _rdata_T_18;	// <stdin>:2758:10, Mux.scala:27:73
  assign io_redirect_target = resetSatp ? io_cfIn_pc + 64'h4 : raiseExceptionIntr ? mtvec : mepc;	// <stdin>:2758:10, CSR.scala:172:34, :175:34, :254:41, :289:64, :297:{34,57,67}
  assign io_redirect_valid = io_in_valid & _T_33 | raiseExceptionIntr | resetSatp;	// <stdin>:2758:10, CSR.scala:254:41, :259:52, :289:64, :293:{37,84}
  assign io_wenFix = |_GEN;	// <stdin>:2758:10, CSR.scala:279:56, :282:48
  assign io_csr_regs_0 = mstatus;	// <stdin>:2758:10, CSR.scala:176:34
  assign io_csr_regs_1 = mtvec;	// <stdin>:2758:10, CSR.scala:172:34
  assign io_csr_regs_2 = mepc;	// <stdin>:2758:10, CSR.scala:175:34
  assign io_csr_regs_3 = mcause;	// <stdin>:2758:10, CSR.scala:173:34
endmodule

module EXU(	// <stdin>:3618:10
  input         clock,
                reset,
                io_in_valid,
  ...
  always @(posedge clock) begin
    if (reset)
      c <= 64'h0;	// <stdin>:3618:10, GTimer.scala:8:32
    else
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:3618:10
    always @(posedge clock) begin	// Debug.scala:34:43
    ...
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3618:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3618:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3618:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3618:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3618:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3618:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3618:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3618:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3618:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3618:10
        c = {_RANDOM_0, _RANDOM_1};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3618:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3618:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  assign io_in_ready = ~io_in_valid | _io_out_valid_T_4;	// <stdin>:3618:10, EXU.scala:91:37, :102:{24,37}
  assign io_out_valid = _io_out_valid_T_4;	// <stdin>:3618:10, EXU.scala:91:37
  assign io_out_bits_decode_cf_instr = io_in_bits_cf_instr;	// <stdin>:3618:10
  assign io_out_bits_decode_cf_pc = io_in_bits_cf_pc;	// <stdin>:3618:10
  assign io_out_bits_decode_cf_redirect_target = _csr_io_redirect_valid ? _csr_io_redirect_target : _alu_io_redirect_target;	// <stdin>:3618:10, EXU.scala:33:25, :57:25, :84:20
  assign io_out_bits_decode_cf_redirect_valid = _csr_io_redirect_valid ? _csr_io_redirect_valid : _alu_io_redirect_valid;	// <stdin>:3618:10, EXU.scala:33:25, :57:25, :84:20
  assign io_out_bits_decode_ctrl_fuType = io_in_bits_ctrl_fuType;	// <stdin>:3618:10
  assign io_out_bits_decode_ctrl_rfWen = io_in_bits_ctrl_rfWen & (~_lsu_io_ioLoadAddrMisaligned & ~_lsu_io_ioStoreAddrMisaligned |
                ~_fuValids_1_T_3) & ~(_csr_io_wenFix & _fuValids_3_T_3);	// <stdin>:3618:10, EXU.scala:30:87, :42:25, :57:25, :75:{57,86,89,119,122,145,148,164}
  assign io_out_bits_decode_ctrl_rfDest = io_in_bits_ctrl_rfDest;	// <stdin>:3618:10
  assign io_out_bits_commits_0 = _alu_io_out_bits;	// <stdin>:3618:10, EXU.scala:33:25
  assign io_out_bits_commits_1 = _lsu_io_out_bits;	// <stdin>:3618:10, EXU.scala:42:25
  assign io_forward_valid = io_in_valid;	// <stdin>:3618:10
  assign io_forward_wb_rfWen = io_in_bits_ctrl_rfWen;	// <stdin>:3618:10
  assign io_forward_wb_rfDest = io_in_bits_ctrl_rfDest;	// <stdin>:3618:10
  assign io_forward_wb_rfData = _alu_io_out_valid ? _alu_io_out_bits : _lsu_io_out_bits;	// <stdin>:3618:10, EXU.scala:33:25, :42:25, :107:36
  assign io_forward_fuType = io_in_bits_ctrl_fuType;	// <stdin>:3618:10
endmodule

module WBU(	// <stdin>:3898:10
  input         clock,
                reset,
                io_in_valid,
  ...
  wire [4:0][63:0] _GEN = {{64'h0}, {io_in_bits_commits_3}, {io_in_bits_commits_2}, {io_in_bits_commits_1},
                {io_in_bits_commits_0}};	// <stdin>:3898:10, WBU.scala:19:22
  ...
  always @(posedge clock) begin
    if (reset)
      c <= 64'h0;	// <stdin>:3898:10, GTimer.scala:8:32
    else
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:3898:10
    always @(posedge clock) begin	// Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & io_in_valid & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "[COMMIT] pc = 0x%x inst %x wen %x wdst %x wdata %x mmio %x intrNO %x\n", io_in_bits_decode_cf_pc, io_in_bits_decode_cf_instr, _io_wb_rfWen_T, io_in_bits_decode_ctrl_rfDest, _GEN_1, 1'h0, 64'h0);	// <stdin>:3898:10, Debug.scala:34:43, :35:31, WBU.scala:17:53, :19:22
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3898:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3898:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3898:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3898:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3898:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3898:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3898:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3898:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3898:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3898:10
        c = {_RANDOM_0, _RANDOM_1};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3898:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3898:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_wb_rfWen = _io_wb_rfWen_T;	// <stdin>:3898:10, WBU.scala:17:53
  assign io_wb_rfDest = io_in_bits_decode_ctrl_rfDest;	// <stdin>:3898:10
  assign io_wb_rfData = _GEN_1;	// <stdin>:3898:10, WBU.scala:19:22
  assign io_redirect_target = io_in_bits_decode_cf_redirect_target;	// <stdin>:3898:10
  assign io_redirect_valid = io_in_bits_decode_cf_redirect_valid & io_in_valid;	// <stdin>:3898:10, WBU.scala:26:66
endmodule

module Backend_inorder(	// <stdin>:3930:10
  input         clock,
                reset,
                io_in_0_valid,
  input  [63:0] io_in_0_bits_cf_instr,
  ...
  wire        _wbu_io_wb_rfWen;	// Backend.scala:27:25
  ...
  wire [63:0] _exu_io_out_bits_decode_cf_pc;	// Backend.scala:26:25
  wire [63:0] _exu_io_out_bits_decode_cf_redirect_target;	// Backend.scala:26:25
  wire        _exu_io_out_bits_decode_cf_redirect_valid;	// Backend.scala:26:25
  wire [2:0]  _exu_io_out_bits_decode_ctrl_fuType;	// Backend.scala:26:25
  wire        _exu_io_out_bits_decode_ctrl_rfWen;	// Backend.scala:26:25
  wire [4:0]  _exu_io_out_bits_decode_ctrl_rfDest;	// Backend.scala:26:25
  wire [63:0] _exu_io_out_bits_commits_0;	// Backend.scala:26:25
  wire [63:0] _exu_io_out_bits_commits_1;	// Backend.scala:26:25
  wire [63:0] _exu_io_out_bits_commits_2;	// Backend.scala:26:25
  wire [63:0] _exu_io_out_bits_commits_3;	// Backend.scala:26:25
  wire        _exu_io_forward_valid;	// Backend.scala:26:25
  wire        _exu_io_forward_wb_rfWen;	// Backend.scala:26:25
  ...
  wire        _isu_io_out_bits_cf_exceptionVec_2;	// Backend.scala:25:25
  wire [2:0]  _isu_io_out_bits_ctrl_fuType;	// Backend.scala:25:25
  wire [6:0]  _isu_io_out_bits_ctrl_fuCtrl;	// Backend.scala:25:25
  wire        _isu_io_out_bits_ctrl_rfWen;	// Backend.scala:25:25
  wire [4:0]  _isu_io_out_bits_ctrl_rfDest;	// Backend.scala:25:25
  wire [63:0] _isu_io_out_bits_data_srcA;	// Backend.scala:25:25
  wire [63:0] _isu_io_out_bits_data_srcB;	// Backend.scala:25:25
  wire [63:0] _isu_io_out_bits_data_imm;	// Backend.scala:25:25
  reg         valid;	// Pipeline.scala:10:28
  ...
  always @(posedge clock) begin
    ...
    _exu_io_in_bits_T = _isu_io_out_valid & _exu_io_in_ready;	// Backend.scala:25:25, :26:25, Pipeline.scala:12:26
    if (reset) begin
      valid <= 1'h0;	// <stdin>:3930:10, Pipeline.scala:10:28
      valid_1 <= 1'h0;	// <stdin>:3930:10, Pipeline.scala:10:28
      c <= 64'h0;	// <stdin>:3930:10, GTimer.scala:8:32
      c_1 <= 64'h0;	// <stdin>:3930:10, GTimer.scala:8:32
    end
    else begin
      valid <= ~(io_flush[0]) & (_exu_io_in_bits_T | ~_exu_io_out_valid & valid);	// Backend.scala:26:25, :29:73, Pipeline.scala:10:28, :11:{29,37}, :12:{26,42,50}, :13:{24,32}
      valid_1 <= ~(io_flush[1]) & _exu_io_out_valid;	// Backend.scala:26:25, :30:64, Pipeline.scala:10:28, :12:42, :13:{24,32}
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
      c_1 <= c_1 + 64'h1;	// GTimer.scala:8:32, :9:24
    end
    if (_exu_io_in_bits_T) begin	// Pipeline.scala:12:26
      exu_io_in_bits_r_cf_instr <= _isu_io_out_bits_cf_instr;	// Backend.scala:25:25, Reg.scala:19:16
      exu_io_in_bits_r_cf_pc <= _isu_io_out_bits_cf_pc;	// Backend.scala:25:25, Reg.scala:19:16
      exu_io_in_bits_r_cf_exceptionVec_2 <= _isu_io_out_bits_cf_exceptionVec_2;	// Backend.scala:25:25, Reg.scala:19:16
      exu_io_in_bits_r_ctrl_fuType <= _isu_io_out_bits_ctrl_fuType;	// Backend.scala:25:25, Reg.scala:19:16
      exu_io_in_bits_r_ctrl_fuCtrl <= _isu_io_out_bits_ctrl_fuCtrl;	// Backend.scala:25:25, Reg.scala:19:16
      exu_io_in_bits_r_ctrl_rfWen <= _isu_io_out_bits_ctrl_rfWen;	// Backend.scala:25:25, Reg.scala:19:16
      exu_io_in_bits_r_ctrl_rfDest <= _isu_io_out_bits_ctrl_rfDest;	// Backend.scala:25:25, Reg.scala:19:16
      exu_io_in_bits_r_data_srcA <= _isu_io_out_bits_data_srcA;	// Backend.scala:25:25, Reg.scala:19:16
      exu_io_in_bits_r_data_srcB <= _isu_io_out_bits_data_srcB;	// Backend.scala:25:25, Reg.scala:19:16
      exu_io_in_bits_r_data_imm <= _isu_io_out_bits_data_imm;	// Backend.scala:25:25, Reg.scala:19:16
    end
    if (_exu_io_out_valid) begin	// Backend.scala:26:25
      wbu_io_in_bits_r_decode_cf_instr <= _exu_io_out_bits_decode_cf_instr;	// Backend.scala:26:25, Reg.scala:19:16
      wbu_io_in_bits_r_decode_cf_pc <= _exu_io_out_bits_decode_cf_pc;	// Backend.scala:26:25, Reg.scala:19:16
      wbu_io_in_bits_r_decode_cf_redirect_target <= _exu_io_out_bits_decode_cf_redirect_target;	// Backend.scala:26:25, Reg.scala:19:16
      wbu_io_in_bits_r_decode_cf_redirect_valid <= _exu_io_out_bits_decode_cf_redirect_valid;	// Backend.scala:26:25, Reg.scala:19:16
      wbu_io_in_bits_r_decode_ctrl_fuType <= _exu_io_out_bits_decode_ctrl_fuType;	// Backend.scala:26:25, Reg.scala:19:16
      wbu_io_in_bits_r_decode_ctrl_rfWen <= _exu_io_out_bits_decode_ctrl_rfWen;	// Backend.scala:26:25, Reg.scala:19:16
      wbu_io_in_bits_r_decode_ctrl_rfDest <= _exu_io_out_bits_decode_ctrl_rfDest;	// Backend.scala:26:25, Reg.scala:19:16
      wbu_io_in_bits_r_commits_0 <= _exu_io_out_bits_commits_0;	// Backend.scala:26:25, Reg.scala:19:16
      wbu_io_in_bits_r_commits_1 <= _exu_io_out_bits_commits_1;	// Backend.scala:26:25, Reg.scala:19:16
      wbu_io_in_bits_r_commits_2 <= _exu_io_out_bits_commits_2;	// Backend.scala:26:25, Reg.scala:19:16
      wbu_io_in_bits_r_commits_3 <= _exu_io_out_bits_commits_3;	// Backend.scala:26:25, Reg.scala:19:16
    end
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:3930:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "flush = %b, isu:(%d,%d), exu:(%d,%d)\n", io_flush, _isu_io_out_valid, _exu_io_in_ready, _exu_io_out_valid, 1'h1);	// <stdin>:3930:10, Backend.scala:25:25, :26:25, Debug.scala:34:43, :35:31
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3930:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3930:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_21;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_22;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_23;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_24;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_25;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_26;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_27;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_28;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_29;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_30;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_31;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_32;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_33;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_34;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_35;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_36;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_37;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_38;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_39;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_40;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_41;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_42;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_43;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_44;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_45;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_46;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_47;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_48;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_49;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_50;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_51;	// <stdin>:3930:10
      automatic logic [31:0] _RANDOM_52;	// <stdin>:3930:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3930:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3930:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3930:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_2 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_3 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_4 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_5 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_6 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_7 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_8 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_9 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_10 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_11 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_12 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_13 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_14 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_15 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_16 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_17 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_18 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_19 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_20 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_21 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_22 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_23 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_24 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_25 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_26 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_27 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_28 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_29 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_30 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_31 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_32 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_33 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_34 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_35 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_36 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_37 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_38 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_39 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_40 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_41 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_42 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_43 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_44 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_45 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_46 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_47 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_48 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_49 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_50 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_51 = `RANDOM;	// <stdin>:3930:10
        _RANDOM_52 = `RANDOM;	// <stdin>:3930:10
        valid = _RANDOM_0[0];	// Pipeline.scala:10:28
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3930:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3930:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ISU isu (	// Backend.scala:25:25
    .clock                          (clock),
    .reset                          (reset),
    ...
    .io_out_ready                   (_exu_io_in_ready),	// Backend.scala:26:25
    .io_wb_rfWen                    (_wbu_io_wb_rfWen),	// Backend.scala:27:25
    .io_wb_rfDest                   (_wbu_io_wb_rfDest),	// Backend.scala:27:25
    .io_wb_rfData                   (_wbu_io_wb_rfData),	// Backend.scala:27:25
    .io_forward_valid               (_exu_io_forward_valid),	// Backend.scala:26:25
    .io_forward_wb_rfWen            (_exu_io_forward_wb_rfWen),	// Backend.scala:26:25
    .io_forward_wb_rfDest           (_exu_io_forward_wb_rfDest),	// Backend.scala:26:25
  ...
  EXU exu (	// Backend.scala:26:25
    ...
    .io_flush                              (io_flush[1]),	// Backend.scala:30:64
    .io_dmem_aw_ready                      (io_dmem_aw_ready),
    .io_dmem_w_ready                       (io_dmem_w_ready),
    .io_dmem_b_valid                       (io_dmem_b_valid),
    .io_dmem_ar_ready                      (io_dmem_ar_ready),
...
module Core(	// <stdin>:4149:10
  ...
  wire        _backend_io_in_0_ready;	// TopMain.scala:37:37
  wire [63:0] _backend_io_redirect_target;	// TopMain.scala:37:37
  wire        _backend_io_redirect_valid;	// TopMain.scala:37:37
  wire        _frontend_io_out_0_valid;	// TopMain.scala:29:50
  wire [63:0] _frontend_io_out_0_bits_cf_instr;	// TopMain.scala:29:50
  wire [63:0] _frontend_io_out_0_bits_cf_pc;	// TopMain.scala:29:50
  wire        _frontend_io_out_0_bits_cf_exceptionVec_2;	// TopMain.scala:29:50
  wire        _frontend_io_out_0_bits_ctrl_srcAType;	// TopMain.scala:29:50
  wire        _frontend_io_out_0_bits_ctrl_srcBType;	// TopMain.scala:29:50
  wire [2:0]  _frontend_io_out_0_bits_ctrl_fuType;	// TopMain.scala:29:50
  wire [6:0]  _frontend_io_out_0_bits_ctrl_fuCtrl;	// TopMain.scala:29:50
  wire [4:0]  _frontend_io_out_0_bits_ctrl_rfSrcA;	// TopMain.scala:29:50
  wire [4:0]  _frontend_io_out_0_bits_ctrl_rfSrcB;	// TopMain.scala:29:50
  wire        _frontend_io_out_0_bits_ctrl_rfWen;	// TopMain.scala:29:50
  wire [4:0]  _frontend_io_out_0_bits_ctrl_rfDest;	// TopMain.scala:29:50
  wire [63:0] _frontend_io_out_0_bits_data_imm;	// TopMain.scala:29:50
  wire        _frontend_io_out_1_valid;	// TopMain.scala:29:50
  wire [63:0] _frontend_io_out_1_bits_cf_instr;	// TopMain.scala:29:50
  wire [63:0] _frontend_io_out_1_bits_cf_pc;	// TopMain.scala:29:50
  wire        _frontend_io_out_1_bits_cf_exceptionVec_2;	// TopMain.scala:29:50
  wire        _frontend_io_out_1_bits_ctrl_srcAType;	// TopMain.scala:29:50
  wire        _frontend_io_out_1_bits_ctrl_srcBType;	// TopMain.scala:29:50
  wire [2:0]  _frontend_io_out_1_bits_ctrl_fuType;	// TopMain.scala:29:50
  wire [6:0]  _frontend_io_out_1_bits_ctrl_fuCtrl;	// TopMain.scala:29:50
  wire [4:0]  _frontend_io_out_1_bits_ctrl_rfSrcA;	// TopMain.scala:29:50
  wire [4:0]  _frontend_io_out_1_bits_ctrl_rfSrcB;	// TopMain.scala:29:50
  wire        _frontend_io_out_1_bits_ctrl_rfWen;	// TopMain.scala:29:50
  wire [4:0]  _frontend_io_out_1_bits_ctrl_rfDest;	// TopMain.scala:29:50
  wire [63:0] _frontend_io_out_1_bits_data_imm;	// TopMain.scala:29:50
  wire [3:0]  _frontend_io_flushVec;	// TopMain.scala:29:50
  ...
  wire        ringBufferAllowin = ringBufferHead - 1'h1 != ringBufferTail & {1'h0, ringBufferHead} - 2'h2 != {1'h0,
                ringBufferTail};	// <stdin>:4149:10, PipelineVector.scala:13:45, :14:45, :16:{75,86,137}
  wire [1:0]  enqueueSize = {1'h0, _frontend_io_out_0_valid} + {1'h0, _frontend_io_out_1_valid};	// <stdin>:4149:10, PipelineVector.scala:23:56, TopMain.scala:29:50
  wire        _frontend_io_out_0_ready_T_1 = ringBufferAllowin | ~_frontend_io_out_0_valid;	// PipelineVector.scala:16:137, :33:{48,51}, TopMain.scala:29:50
  wire        _frontend_io_out_1_ready_T_1 = ringBufferAllowin | ~_frontend_io_out_1_valid;	// PipelineVector.scala:16:137, :34:{48,51}, TopMain.scala:29:50
  ...
  wire        _dequeueSize_T = _backend_io_in_0_ready & _backend_io_in_0_valid_T;	// Decoupled.scala:52:35, PipelineVector.scala:39:46, TopMain.scala:37:37
  reg  [63:0] c;	// GTimer.scala:8:32
  always @(posedge clock) begin
    if (reset) begin
      dataBuffer_0_cf_instr <= 64'h0;	// <stdin>:4149:10, PipelineVector.scala:12:41
      dataBuffer_0_cf_pc <= 64'h0;	// <stdin>:4149:10, PipelineVector.scala:12:41
      dataBuffer_0_cf_exceptionVec_2 <= 1'h0;	// <stdin>:4149:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_srcAType <= 1'h0;	// <stdin>:4149:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_srcBType <= 1'h0;	// <stdin>:4149:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_fuType <= 3'h0;	// PipelineVector.scala:12:{41,83}
      dataBuffer_0_ctrl_fuCtrl <= 7'h0;	// PipelineVector.scala:12:{41,83}
      dataBuffer_0_ctrl_rfSrcA <= 5'h0;	// PipelineVector.scala:12:{41,83}
      dataBuffer_0_ctrl_rfSrcB <= 5'h0;	// PipelineVector.scala:12:{41,83}
      dataBuffer_0_ctrl_rfWen <= 1'h0;	// <stdin>:4149:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfDest <= 5'h0;	// PipelineVector.scala:12:{41,83}
      dataBuffer_0_data_imm <= 64'h0;	// <stdin>:4149:10, PipelineVector.scala:12:41
      ringBufferHead <= 1'h0;	// <stdin>:4149:10, PipelineVector.scala:13:45
      ringBufferTail <= 1'h0;	// <stdin>:4149:10, PipelineVector.scala:14:45
      c <= 64'h0;	// <stdin>:4149:10, GTimer.scala:8:32
    end
    else begin
      automatic logic wen = _frontend_io_out_0_ready_T_1 & _frontend_io_out_0_valid | _frontend_io_out_1_ready_T_1 &
                                                _frontend_io_out_1_valid;	// Decoupled.scala:52:35, PipelineVector.scala:26:36, :33:48, :34:48, TopMain.scala:29:50
      if (wen) begin	// PipelineVector.scala:26:36
        if (enqueueSize[1]) begin	// PipelineVector.scala:23:56, :24:65
          dataBuffer_0_cf_instr <= _frontend_io_out_1_bits_cf_instr;	// PipelineVector.scala:12:41, TopMain.scala:29:50
          dataBuffer_0_cf_pc <= _frontend_io_out_1_bits_cf_pc;	// PipelineVector.scala:12:41, TopMain.scala:29:50
          dataBuffer_0_cf_exceptionVec_2 <= _frontend_io_out_1_bits_cf_exceptionVec_2;	// PipelineVector.scala:12:41, TopMain.scala:29:50
          dataBuffer_0_ctrl_srcAType <= _frontend_io_out_1_bits_ctrl_srcAType;	// PipelineVector.scala:12:41, TopMain.scala:29:50
          dataBuffer_0_ctrl_srcBType <= _frontend_io_out_1_bits_ctrl_srcBType;	// PipelineVector.scala:12:41, TopMain.scala:29:50
          dataBuffer_0_ctrl_fuType <= _frontend_io_out_1_bits_ctrl_fuType;	// PipelineVector.scala:12:41, TopMain.scala:29:50
          dataBuffer_0_ctrl_fuCtrl <= _frontend_io_out_1_bits_ctrl_fuCtrl;	// PipelineVector.scala:12:41, TopMain.scala:29:50
          dataBuffer_0_ctrl_rfSrcA <= _frontend_io_out_1_bits_ctrl_rfSrcA;	// PipelineVector.scala:12:41, TopMain.scala:29:50
          dataBuffer_0_ctrl_rfSrcB <= _frontend_io_out_1_bits_ctrl_rfSrcB;	// PipelineVector.scala:12:41, TopMain.scala:29:50
          dataBuffer_0_ctrl_rfWen <= _frontend_io_out_1_bits_ctrl_rfWen;	// PipelineVector.scala:12:41, TopMain.scala:29:50
          dataBuffer_0_ctrl_rfDest <= _frontend_io_out_1_bits_ctrl_rfDest;	// PipelineVector.scala:12:41, TopMain.scala:29:50
          dataBuffer_0_data_imm <= _frontend_io_out_1_bits_data_imm;	// PipelineVector.scala:12:41, TopMain.scala:29:50
        end
        else if (|enqueueSize) begin	// PipelineVector.scala:23:56, :24:65
          if (_frontend_io_out_0_valid) begin	// TopMain.scala:29:50
            dataBuffer_0_cf_instr <= _frontend_io_out_0_bits_cf_instr;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_cf_pc <= _frontend_io_out_0_bits_cf_pc;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_cf_exceptionVec_2 <= _frontend_io_out_0_bits_cf_exceptionVec_2;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_ctrl_srcAType <= _frontend_io_out_0_bits_ctrl_srcAType;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_ctrl_srcBType <= _frontend_io_out_0_bits_ctrl_srcBType;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_ctrl_fuType <= _frontend_io_out_0_bits_ctrl_fuType;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_ctrl_fuCtrl <= _frontend_io_out_0_bits_ctrl_fuCtrl;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_ctrl_rfSrcA <= _frontend_io_out_0_bits_ctrl_rfSrcA;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_ctrl_rfSrcB <= _frontend_io_out_0_bits_ctrl_rfSrcB;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_ctrl_rfWen <= _frontend_io_out_0_bits_ctrl_rfWen;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_ctrl_rfDest <= _frontend_io_out_0_bits_ctrl_rfDest;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_data_imm <= _frontend_io_out_0_bits_data_imm;	// PipelineVector.scala:12:41, TopMain.scala:29:50
          end
          else begin	// TopMain.scala:29:50
            dataBuffer_0_cf_instr <= _frontend_io_out_1_bits_cf_instr;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_cf_pc <= _frontend_io_out_1_bits_cf_pc;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_cf_exceptionVec_2 <= _frontend_io_out_1_bits_cf_exceptionVec_2;	// PipelineVector.scala:12:41, TopMain.scala:29:50
            dataBuffer_0_ctrl_srcAType <= _frontend_io_out_1_bits_ctrl_srcAType;	// PipelineVector.scala:12:41, TopMain.scala:29:50
      ...
      ringBufferHead <= ~(_frontend_io_flushVec[1]) & (wen ? ringBufferHead + enqueueSize[0] : ringBufferHead);	// PipelineVector.scala:13:45, :23:56, :26:36, :27:28, :30:{40,58}, :54:30, :55:36, TopMain.scala:29:50, :40:150
      ringBufferTail <= ~(_frontend_io_flushVec[1]) & (_dequeueSize_T ? ringBufferTail + _dequeueSize_T :
                                                ringBufferTail);	// Decoupled.scala:52:35, PipelineVector.scala:14:45, :27:28, :49:36, :50:{36,54}, :54:30, :55:36, :56:36, TopMain.scala:29:50, :40:150
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
    end
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:4149:10
    always @(posedge clock) begin	// PipelineVector.scala:60:27
      if ((`PRINTF_COND_) & ~reset)	// PipelineVector.scala:60:27
        $fwrite(32'h80000002, "[DPQ] size %x head %x tail %x enq %x deq %x\n", 1'h0, ringBufferHead, ringBufferTail, enqueueSize, {1'h0, _dequeueSize_T});	// <stdin>:4149:10, Decoupled.scala:52:35, PipelineVector.scala:13:45, :14:45, :23:56, :47:52, :60:27
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:35:31, PipelineVector.scala:60:27
        $fwrite(32'h80000002, "flush = %b, 0: frontend:(%d,%d), backend:(%d,%d); 1: frontend:(%d,%d), backend:(%d,%d)\n", _frontend_io_flushVec, _frontend_io_out_0_valid, _frontend_io_out_0_ready_T_1, _backend_io_in_0_valid_T, _backend_io_in_0_ready, _frontend_io_out_1_valid, _frontend_io_out_1_ready_T_1, _backend_io_in_1_valid_T_1, 1'h0);	// <stdin>:4149:10, Debug.scala:35:31, PipelineVector.scala:33:48, :34:48, :39:46, :44:66, :60:27, TopMain.scala:29:50, :37:37
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4149:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4149:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:4149:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:4149:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4149:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4149:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4149:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_3 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_4 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_5 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_6 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_7 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_8 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_9 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_10 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_11 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_12 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_13 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_14 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_15 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_16 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_17 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_18 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_19 = `RANDOM;	// <stdin>:4149:10
        _RANDOM_20 = `RANDOM;	// <stdin>:4149:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4149:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4149:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  Frontend_embedded frontend (	// TopMain.scala:29:50
    .clock                           (clock),
    .reset                           (reset),
    .io_imem_ar_ready                (io_imem_ar_ready),
    .io_imem_r_valid                 (io_imem_r_valid),
    ...
    .io_redirect_target              (_backend_io_redirect_target),	// TopMain.scala:37:37
    .io_redirect_valid               (_backend_io_redirect_valid),	// TopMain.scala:37:37
    .io_imem_ar_valid                (io_imem_ar_valid),
    .io_imem_ar_bits_addr            (io_imem_ar_bits_addr),
  ...
  Backend_inorder backend (	// TopMain.scala:37:37
    .clock                          (clock),
    .reset                          (reset),
    ...
    .io_flush                       (_frontend_io_flushVec[3:2]),	// TopMain.scala:29:50, :46:57
    .io_dmem_aw_ready               (io_dmem_aw_ready),
    .io_dmem_w_ready                (io_dmem_w_ready),
    .io_dmem_b_valid                (io_dmem_b_valid),
    .io_dmem_ar_ready               (io_dmem_ar_ready),
...
module AXI4Lite_Arbiter(	// <stdin>:4444:10
  ...
  assign InstFetch_ar_ready = ~_T & _T_2 & Arbiter_ar_ready;	// <stdin>:4444:10, AXI4_Arbiter.scala:28:{33,56}, :32:41, :35:{39,63}
  assign InstFetch_r_valid = ~_T & _T_2 & Arbiter_r_valid;	// <stdin>:4444:10, AXI4_Arbiter.scala:28:{33,56}, :32:41, :33:41, :35:{39,63}
  assign InstFetch_r_bits_data = _T | ~_T_2 ? 64'h0 : Arbiter_r_bits_data;	// <stdin>:4444:10, AXI4.scala:96:27, AXI4_Arbiter.scala:28:{33,56}, :35:{39,63}
  assign LoadStore_aw_ready = Arbiter_aw_ready;	// <stdin>:4444:10
  assign LoadStore_w_ready = Arbiter_w_ready;	// <stdin>:4444:10
  assign LoadStore_b_valid = Arbiter_b_valid;	// <stdin>:4444:10
  assign LoadStore_ar_ready = _GEN & Arbiter_ar_ready;	// <stdin>:4444:10, AXI4_Arbiter.scala:28:56, :30:33, :35:63
  assign LoadStore_r_valid = _GEN & Arbiter_r_valid;	// <stdin>:4444:10, AXI4_Arbiter.scala:28:56, :30:33, :31:41, :35:63
  assign LoadStore_r_bits_data = _T | ~(_T_2 | ~_T_4) ? Arbiter_r_bits_data : 64'h0;	// <stdin>:4444:10, AXI4.scala:96:27, AXI4_Arbiter.scala:28:{33,56}, :31:41, :35:{39,63}, :42:{40,63}
  assign Arbiter_aw_valid = LoadStore_aw_valid;	// <stdin>:4444:10
  assign Arbiter_aw_bits_addr = LoadStore_aw_bits_addr;	// <stdin>:4444:10
  assign Arbiter_w_valid = LoadStore_w_valid;	// <stdin>:4444:10
  assign Arbiter_w_bits_data = LoadStore_w_bits_data;	// <stdin>:4444:10
  assign Arbiter_w_bits_strb = LoadStore_w_bits_strb;	// <stdin>:4444:10
  assign Arbiter_ar_valid = _T ? LoadStore_ar_valid : _T_2 ? InstFetch_ar_valid : _T_4 & LoadStore_ar_valid;	// <stdin>:4444:10, AXI4_Arbiter.scala:28:{33,56}, :30:33, :35:{39,63}, :37:33, :42:{40,63}, :44:33, :51:41
  assign Arbiter_ar_bits_addr = _T ? LoadStore_ar_bits_addr : _T_2 ? InstFetch_ar_bits_addr : _T_4 ? LoadStore_ar_bits_addr
                : 32'h0;	// <stdin>:4444:10, AXI4.scala:73:27, AXI4_Arbiter.scala:28:{33,56}, :30:33, :35:{39,63}, :37:33, :42:{40,63}, :44:33
endmodule

// external module MEM

module TP_SRAM(	// <stdin>:4510:10
  input         clock,
                reset,
                io_aw_valid,
  ...
  `ifndef SYNTHESIS	// <stdin>:4510:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4510:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4510:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4510:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4510:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4510:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4510:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4510:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4510:10
        rWriteStatuOK = _RANDOM_0[0];	// TP_SRAM.scala:29:36
        rReadStatuOK = _RANDOM_0[1];	// TP_SRAM.scala:29:36, :30:36
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4510:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4510:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  assign io_aw_ready = io_aw_valid;	// <stdin>:4510:10
  assign io_w_ready = io_w_valid;	// <stdin>:4510:10
  assign io_b_valid = rWriteStatuOK;	// <stdin>:4510:10, TP_SRAM.scala:29:36
  assign io_ar_ready = io_ar_valid;	// <stdin>:4510:10
  assign io_r_valid = rReadStatuOK;	// <stdin>:4510:10, TP_SRAM.scala:30:36
endmodule

module SimTop(	// <stdin>:4553:10
  input         clock,
                reset,
  ...
  wire        _TP_SRAM_io_aw_ready;	// SimTop.scala:27:29
  wire        _TP_SRAM_io_w_ready;	// SimTop.scala:27:29
  wire        _TP_SRAM_io_b_valid;	// SimTop.scala:27:29
  wire        _TP_SRAM_io_ar_ready;	// SimTop.scala:27:29
  wire        _TP_SRAM_io_r_valid;	// SimTop.scala:27:29
  wire [63:0] _TP_SRAM_io_r_bits_data;	// SimTop.scala:27:29
  wire        _arbiter_InstFetch_ar_ready;	// SimTop.scala:26:29
  wire        _arbiter_InstFetch_r_valid;	// SimTop.scala:26:29
  wire [63:0] _arbiter_InstFetch_r_bits_data;	// SimTop.scala:26:29
  wire        _arbiter_LoadStore_aw_ready;	// SimTop.scala:26:29
  wire        _arbiter_LoadStore_w_ready;	// SimTop.scala:26:29
  wire        _arbiter_LoadStore_b_valid;	// SimTop.scala:26:29
  wire        _arbiter_LoadStore_ar_ready;	// SimTop.scala:26:29
  wire        _arbiter_LoadStore_r_valid;	// SimTop.scala:26:29
  wire [63:0] _arbiter_LoadStore_r_bits_data;	// SimTop.scala:26:29
  wire        _arbiter_Arbiter_aw_valid;	// SimTop.scala:26:29
  wire [31:0] _arbiter_Arbiter_aw_bits_addr;	// SimTop.scala:26:29
  wire        _arbiter_Arbiter_w_valid;	// SimTop.scala:26:29
  wire [63:0] _arbiter_Arbiter_w_bits_data;	// SimTop.scala:26:29
  wire [7:0]  _arbiter_Arbiter_w_bits_strb;	// SimTop.scala:26:29
  wire        _arbiter_Arbiter_ar_valid;	// SimTop.scala:26:29
  wire [31:0] _arbiter_Arbiter_ar_bits_addr;	// SimTop.scala:26:29
  wire        _core_io_imem_ar_valid;	// SimTop.scala:25:26
  wire [31:0] _core_io_imem_ar_bits_addr;	// SimTop.scala:25:26
  wire        _core_io_dmem_aw_valid;	// SimTop.scala:25:26
  wire [31:0] _core_io_dmem_aw_bits_addr;	// SimTop.scala:25:26
  wire        _core_io_dmem_w_valid;	// SimTop.scala:25:26
  wire [63:0] _core_io_dmem_w_bits_data;	// SimTop.scala:25:26
  wire [7:0]  _core_io_dmem_w_bits_strb;	// SimTop.scala:25:26
  wire        _core_io_dmem_ar_valid;	// SimTop.scala:25:26
  wire [31:0] _core_io_dmem_ar_bits_addr;	// SimTop.scala:25:26
  Core core (	// SimTop.scala:25:26
    .clock                (clock),
    .reset                (reset),
    .io_imem_ar_ready     (_arbiter_InstFetch_ar_ready),	// SimTop.scala:26:29
    .io_imem_r_valid      (_arbiter_InstFetch_r_valid),	// SimTop.scala:26:29
    .io_imem_r_bits_data  (_arbiter_InstFetch_r_bits_data),	// SimTop.scala:26:29
    .io_dmem_aw_ready     (_arbiter_LoadStore_aw_ready),	// SimTop.scala:26:29
    .io_dmem_w_ready      (_arbiter_LoadStore_w_ready),	// SimTop.scala:26:29
    .io_dmem_b_valid      (_arbiter_LoadStore_b_valid),	// SimTop.scala:26:29
    .io_dmem_ar_ready     (_arbiter_LoadStore_ar_ready),	// SimTop.scala:26:29
    .io_dmem_r_valid      (_arbiter_LoadStore_r_valid),	// SimTop.scala:26:29
    .io_dmem_r_bits_data  (_arbiter_LoadStore_r_bits_data),	// SimTop.scala:26:29
  ...
  AXI4Lite_Arbiter arbiter (	// SimTop.scala:26:29
    .InstFetch_ar_valid     (_core_io_imem_ar_valid),	// SimTop.scala:25:26
    .InstFetch_ar_bits_addr (_core_io_imem_ar_bits_addr),	// SimTop.scala:25:26
    .LoadStore_aw_valid     (_core_io_dmem_aw_valid),	// SimTop.scala:25:26
    .LoadStore_aw_bits_addr (_core_io_dmem_aw_bits_addr),	// SimTop.scala:25:26
    .LoadStore_w_valid      (_core_io_dmem_w_valid),	// SimTop.scala:25:26
    .LoadStore_w_bits_data  (_core_io_dmem_w_bits_data),	// SimTop.scala:25:26
    .LoadStore_w_bits_strb  (_core_io_dmem_w_bits_strb),	// SimTop.scala:25:26
    .LoadStore_ar_valid     (_core_io_dmem_ar_valid),	// SimTop.scala:25:26
    .LoadStore_ar_bits_addr (_core_io_dmem_ar_bits_addr),	// SimTop.scala:25:26
    .Arbiter_aw_ready       (_TP_SRAM_io_aw_ready),	// SimTop.scala:27:29
    .Arbiter_w_ready        (_TP_SRAM_io_w_ready),	// SimTop.scala:27:29
    .Arbiter_b_valid        (_TP_SRAM_io_b_valid),	// SimTop.scala:27:29
    .Arbiter_ar_ready       (_TP_SRAM_io_ar_ready),	// SimTop.scala:27:29
    .Arbiter_r_valid        (_TP_SRAM_io_r_valid),	// SimTop.scala:27:29
    .Arbiter_r_bits_data    (_TP_SRAM_io_r_bits_data),	// SimTop.scala:27:29
  ...
  TP_SRAM TP_SRAM (	// SimTop.scala:27:29
    .clock           (clock),
    .reset           (reset),
    .io_aw_valid     (_arbiter_Arbiter_aw_valid),	// SimTop.scala:26:29
    .io_aw_bits_addr (_arbiter_Arbiter_aw_bits_addr),	// SimTop.scala:26:29
    .io_w_valid      (_arbiter_Arbiter_w_valid),	// SimTop.scala:26:29
    .io_w_bits_data  (_arbiter_Arbiter_w_bits_data),	// SimTop.scala:26:29
    .io_w_bits_strb  (_arbiter_Arbiter_w_bits_strb),	// SimTop.scala:26:29
    .io_ar_valid     (_arbiter_Arbiter_ar_valid),	// SimTop.scala:26:29
    .io_ar_bits_addr (_arbiter_Arbiter_ar_bits_addr),	// SimTop.scala:26:29
  ...
  assign io_gpr_regs_0 = 64'h0;	// <stdin>:4553:10, SimTop.scala:26:29
endmodule
