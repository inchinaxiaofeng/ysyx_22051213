...
module WBU(	// <stdin>:3812:10
  ...
  assign io_redirect_valid = io_in_bits_decode_cf_redirect_valid & io_in_valid;	// <stdin>:3812:10, WBU.scala:24:66
endmodule

module Backend_inorder(	// <stdin>:3843:10
  input         clock,
                reset,
                io_in_0_valid,
  input  [63:0] io_in_0_bits_cf_instr,
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
      valid <= 1'h0;	// <stdin>:3843:10, Pipeline.scala:10:28
      valid_1 <= 1'h0;	// <stdin>:3843:10, Pipeline.scala:10:28
      c <= 64'h0;	// <stdin>:3843:10, GTimer.scala:8:32
      c_1 <= 64'h0;	// <stdin>:3843:10, GTimer.scala:8:32
      c_2 <= 64'h0;	// <stdin>:3843:10, GTimer.scala:8:32
      c_3 <= 64'h0;	// <stdin>:3843:10, GTimer.scala:8:32
    end
    else begin
  ...
  `ifndef SYNTHESIS	// <stdin>:3843:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "flush = %b, isu:(%d,%d), exu:(%d,%d)\n", io_flush, _isu_io_out_valid, _exu_io_in_ready, _exu_io_out_valid, 1'h1);	// <stdin>:3843:10, Backend.scala:25:25, :26:25, Debug.scala:34:43, :35:31
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3843:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3843:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_21;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_22;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_23;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_24;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_25;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_26;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_27;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_28;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_29;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_30;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_31;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_32;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_33;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_34;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_35;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_36;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_37;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_38;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_39;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_40;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_41;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_42;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_43;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_44;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_45;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_46;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_47;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_48;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_49;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_50;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_51;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_52;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_53;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_54;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_55;	// <stdin>:3843:10
      automatic logic [31:0] _RANDOM_56;	// <stdin>:3843:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3843:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3843:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3843:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_2 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_3 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_4 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_5 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_6 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_7 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_8 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_9 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_10 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_11 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_12 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_13 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_14 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_15 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_16 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_17 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_18 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_19 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_20 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_21 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_22 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_23 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_24 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_25 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_26 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_27 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_28 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_29 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_30 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_31 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_32 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_33 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_34 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_35 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_36 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_37 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_38 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_39 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_40 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_41 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_42 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_43 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_44 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_45 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_46 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_47 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_48 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_49 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_50 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_51 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_52 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_53 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_54 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_55 = `RANDOM;	// <stdin>:3843:10
        _RANDOM_56 = `RANDOM;	// <stdin>:3843:10
        valid = _RANDOM_0[0];	// Pipeline.scala:10:28
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3843:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3843:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
