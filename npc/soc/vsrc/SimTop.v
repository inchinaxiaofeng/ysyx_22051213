...
module CSR(	// <stdin>:2909:10
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      c <= 64'h0;	// <stdin>:2909:10, GTimer.scala:8:32
    end
    else begin
      ...
      if (raiseExceptionIntr) begin	// CSR.scala:287:64
        ...
        mstatus <= {mstatus[63:13], priviledgeMode, mstatus[10:8], mstatus[3], mstatus[6:4], 1'h0,
                                                                mstatus[2:0]};	// <stdin>:2909:10, CSR.scala:176:34, :213:37, :310:39, :316:59, :329:39
        priviledgeMode <= 2'h3;	// CSR.scala:213:37
      end
        ...
        if (io_in_valid & io_in_bits_srcB[11:0] == 12'h302 & _T_21) begin	// CSR.scala:230:24, :259:52, :261:27, :303:21
          mstatus <= {mstatus[63:13], 2'h0, mstatus[10:8], 1'h1, mstatus[6:4], mstatus[7], mstatus[2:0]};	// <stdin>:2909:10, CSR.scala:176:34, :279:74, :304:59, :310:39
  ...
  `ifndef SYNTHESIS	// <stdin>:2909:10
    ...
    initial begin	// <stdin>:2909:10
      ...
      automatic logic [31:0] _RANDOM_13;	// <stdin>:2909:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:2909:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2909:10
        ...
        _RANDOM_13 = `RANDOM;	// <stdin>:2909:10
        _RANDOM_14 = `RANDOM;	// <stdin>:2909:10
  ...
  assign io_redirect_valid = io_in_valid & _T_21 | raiseExceptionIntr | resetSatp;	// <stdin>:2909:10, CSR.scala:254:41, :259:52, :287:64, :290:{37,84}
...
module EXU(	// <stdin>:3664:10
  ...
  always @(posedge clock) begin
    if (reset)
      c <= 64'h0;	// <stdin>:3664:10, GTimer.scala:8:32
    else
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:3664:10
    always @(posedge clock) begin	// Debug.scala:34:43
    ...
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3664:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3664:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3664:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3664:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3664:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3664:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3664:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3664:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3664:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3664:10
        c = {_RANDOM_0, _RANDOM_1};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3664:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3664:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  assign io_in_ready = ~io_in_valid | _io_out_valid_T_4;	// <stdin>:3664:10, EXU.scala:91:37, :102:{24,37}
  assign io_out_valid = _io_out_valid_T_4;	// <stdin>:3664:10, EXU.scala:91:37
  assign io_out_bits_decode_cf_instr = io_in_bits_cf_instr;	// <stdin>:3664:10
  assign io_out_bits_decode_cf_pc = io_in_bits_cf_pc;	// <stdin>:3664:10
  assign io_out_bits_decode_cf_pnpc = io_in_bits_cf_pnpc;	// <stdin>:3664:10
  assign io_out_bits_decode_cf_redirect_target = _csr_io_redirect_valid ? _csr_io_redirect_target : _alu_io_redirect_target;	// <stdin>:3664:10, EXU.scala:33:25, :57:25, :84:20
  assign io_out_bits_decode_cf_redirect_valid = _csr_io_redirect_valid ? _csr_io_redirect_valid : _alu_io_redirect_valid;	// <stdin>:3664:10, EXU.scala:33:25, :57:25, :84:20
  assign io_out_bits_decode_ctrl_fuType = io_in_bits_ctrl_fuType;	// <stdin>:3664:10
  assign io_out_bits_decode_ctrl_rfWen = io_in_bits_ctrl_rfWen & (~_lsu_io_ioLoadAddrMisaligned & ~_lsu_io_ioStoreAddrMisaligned |
                ~_fuValids_1_T_3) & ~(_csr_io_wenFix & _fuValids_3_T_3);	// <stdin>:3664:10, EXU.scala:30:87, :42:25, :57:25, :75:{40,69,72,102,105,128,131,147}
  assign io_out_bits_decode_ctrl_rfDest = io_in_bits_ctrl_rfDest;	// <stdin>:3664:10
  assign io_out_bits_commits_0 = _alu_io_out_bits;	// <stdin>:3664:10, EXU.scala:33:25
  assign io_out_bits_commits_1 = _lsu_io_out_bits;	// <stdin>:3664:10, EXU.scala:42:25
  assign io_forward_valid = io_in_valid;	// <stdin>:3664:10
  assign io_forward_wb_rfWen = io_in_bits_ctrl_rfWen;	// <stdin>:3664:10
  assign io_forward_wb_rfDest = io_in_bits_ctrl_rfDest;	// <stdin>:3664:10
  assign io_forward_wb_rfData = _alu_io_out_valid ? _alu_io_out_bits : _lsu_io_out_bits;	// <stdin>:3664:10, EXU.scala:33:25, :42:25, :107:36
  assign io_forward_fuType = io_in_bits_ctrl_fuType;	// <stdin>:3664:10
endmodule

module WBU(	// <stdin>:3945:10
  input         clock,
                reset,
                io_in_valid,
  ...
  wire [4:0][63:0] _GEN = {{64'h0}, {io_in_bits_commits_3}, {io_in_bits_commits_2}, {io_in_bits_commits_1},
                {io_in_bits_commits_0}};	// <stdin>:3945:10, WBU.scala:21:22
  ...
  `ifndef SYNTHESIS	// <stdin>:3945:10
    always @(posedge clock) begin	// Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & io_in_valid & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "[COMMIT] pc = 0x%x inst %x wen %x wdst %x wdata %x mmio %x intrNO %x\n", io_in_bits_decode_cf_pc, io_in_bits_decode_cf_instr, _io_wb_rfWen_T, io_in_bits_decode_ctrl_rfDest, _GEN_1, 1'h0, 64'h0);	// <stdin>:3945:10, Debug.scala:34:43, :35:31, WBU.scala:19:53, :21:22
    end // always @(posedge)
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_wb_rfWen = _io_wb_rfWen_T;	// <stdin>:3945:10, WBU.scala:19:53
  assign io_wb_rfDest = io_in_bits_decode_ctrl_rfDest;	// <stdin>:3945:10
  assign io_wb_rfData = _GEN_1;	// <stdin>:3945:10, WBU.scala:21:22
  assign io_redirect_target = io_in_bits_decode_cf_redirect_target;	// <stdin>:3945:10
  assign io_redirect_valid = _io_difftest_redirect_valid_T;	// <stdin>:3945:10, WBU.scala:27:66
  assign io_difftest_commit_valid = io_in_valid;	// <stdin>:3945:10
  assign io_difftest_commit_bits_decode_cf_pnpc = io_in_bits_decode_cf_pnpc;	// <stdin>:3945:10
  assign io_difftest_redirect_target = io_in_bits_decode_cf_redirect_target;	// <stdin>:3945:10
  assign io_difftest_redirect_valid = _io_difftest_redirect_valid_T;	// <stdin>:3945:10, WBU.scala:27:66
endmodule

module Backend_inorder(	// <stdin>:3980:10
  input         clock,
                reset,
                io_in_0_valid,
  input  [63:0] io_in_0_bits_cf_instr,
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
      valid <= 1'h0;	// <stdin>:3980:10, Pipeline.scala:10:28
      valid_1 <= 1'h0;	// <stdin>:3980:10, Pipeline.scala:10:28
      c <= 64'h0;	// <stdin>:3980:10, GTimer.scala:8:32
      c_1 <= 64'h0;	// <stdin>:3980:10, GTimer.scala:8:32
    end
    else begin
  ...
  `ifndef SYNTHESIS	// <stdin>:3980:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "flush = %b, isu:(%d,%d), exu:(%d,%d)\n", io_flush, _isu_io_out_valid, _exu_io_in_ready, _exu_io_out_valid, 1'h1);	// <stdin>:3980:10, Backend.scala:27:25, :28:25, Debug.scala:34:43, :35:31
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3980:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3980:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_21;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_22;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_23;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_24;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_25;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_26;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_27;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_28;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_29;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_30;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_31;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_32;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_33;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_34;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_35;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_36;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_37;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_38;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_39;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_40;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_41;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_42;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_43;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_44;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_45;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_46;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_47;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_48;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_49;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_50;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_51;	// <stdin>:3980:10
      automatic logic [31:0] _RANDOM_52;	// <stdin>:3980:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3980:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3980:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3980:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_2 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_3 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_4 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_5 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_6 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_7 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_8 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_9 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_10 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_11 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_12 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_13 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_14 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_15 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_16 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_17 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_18 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_19 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_20 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_21 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_22 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_23 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_24 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_25 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_26 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_27 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_28 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_29 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_30 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_31 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_32 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_33 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_34 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_35 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_36 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_37 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_38 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_39 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_40 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_41 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_42 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_43 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_44 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_45 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_46 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_47 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_48 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_49 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_50 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_51 = `RANDOM;	// <stdin>:3980:10
        _RANDOM_52 = `RANDOM;	// <stdin>:3980:10
        valid = _RANDOM_0[0];	// Pipeline.scala:10:28
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3980:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3980:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
...
module Core(	// <stdin>:4203:10
  ...
  wire        _frontend_io_out_0_ready_T_1 = ringBufferHead - 1'h1 != ringBufferTail & {1'h0, ringBufferHead} - 2'h2 != {1'h0,
                ringBufferTail} | ~_frontend_io_out_0_valid;	// <stdin>:4203:10, PipelineVector.scala:13:45, :14:45, :16:{75,86,137}, :33:{48,51}, TopMain.scala:31:50
  ...
  always @(posedge clock) begin
    if (reset) begin
      dataBuffer_0_cf_instr <= 64'h0;	// <stdin>:4203:10, PipelineVector.scala:12:41
      dataBuffer_0_cf_pc <= 64'h0;	// <stdin>:4203:10, PipelineVector.scala:12:41
      dataBuffer_0_cf_pnpc <= 64'h0;	// <stdin>:4203:10, PipelineVector.scala:12:41
      dataBuffer_0_cf_exceptionVec_2 <= 1'h0;	// <stdin>:4203:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_srcAType <= 1'h0;	// <stdin>:4203:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_srcBType <= 1'h0;	// <stdin>:4203:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_fuType <= 3'h0;	// <stdin>:4203:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_fuCtrl <= 7'h0;	// <stdin>:4203:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfSrcA <= 5'h0;	// <stdin>:4203:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfSrcB <= 5'h0;	// <stdin>:4203:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfWen <= 1'h0;	// <stdin>:4203:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfDest <= 5'h0;	// <stdin>:4203:10, PipelineVector.scala:12:41
      dataBuffer_0_data_imm <= 64'h0;	// <stdin>:4203:10, PipelineVector.scala:12:41
      ringBufferHead <= 1'h0;	// <stdin>:4203:10, PipelineVector.scala:13:45
      ringBufferTail <= 1'h0;	// <stdin>:4203:10, PipelineVector.scala:14:45
      c <= 64'h0;	// <stdin>:4203:10, GTimer.scala:8:32
    end
    else begin
  ...
  `ifndef SYNTHESIS	// <stdin>:4203:10
    always @(posedge clock) begin	// PipelineVector.scala:60:27
      if ((`PRINTF_COND_) & ~reset)	// PipelineVector.scala:60:27
        $fwrite(32'h80000002, "[DPQ] size %x head %x tail %x enq %x deq %x\n", 1'h0, ringBufferHead, ringBufferTail, {1'h0, _frontend_io_out_0_valid}, {1'h0, _dequeueSize_T});	// <stdin>:4203:10, Decoupled.scala:52:35, PipelineVector.scala:13:45, :14:45, :23:56, :47:52, :60:27, TopMain.scala:31:50
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:35:31, PipelineVector.scala:60:27
        $fwrite(32'h80000002, "flush = %b, 0: frontend:(%d,%d), backend:(%d,%d); 1: frontend:(%d,%d), backend:(%d,%d)\n", _frontend_io_flushVec, _frontend_io_out_0_valid, _frontend_io_out_0_ready_T_1, _backend_io_in_0_valid_T, _backend_io_in_0_ready, 1'h0, 1'h1, _backend_io_in_1_valid_T_1, 1'h0);	// <stdin>:4203:10, Debug.scala:35:31, PipelineVector.scala:33:48, :39:46, :44:66, :60:27, TopMain.scala:31:50, :39:37
    end // always @(posedge)
    ...
    initial begin	// <stdin>:4203:10
      ...
      automatic logic [31:0] _RANDOM_8;	// <stdin>:4203:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:4203:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:4203:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:4203:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:4203:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:4203:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:4203:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:4203:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:4203:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:4203:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:4203:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:4203:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:4203:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4203:10
        ...
        _RANDOM_8 = `RANDOM;	// <stdin>:4203:10
        _RANDOM_9 = `RANDOM;	// <stdin>:4203:10
        _RANDOM_10 = `RANDOM;	// <stdin>:4203:10
        _RANDOM_11 = `RANDOM;	// <stdin>:4203:10
        _RANDOM_12 = `RANDOM;	// <stdin>:4203:10
        _RANDOM_13 = `RANDOM;	// <stdin>:4203:10
        _RANDOM_14 = `RANDOM;	// <stdin>:4203:10
        _RANDOM_15 = `RANDOM;	// <stdin>:4203:10
        _RANDOM_16 = `RANDOM;	// <stdin>:4203:10
        _RANDOM_17 = `RANDOM;	// <stdin>:4203:10
        _RANDOM_18 = `RANDOM;	// <stdin>:4203:10
        _RANDOM_19 = `RANDOM;	// <stdin>:4203:10
        _RANDOM_20 = `RANDOM;	// <stdin>:4203:10
...
module AXI4Lite_Arbiter(	// <stdin>:4502:10
  input         clock,
                reset,
                InstFetch_ar_valid,
  ...
  `ifndef SYNTHESIS	// <stdin>:4502:10
    always @(posedge clock) begin	// Debug.scala:34:43
    ...
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4502:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4502:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4502:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4502:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4502:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4502:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:4502:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:4502:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:4502:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:4502:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:4502:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:4502:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:4502:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:4502:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:4502:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:4502:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4502:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4502:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4502:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4502:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4502:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4502:10
        _RANDOM_3 = `RANDOM;	// <stdin>:4502:10
        _RANDOM_4 = `RANDOM;	// <stdin>:4502:10
        _RANDOM_5 = `RANDOM;	// <stdin>:4502:10
        _RANDOM_6 = `RANDOM;	// <stdin>:4502:10
        _RANDOM_7 = `RANDOM;	// <stdin>:4502:10
        _RANDOM_8 = `RANDOM;	// <stdin>:4502:10
        _RANDOM_9 = `RANDOM;	// <stdin>:4502:10
        _RANDOM_10 = `RANDOM;	// <stdin>:4502:10
        _RANDOM_11 = `RANDOM;	// <stdin>:4502:10
        _RANDOM_12 = `RANDOM;	// <stdin>:4502:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4502:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4502:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign InstFetch_ar_ready = Arbiter_ar_ready;	// <stdin>:4502:10
  assign InstFetch_r_valid = Arbiter_r_valid;	// <stdin>:4502:10
  assign InstFetch_r_bits_data = Arbiter_r_bits_data;	// <stdin>:4502:10
  assign LoadStore_aw_ready = Arbiter_aw_ready;	// <stdin>:4502:10
  assign LoadStore_w_ready = Arbiter_w_ready;	// <stdin>:4502:10
  assign LoadStore_b_valid = Arbiter_b_valid;	// <stdin>:4502:10
  assign LoadStore_ar_ready = Arbiter_ar_ready;	// <stdin>:4502:10
  assign LoadStore_r_valid = Arbiter_r_valid;	// <stdin>:4502:10
  assign LoadStore_r_bits_data = Arbiter_r_bits_data;	// <stdin>:4502:10
  assign Arbiter_aw_valid = LoadStore_aw_valid;	// <stdin>:4502:10
  assign Arbiter_aw_bits_addr = LoadStore_aw_bits_addr;	// <stdin>:4502:10
  assign Arbiter_w_valid = LoadStore_w_valid;	// <stdin>:4502:10
  assign Arbiter_w_bits_data = LoadStore_w_bits_data;	// <stdin>:4502:10
  assign Arbiter_w_bits_strb = LoadStore_w_bits_strb;	// <stdin>:4502:10
  assign Arbiter_b_ready = LoadStore_b_ready;	// <stdin>:4502:10
  assign Arbiter_ar_valid = (|state) ? (_T_26 ? InstFetch_ar_valid : LoadStore_ar_valid) : _GEN ? LoadStore_ar_valid :
                InstFetch_ar_valid;	// <stdin>:4502:10, AXI4_Arbiter.scala:30:28, :32:24, :34:73, :36:46, :39:80, :54:38
  assign Arbiter_ar_bits_addr = (|state) ? (_T_26 ? InstFetch_ar_bits_addr : LoadStore_ar_bits_addr) : _GEN ?
                LoadStore_ar_bits_addr : InstFetch_ar_bits_addr;	// <stdin>:4502:10, AXI4_Arbiter.scala:30:28, :32:24, :34:73, :36:46, :39:80, :54:38
  assign Arbiter_r_ready = (|state) ? (_T_26 ? InstFetch_r_ready : LoadStore_r_ready) : _GEN ? LoadStore_r_ready :
                InstFetch_r_ready;	// <stdin>:4502:10, AXI4_Arbiter.scala:30:28, :32:24, :34:73, :36:46, :37:46, :39:80, :55:38
endmodule

// external module MEM

module TP_SRAM(	// <stdin>:4710:10
  input         clock,
                reset,
                io_aw_valid,
  ...
  `ifndef SYNTHESIS	// <stdin>:4710:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4710:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4710:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4710:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4710:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4710:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4710:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4710:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4710:10
        state_load = _RANDOM_0[0];	// TP_SRAM.scala:31:33
        state_store = _RANDOM_0[1];	// TP_SRAM.scala:31:33, :32:34
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4710:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4710:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  assign io_aw_ready = ~state_store;	// <stdin>:4710:10, TP_SRAM.scala:32:34, :44:30
  assign io_w_ready = ~state_store;	// <stdin>:4710:10, TP_SRAM.scala:32:34, :44:30
  assign io_b_valid = state_store;	// <stdin>:4710:10, TP_SRAM.scala:32:34
  assign io_ar_ready = ~state_load;	// <stdin>:4710:10, TP_SRAM.scala:31:33, :34:29
  assign io_r_valid = state_load;	// <stdin>:4710:10, TP_SRAM.scala:31:33
endmodule

module SimTop(	// <stdin>:4775:10
  input         clock,
                reset,
  output        io_commit,
  output [63:0] io_pc,
  ...
  `ifndef SYNTHESIS	// <stdin>:4775:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4775:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4775:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4775:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4775:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4775:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4775:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4775:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4775:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4775:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4775:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4775:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4775:10
        io_commit_REG = _RANDOM_0[0];	// SimTop.scala:50:29
        io_pc_REG = {_RANDOM_0[31:1], _RANDOM_1, _RANDOM_2[0]};	// SimTop.scala:50:29, :51:25
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4775:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4775:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  assign io_commit = io_commit_REG;	// <stdin>:4775:10, SimTop.scala:50:29
  assign io_pc = io_pc_REG;	// <stdin>:4775:10, SimTop.scala:51:25
  assign io_gpr_regs_0 = 64'h0;	// <stdin>:4775:10, SimTop.scala:28:29
endmodule
