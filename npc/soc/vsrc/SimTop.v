...
module ISU(	// <stdin>:1741:10
  ...
  assign io_out_bits_data_srcA = (io_in_0_bits_ctrl_srcAType ? io_in_0_bits_cf_pc : 64'h0) | (srcAForwardNextCycle ?
                ...
                io_in_0_bits_ctrl_rfSrcA == 5'h0 ? 64'h0 : _rf_ext_R32_data);	// <stdin>:1741:10, ISU.scala:39:49, :41:40, :55:{30,33}, Mux.scala:27:73, RegisterFile.scala:15:21, :16:{47,63}
  assign io_out_bits_data_srcB = (io_in_0_bits_ctrl_srcBType ? io_in_0_bits_data_imm : 64'h0) | (srcBForwardNextCycle ?
                ...
                io_in_0_bits_ctrl_rfSrcB == 5'h0 ? 64'h0 : _rf_ext_R33_data);	// <stdin>:1741:10, ISU.scala:40:49, :42:40, :61:{30,33}, Mux.scala:27:73, RegisterFile.scala:15:21, :16:{47,63}
...
module ALU(	// <stdin>:2077:10
  ...
  wire [5:0]   shamt = io_in_bits_ctrl[5] ? {1'h0, io_in_bits_srcB[4:0]} : io_in_bits_srcB[5:0];	// <stdin>:2077:10, ALU.scala:50:40, :91:{24,53,81}
  ...
  wire         _io_redirect_target_T = (io_in_bits_ctrl[2:1] == 2'h0 & xorRes == 64'h0 | io_in_bits_ctrl[2:1] == 2'h2 & slt |
                (&(io_in_bits_ctrl[2:1])) & ~(adderRes[64])) ^ ~(io_in_bits_ctrl[0]);	// ALU.scala:53:45, :54:46, :78:68, :79:40, :80:{35,44}, :81:50, :109:68, :118:32, Bitwise.scala:77:12, LookupTree.scala:8:38, Mux.scala:27:73, :81:61
  reg  [63:0]  c;	// GTimer.scala:8:32
  always @(posedge clock) begin
    if (reset)
  ...
  `ifndef SYNTHESIS	// <stdin>:2077:10
    always @(posedge clock) begin	// ALU.scala:120:15
      automatic logic _T_15 = io_in_valid & (&(io_cfIn_instr[1:0])) != (&(io_cfIn_instr[1:0]));	// ALU.scala:119:{35,42}, :121:{21,45,58}
      if (~reset & ~((&(io_cfIn_instr[1:0])) | ~(&(io_cfIn_instr[1:0])) | ~io_in_valid)) begin	// ALU.scala:119:{35,42}, :120:{15,36,57,60}
        if (`ASSERT_VERBOSE_COND_)	// ALU.scala:120:15
          $error("Assertion failed\n    at ALU.scala:120 assert(io.cfIn.instr(1, 0) === \"b11\".U || isRVC || !valid)\n");	// ALU.scala:120:15
        if (`STOP_COND_)	// ALU.scala:120:15
          $fatal;	// ALU.scala:120:15
      end
      if ((`PRINTF_COND_) & _T_15 & ~reset)	// ALU.scala:121:21, Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] ALU: ", c);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_15 & ~reset)	// ALU.scala:121:21, Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "[ERROR] pc %x inst %x rvc %x\n", io_cfIn_pc, io_cfIn_instr, ~(&(io_cfIn_instr[1:0])));	// ALU.scala:119:{35,42}, Debug.scala:34:43, :35:31
    end // always @(posedge)
  ...
  assign io_out_bits = io_in_bits_ctrl[4] ? ((&(io_cfIn_instr[1:0])) ? io_cfIn_pc + 64'h4 : io_cfIn_pc + 64'h2) :
                io_in_bits_ctrl[5] ? {{32{_GEN_0[31]}}, _GEN_0[31:0]} : _GEN_0;	// <stdin>:2077:10, ALU.scala:50:40, :51:37, :106:{25,61}, :119:{35,42}, :122:{77,95}, :131:{27,38,77,114}, BitUtils.scala:17:32, Bitwise.scala:77:12, Mux.scala:81:58
  assign io_redirect_target = _io_redirect_target_T & io_in_bits_ctrl[3] ? ((&(io_cfIn_instr[1:0])) ? io_cfIn_pc + 64'h4
                : io_cfIn_pc + 64'h2) : io_in_bits_ctrl[3] ? io_cfIn_pc + io_offset : adderRes[63:0];	// <stdin>:2077:10, ALU.scala:52:40, :78:68, :117:{25,47}, :118:32, :119:{35,42}, :122:{34,42,58,77,95}
  assign io_redirect_valid = io_in_valid & io_in_bits_ctrl[4] & ~(_io_redirect_target_T & io_in_bits_ctrl[3]);	// <stdin>:2077:10, ALU.scala:51:37, :52:40, :118:{31,32,39}, :124:45
endmodule
...
module LSExecUnit(	// <stdin>:2236:10
  ...
  `ifndef SYNTHESIS	// <stdin>:2236:10
    always @(posedge clock) begin	// Debug.scala:34:43
    ...
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2236:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2236:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:2236:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:2236:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2236:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2236:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2236:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_9 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_10 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_11 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_12 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_13 = `RANDOM;	// <stdin>:2236:10
        _RANDOM_14 = `RANDOM;	// <stdin>:2236:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2236:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2236:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_in_ready = _io_in_ready_T & ~state_store;	// <stdin>:2236:10, UnpipelinedLSU.scala:188:34, :190:29, :206:30, :252:47
  assign io_out_valid = _io_out_valid_T_10;	// <stdin>:2236:10, UnpipelinedLSU.scala:244:28
  assign io_out_bits = partialLoad ? (io_in_bits_ctrl == 7'h0 ? {{56{_rdataPartialLoad_T_20[7]}},
                ...
                64'h0) : io_dmem_r_bits_data;	// <stdin>:2236:10, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:152:20, :183:36, :279:52, :280:52, :293:27
  assign io_dmem_aw_valid = wValid;	// <stdin>:2236:10, UnpipelinedLSU.scala:235:96
  assign io_dmem_aw_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2236:10, AXI4.scala:73:27
  assign io_dmem_w_valid = wValid;	// <stdin>:2236:10, UnpipelinedLSU.scala:235:96
  assign io_dmem_w_bits_data = ((|(io_in_bits_ctrl[1:0])) ? 64'h0 : {2{{2{{2{io_wdata[7:0]}}}}}}) | (_reqWmask_T_1 ?
                ...
                ((&(io_in_bits_ctrl[1:0])) ? io_wdata : 64'h0);	// <stdin>:2236:10, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:157:48, :158:48, :159:48, :225:27
  assign io_dmem_w_bits_strb = reqWmask[7:0];	// <stdin>:2236:10, AXI4.scala:83:27, UnpipelinedLSU.scala:152:20
  assign io_dmem_b_ready = state_store;	// <stdin>:2236:10, UnpipelinedLSU.scala:188:34
  assign io_dmem_ar_valid = rValid;	// <stdin>:2236:10, UnpipelinedLSU.scala:236:96
  assign io_dmem_ar_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2236:10, AXI4.scala:73:27
  assign io_dmem_r_ready = _io_out_valid_T_5;	// <stdin>:2236:10, UnpipelinedLSU.scala:242:36
  assign io_ioLoadAddrMisaligned = _io_ioLoadAddrMisaligned_T_3;	// <stdin>:2236:10, UnpipelinedLSU.scala:301:55
  assign io_ioStoreAddrMisaligned = _io_ioStoreAddrMisaligned_T_2;	// <stdin>:2236:10, UnpipelinedLSU.scala:302:54
endmodule

module UnpipelinedLSU(	// <stdin>:2593:10
  input         clock,
                reset,
                io_in_valid,
  input  [63:0] io_in_bits_srcA,
  ...
  `ifndef SYNTHESIS	// <stdin>:2593:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
    ...
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2593:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2593:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2593:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2593:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2593:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2593:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2593:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2593:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2593:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2593:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2593:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2593:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2593:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2593:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2593:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2593:10
        c = {_RANDOM_0[31:2], _RANDOM_1, _RANDOM_2[1:0]};	// GTimer.scala:8:32
        c_1 = {_RANDOM_2[31:2], _RANDOM_3, _RANDOM_4[1:0]};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2593:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2593:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  assign io_out_valid = _lsExecUnit_io_out_valid;	// <stdin>:2593:10, UnpipelinedLSU.scala:32:32
endmodule
...
module AXI4Lite_Arbiter(	// <stdin>:4440:10
  ...
  reg  [63:0] c;	// GTimer.scala:8:32
  wire        _T_7 = InstFetch_ar_valid & ~LoadStore_ar_valid;	// AXI4_Arbiter.scala:43:{39,42}
  reg  [63:0] c_1;	// GTimer.scala:8:32
  reg  [63:0] c_2;	// GTimer.scala:8:32
  wire        _GEN = _T | ~_T_7;	// AXI4_Arbiter.scala:38:{33,56}, :41:33, :43:{39,63}
  reg  [63:0] c_3;	// GTimer.scala:8:32
  always @(posedge clock) begin
    if (reset) begin
      c <= 64'h0;	// GTimer.scala:8:32
  ...
  `ifndef SYNTHESIS	// <stdin>:4440:10
    always @(posedge clock) begin	// Debug.scala:34:43
      automatic logic _GEN_0 = ~_T & _T_7;	// AXI4_Arbiter.scala:38:{33,56}, :43:{39,63}
      automatic logic _GEN_1 = ~_T & ~_T_7;	// AXI4_Arbiter.scala:38:{33,56}, :43:{39,63}
      automatic logic _T_14 = ~InstFetch_ar_valid & LoadStore_ar_valid;	// AXI4_Arbiter.scala:48:{20,40}
      automatic logic _GEN_2 = _GEN_1 & _T_14;	// AXI4_Arbiter.scala:43:63, :48:{40,63}
      automatic logic _GEN_3 = _GEN_1 & ~_T_14;	// AXI4_Arbiter.scala:43:63, :48:{40,63}
      if ((`PRINTF_COND_) & _T & ~reset)	// AXI4_Arbiter.scala:38:33, Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] AXI4Lite_Arbiter: ", c);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T & ~reset)	// AXI4_Arbiter.scala:38:33, Debug.scala:34:43, :35:31
  ...
  assign Arbiter_ar_valid = _GEN ? LoadStore_ar_valid : InstFetch_ar_valid;	// <stdin>:4440:10, AXI4_Arbiter.scala:38:56, :41:33, :43:63
  assign Arbiter_ar_bits_addr = _GEN ? LoadStore_ar_bits_addr : InstFetch_ar_bits_addr;	// <stdin>:4440:10, AXI4_Arbiter.scala:38:56, :41:33, :43:63
  assign Arbiter_r_ready = _GEN ? LoadStore_r_ready : InstFetch_r_ready;	// <stdin>:4440:10, AXI4_Arbiter.scala:38:56, :41:33, :42:41, :43:63
endmodule

// external module MEM

module TP_SRAM(	// <stdin>:4595:10
  input         clock,
                reset,
                io_aw_valid,
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (state_load)	// TP_SRAM.scala:30:33
        state_load <= (~state_load | ~(io_r_ready & state_load)) & state_load;	// Decoupled.scala:52:35, TP_SRAM.scala:30:33, :43:29, :49:{42,55}
      else	// TP_SRAM.scala:30:33
        state_load <= ~state_load & io_ar_valid | state_load;	// Decoupled.scala:52:35, TP_SRAM.scala:30:33, :43:29, :45:{43,56}
  ...
  `ifndef SYNTHESIS	// <stdin>:4595:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] TP_SRAM: ", c);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "======================================= statels(%x,%x) arv%x arr%x araddr%x awv%x awr%x awaddr%x wv%x wr%x wdata%x\n", state_load, state_store, io_ar_valid, ~state_load, io_ar_bits_addr, io_aw_valid, ~state_store, io_aw_bits_addr, io_w_valid, ~state_store, io_w_bits_data);	// Debug.scala:34:43, :35:31, TP_SRAM.scala:30:33, :31:34, :43:29, :53:30
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4595:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4595:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4595:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4595:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4595:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4595:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4595:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4595:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4595:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4595:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4595:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4595:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4595:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4595:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  assign io_aw_ready = ~state_store;	// <stdin>:4595:10, TP_SRAM.scala:31:34, :53:30
  assign io_w_ready = ~state_store;	// <stdin>:4595:10, TP_SRAM.scala:31:34, :53:30
  assign io_b_valid = state_store;	// <stdin>:4595:10, TP_SRAM.scala:31:34
  assign io_ar_ready = ~state_load;	// <stdin>:4595:10, TP_SRAM.scala:30:33, :43:29
  assign io_r_valid = state_load;	// <stdin>:4595:10, TP_SRAM.scala:30:33
endmodule

module SimTop(	// <stdin>:4675:10
  input         clock,
                reset,
  output        io_commit,
  output [63:0] io_pc,
  ...
  `ifndef SYNTHESIS	// <stdin>:4675:10
    ...
    initial begin	// <stdin>:4675:10
      ...
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4675:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4675:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4675:10
        ...
        _RANDOM_1 = `RANDOM;	// <stdin>:4675:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4675:10
  ...
  assign io_commit = io_commit_REG;	// <stdin>:4675:10, SimTop.scala:50:29
  assign io_pc = io_pc_REG;	// <stdin>:4675:10, SimTop.scala:51:25
  assign io_gpr_regs_0 = 64'h0;	// <stdin>:4675:10, SimTop.scala:28:29
endmodule
