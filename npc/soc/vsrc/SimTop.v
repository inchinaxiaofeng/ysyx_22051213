...
module LSExecUnit(	// <stdin>:2290:10
  ...
  wire        _io_ioStoreAddrMisaligned_T_2;	// UnpipelinedLSU.scala:293:54
  wire        _io_ioLoadAddrMisaligned_T_3;	// UnpipelinedLSU.scala:292:55
  wire        _io_out_valid_T_5;	// UnpipelinedLSU.scala:239:36
  ...
  reg  [63:0] c;	// GTimer.scala:8:32
  wire        _T_34 = _io_out_valid_T_5 & io_dmem_r_valid;	// Decoupled.scala:52:35, UnpipelinedLSU.scala:239:36
  ...
  wire        wValid = io_in_valid & ~state_store & isStore & ~_io_ioLoadAddrMisaligned_T_3 &
                ~_io_ioStoreAddrMisaligned_T_2;	// UnpipelinedLSU.scala:180:29, :186:34, :204:30, :232:{71,96,99}, :292:55, :293:54
  wire        rValid = io_in_valid & _io_in_ready_T & ~isStore & ~_io_ioLoadAddrMisaligned_T_3 &
                ~_io_ioStoreAddrMisaligned_T_2;	// UnpipelinedLSU.scala:180:29, :181:27, :188:29, :232:{71,99}, :233:96, :292:55, :293:54
  assign _io_out_valid_T_5 = state_load == 2'h1;	// UnpipelinedLSU.scala:185:33, :191:44, :239:36
  wire        _T_42 = _io_ioLoadAddrMisaligned_T_3 | _io_ioStoreAddrMisaligned_T_2;	// UnpipelinedLSU.scala:242:41, :292:55, :293:54
  wire        _io_out_valid_T_10 = _T_42 | (partialLoad ? state_load == 2'h2 : (_T_34 | _T_35) & (_io_out_valid_T_5 |
                state_store));	// Decoupled.scala:52:35, UnpipelinedLSU.scala:181:36, :185:33, :186:34, :197:50, :239:36, :241:28, :242:41, :243:28, :244:36, :245:{38,54}, :246:54
  reg  [63:0] c_2;	// GTimer.scala:8:32
  reg  [63:0] rdataLatch;	// UnpipelinedLSU.scala:257:33
  wire [31:0] _GEN = (addrLatch[2:0] == 3'h1 ? rdataLatch[39:8] : 32'h0) | (addrLatch[2:0] == 3'h2 ?
                ...
                (addrLatch[2:0] == 3'h4 ? rdataLatch[63:32] : 32'h0);	// Bitwise.scala:77:12, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:179:32, :257:33, :258:46, :260:46, :261:46, :262:46, :263:46
  wire [23:0] _GEN_0 = _GEN[23:0] | (addrLatch[2:0] == 3'h5 ? rdataLatch[63:40] : 24'h0);	// LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:179:32, :257:33, :258:46, :264:46
  wire [15:0] _GEN_1 = _GEN_0[15:0] | (addrLatch[2:0] == 3'h6 ? rdataLatch[63:48] : 16'h0);	// LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:179:32, :257:33, :258:46, :265:46
  wire [31:0] _rdataPartialLoad_T_20 = (addrLatch[2:0] == 3'h0 ? rdataLatch[31:0] : 32'h0) | {_GEN[31:24], _GEN_0[23:16],
                _GEN_1[15:8], _GEN_1[7:0] | ((&(addrLatch[2:0])) ? rdataLatch[63:56] : 8'h0)};	// Bitwise.scala:77:12, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:179:32, :257:33, :258:46, :266:46
  wire        _addrAligned_T_17 = ~(|(io_in_bits_ctrl[1:0])) | io_in_bits_ctrl[1:0] == 2'h1 & ~(io_in_bits_srcA[0]) |
                ...
                io_in_bits_srcA[2:0] == 3'h0;	// LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:150:27, :185:33, :191:44, :197:50, :222:27, :285:{33,37}, :286:{33,40}, :287:40
  assign _io_ioLoadAddrMisaligned_T_3 = io_in_valid & ~isStore & ~_addrAligned_T_17;	// Mux.scala:27:73, UnpipelinedLSU.scala:180:29, :181:27, :292:{55,58}
  assign _io_ioStoreAddrMisaligned_T_2 = io_in_valid & isStore & ~_addrAligned_T_17;	// Mux.scala:27:73, UnpipelinedLSU.scala:180:29, :292:58, :293:54
  reg  [63:0] c_3;	// GTimer.scala:8:32
  always @(posedge clock) begin
    addrLatch <= io_in_bits_srcA;	// UnpipelinedLSU.scala:179:32
    rdataLatch <= io_dmem_r_bits_data;	// UnpipelinedLSU.scala:257:33
    if (reset) begin
      ...
      _GEN_2 = {{state_load}, {2'h0}, {_io_out_valid_T_5 & io_dmem_r_valid ? {partialLoad, 1'h0} :
                                                state_load}, {io_dmem_ar_ready & rValid & ~isStore ? 2'h1 : state_load}};	// Decoupled.scala:52:35, UnpipelinedLSU.scala:179:32, :180:29, :181:{27,36}, :185:33, :188:29, :190:{44,57}, :191:44, :196:44, :197:{44,50}, :201:50, :233:96, :239:36
      ...
      if (state_store)	// UnpipelinedLSU.scala:186:34
        ...
        state_store <= io_dmem_aw_ready & wValid & io_dmem_w_ready & isStore | state_store;	// UnpipelinedLSU.scala:180:29, :186:34, :206:{59,71}, :207:45, :232:96
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
      c_1 <= c_1 + 64'h1;	// GTimer.scala:8:32, :9:24
      c_2 <= c_2 + 64'h1;	// GTimer.scala:8:32, :9:24
      c_3 <= c_3 + 64'h1;	// GTimer.scala:8:32, :9:24
  ...
  `ifndef SYNTHESIS	// <stdin>:2290:10
    always @(posedge clock) begin	// Debug.scala:34:43
      automatic logic _T_23 = io_dmem_aw_ready & io_dmem_w_ready;	// UnpipelinedLSU.scala:220:28
      automatic logic _T_24 = io_dmem_ar_ready & _io_out_valid_T_5;	// UnpipelinedLSU.scala:220:59, :239:36
      automatic logic _T_18 = _T_23 | _T_24;	// UnpipelinedLSU.scala:220:{28,43,59}
      automatic logic _T_28 = _T_23 | _T_24;	// UnpipelinedLSU.scala:220:{28,59}, :223:43
      ...
      if ((`PRINTF_COND_) & _T_28 & ~reset)	// Debug.scala:34:43, UnpipelinedLSU.scala:223:43
        $fwrite(32'h80000002, "[%d] LSExecUnit: ", c_1);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_28 & ~reset)	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:223:43
      ...
      if ((`PRINTF_COND_) & _io_out_valid_T_10 & ~reset)	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:241:28
        $fwrite(32'h80000002, "[LSU-EXECUNIT] statels (%x,%x) rResp %x wResp %x lm %x sm %x\n", state_load, state_store, _T_34, _T_35, _io_ioLoadAddrMisaligned_T_3, _io_ioStoreAddrMisaligned_T_2);	// Debug.scala:34:43, :35:31, Decoupled.scala:52:35, UnpipelinedLSU.scala:185:33, :186:34, :292:55, :293:54
      if ((`PRINTF_COND_) & _T_42 & ~reset)	// Debug.scala:34:43, UnpipelinedLSU.scala:242:41
        $fwrite(32'h80000002, "[%d] LSExecUnit: ", c_3);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_42 & ~reset)	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:242:41
    ...
    initial begin	// <stdin>:2290:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2290:10
        ...
        rdataLatch = {_RANDOM_8[31:3], _RANDOM_9, _RANDOM_10[2:0]};	// GTimer.scala:8:32, UnpipelinedLSU.scala:257:33
        c_3 = {_RANDOM_10[31:3], _RANDOM_11, _RANDOM_12[2:0]};	// GTimer.scala:8:32, UnpipelinedLSU.scala:257:33
      `endif // RANDOMIZE_REG_INIT
    end // initial
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_in_ready = _io_in_ready_T & ~state_store;	// <stdin>:2290:10, UnpipelinedLSU.scala:186:34, :188:29, :204:30, :249:47
  assign io_out_valid = _io_out_valid_T_10;	// <stdin>:2290:10, UnpipelinedLSU.scala:241:28
  assign io_out_bits = partialLoad ? (io_in_bits_ctrl == 7'h0 ? {{56{_rdataPartialLoad_T_20[7]}},
                ...
                64'h0) : io_dmem_r_bits_data;	// <stdin>:2290:10, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:150:20, :181:36, :276:52, :277:52, :290:27
  assign io_dmem_aw_valid = wValid;	// <stdin>:2290:10, UnpipelinedLSU.scala:232:96
  assign io_dmem_aw_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2290:10, AXI4.scala:73:27
  assign io_dmem_w_valid = wValid;	// <stdin>:2290:10, UnpipelinedLSU.scala:232:96
  ...
  assign io_dmem_ar_valid = rValid;	// <stdin>:2290:10, UnpipelinedLSU.scala:233:96
  assign io_dmem_ar_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2290:10, AXI4.scala:73:27
  assign io_dmem_r_ready = _io_out_valid_T_5;	// <stdin>:2290:10, UnpipelinedLSU.scala:239:36
  assign io_ioLoadAddrMisaligned = _io_ioLoadAddrMisaligned_T_3;	// <stdin>:2290:10, UnpipelinedLSU.scala:292:55
  assign io_ioStoreAddrMisaligned = _io_ioStoreAddrMisaligned_T_2;	// <stdin>:2290:10, UnpipelinedLSU.scala:293:54
endmodule
