...
module ALU(	// <stdin>:2062:10
  ...
  wire [63:0]  _io_redirect_target_T_7 = ~taken & io_in_bits_ctrl[3] ? ((&(io_cfIn_instr[1:0])) ? io_cfIn_pc + 64'h4 : io_cfIn_pc +
                64'h2) : io_in_bits_ctrl[3] ? io_cfIn_pc + io_offset : adderRes[63:0];	// ALU.scala:52:40, :78:68, :116:76, :117:{25,47}, :118:32, :119:{35,42}, :125:{34,42,58,77,95}
  wire         _T_38 = io_in_valid & io_in_bits_ctrl[4];	// ALU.scala:51:37, :127:36
  wire         _io_redirect_valid_T_1 = _T_38 & ~_predictWrong_T_1;	// ALU.scala:118:{31,39}, :127:{36,45}
  reg  [63:0]  c_1;	// GTimer.scala:8:32
  reg  [63:0]  c_2;	// GTimer.scala:8:32
  reg  [63:0]  c_3;	// GTimer.scala:8:32
  ...
  `ifndef SYNTHESIS	// <stdin>:2062:10
    always @(posedge clock) begin	// ALU.scala:120:15
      ...
      if ((`PRINTF_COND_) & _T_38 & ~reset)	// ALU.scala:127:36, Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] ALU: ", c_1);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_38 & ~reset)	// ALU.scala:127:36, Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "tgt %x valid %d npc %x pdwrong %x\n", _io_redirect_target_T_7, _io_redirect_valid_T_1, io_cfIn_pnpc, ~_predictWrong_T_1);	// ALU.scala:118:{31,39}, :125:34, :127:45, Debug.scala:34:43, :35:31
      if ((`PRINTF_COND_) & _T_38 & ~reset)	// ALU.scala:127:36, Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & _T_38 & ~reset)	// ALU.scala:127:36, Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "[BPW] pc %x tgt %x npc %x pdWrong %x type %x%x%x%x\n", io_cfIn_pc, _io_redirect_target_T_7, io_cfIn_pnpc, ~_predictWrong_T_1, io_in_bits_ctrl[3], io_in_bits_ctrl == 7'h58 | io_in_bits_ctrl == 7'h5C, io_in_bits_ctrl == 7'h5A, io_in_bits_ctrl == 7'h5E);	// ALU.scala:52:40, :118:{31,39}, :125:34, :147:{23,39,47}, :148:{22,45}, Debug.scala:34:43, :35:31
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
  ...
  assign io_redirect_target = _io_redirect_target_T_7;	// <stdin>:2062:10, ALU.scala:125:34
  assign io_redirect_valid = _io_redirect_valid_T_1;	// <stdin>:2062:10, ALU.scala:127:45
endmodule

module LSExecUnit(	// <stdin>:2289:10
  input         clock,
                reset,
                io_in_valid,
  input  [63:0] io_in_bits_srcA,
  ...
  `ifndef SYNTHESIS	// <stdin>:2289:10
    always @(posedge clock) begin	// Debug.scala:34:43
    ...
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2289:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2289:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2289:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2289:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2289:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2289:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2289:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2289:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2289:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2289:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2289:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2289:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:2289:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:2289:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:2289:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:2289:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2289:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2289:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2289:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2289:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2289:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2289:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2289:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2289:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2289:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2289:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2289:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2289:10
        _RANDOM_9 = `RANDOM;	// <stdin>:2289:10
        _RANDOM_10 = `RANDOM;	// <stdin>:2289:10
        _RANDOM_11 = `RANDOM;	// <stdin>:2289:10
        _RANDOM_12 = `RANDOM;	// <stdin>:2289:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2289:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2289:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_in_ready = _io_in_ready_T & ~state_store;	// <stdin>:2289:10, UnpipelinedLSU.scala:186:34, :188:29, :204:30, :250:47
  assign io_out_valid = _io_out_valid_T_10;	// <stdin>:2289:10, UnpipelinedLSU.scala:242:28
  assign io_out_bits = partialLoad ? (io_in_bits_ctrl == 7'h0 ? {{56{_rdataPartialLoad_T_20[7]}},
                ...
                64'h0) : io_dmem_r_bits_data;	// <stdin>:2289:10, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:150:20, :181:36, :277:52, :278:52, :291:27
  assign io_dmem_aw_valid = wValid;	// <stdin>:2289:10, UnpipelinedLSU.scala:233:96
  assign io_dmem_aw_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2289:10, AXI4.scala:73:27
  assign io_dmem_w_valid = wValid;	// <stdin>:2289:10, UnpipelinedLSU.scala:233:96
  assign io_dmem_w_bits_data = ((|(io_in_bits_ctrl[1:0])) ? 64'h0 : {2{{2{{2{io_wdata[7:0]}}}}}}) | (_reqWmask_T_1 ?
                ...
                ((&(io_in_bits_ctrl[1:0])) ? io_wdata : 64'h0);	// <stdin>:2289:10, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:155:48, :156:48, :157:48, :223:27
  assign io_dmem_w_bits_strb = reqWmask[7:0];	// <stdin>:2289:10, AXI4.scala:83:27, UnpipelinedLSU.scala:150:20
  assign io_dmem_b_ready = state_store;	// <stdin>:2289:10, UnpipelinedLSU.scala:186:34
  assign io_dmem_ar_valid = rValid;	// <stdin>:2289:10, UnpipelinedLSU.scala:234:96
  assign io_dmem_ar_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2289:10, AXI4.scala:73:27
  assign io_dmem_r_ready = _io_out_valid_T_5;	// <stdin>:2289:10, UnpipelinedLSU.scala:240:36
  assign io_ioLoadAddrMisaligned = _io_ioLoadAddrMisaligned_T_3;	// <stdin>:2289:10, UnpipelinedLSU.scala:299:55
  assign io_ioStoreAddrMisaligned = _io_ioStoreAddrMisaligned_T_2;	// <stdin>:2289:10, UnpipelinedLSU.scala:300:54
endmodule
