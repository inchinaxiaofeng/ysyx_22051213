...
module rf_combMem(	// RegisterFile.scala:15:21
  ...
  assign R34_data = R34_en ? Memory[R34_addr] : 64'bx;	// RegisterFile.scala:15:21
endmodule
...
<<<<<<< HEAD
  wire        _T_5 = _io_imem_r_ready_T_1 & io_imem_r_valid;	// Decoupled.scala:52:35, IFU.scala:44:41
=======
...
<<<<<<< HEAD
      c_3 <= 64'h0;	// GTimer.scala:8:32, IFU.scala:41:17
    end
    else begin
      if (io_redirect_valid | _T_5) begin	// Decoupled.scala:52:35, IFU.scala:29:42
=======
    end
    else begin
...
<<<<<<< HEAD
      automatic logic _T_8 = _T_5 | io_imem_ar_ready & io_out_ready;	// Decoupled.scala:52:35, IFU.scala:55:30
      automatic logic _T_14 = io_out_ready & _io_out_valid_T_2;	// Decoupled.scala:52:35, IFU.scala:51:41
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "imem valid %x\n", io_imem_r_valid);	// Debug.scala:34:43, :35:31
      if ((`PRINTF_COND_) & _T_8 & ~reset)	// Debug.scala:34:43, IFU.scala:55:30
        $fwrite(32'h80000002, "[%d] IFU_embedded: ", c_1);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_8 & ~reset) begin	// Debug.scala:34:43, :35:31, IFU.scala:55:30
...
<<<<<<< HEAD
        c_3 = {_RANDOM_8, _RANDOM_9};	// GTimer.scala:8:32
=======
>>>>>>> tmp
      `endif // RANDOMIZE_REG_INIT
    end // initial
...
<<<<<<< HEAD
  ...
  always @(posedge clock) begin
    if (reset)
      c <= 64'h0;	// <stdin>:158:10, GTimer.scala:8:32
    else
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:158:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
    ...
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:158:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:158:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:158:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:158:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:158:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:158:10
        `INIT_RANDOM_PROLOG_	// <stdin>:158:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:158:10
        _RANDOM_0 = `RANDOM;	// <stdin>:158:10
        _RANDOM_1 = `RANDOM;	// <stdin>:158:10
        c = {_RANDOM_0, _RANDOM_1};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:158:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:158:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_in_ready = ~io_in_valid | io_out_ready & io_in_valid;	// <stdin>:158:10, Decoupled.scala:52:35, IDU.scala:107:{24,37}
  assign io_out_valid = io_in_valid;	// <stdin>:158:10
  assign io_out_bits_cf_instr = io_in_bits_instr;	// <stdin>:158:10
  assign io_out_bits_cf_pc = io_in_bits_pc;	// <stdin>:158:10
  assign io_out_bits_cf_pnpc = io_in_bits_pnpc;	// <stdin>:158:10
  assign io_out_bits_cf_exceptionVec_2 = decodeList_0 == 3'h0 & io_in_valid;	// <stdin>:158:10, IDU.scala:120:{65,89}, Lookup.scala:34:39
  assign io_out_bits_ctrl_srcAType = io_in_bits_instr[6:0] != 7'h37 & _srcAType_T_19;	// <stdin>:158:10, IDU.scala:87:{41,47,54}, Mux.scala:27:73
  assign io_out_bits_ctrl_srcBType = _srcBType_T_19;	// <stdin>:158:10, Mux.scala:27:73
  assign io_out_bits_ctrl_fuType = {1'h0, decodeList_1};	// <stdin>:158:10, IDU.scala:33:33, Lookup.scala:34:39
  assign io_out_bits_ctrl_fuCtrl = decodeList_1 == 2'h0 ? (_T_19 ? (_T_23 | _T_24 ? 7'h5C : io_in_bits_instr[19:15] == 5'h1 |
                io_in_bits_instr[19:15] == 5'h5 ? 7'h5E : _GEN_4) : _GEN_4) : decodeList_2;	// <stdin>:158:10, IDU.scala:34:33, :48:34, :78:{22,38}, :79:{46,54,61}, :80:{48,65,91}, :81:47, :82:{47,73}, :83:{47,73}, Lookup.scala:34:39
  assign io_out_bits_ctrl_rfSrcA = _srcAType_T_19 ? 5'h0 : io_in_bits_instr[19:15];	// <stdin>:158:10, IDU.scala:48:34, :58:39, Mux.scala:27:73
  assign io_out_bits_ctrl_rfSrcB = _srcBType_T_19 ? 5'h0 : io_in_bits_instr[24:20];	// <stdin>:158:10, IDU.scala:48:49, :58:39, :59:39, Mux.scala:27:73
  assign io_out_bits_ctrl_rfWen = decodeList_0[2];	// <stdin>:158:10, InstrDecode.scala:23:55, Lookup.scala:34:39
  assign io_out_bits_ctrl_rfDest = decodeList_0[2] ? io_in_bits_instr[11:7] : 5'h0;	// <stdin>:158:10, IDU.scala:48:64, :58:39, :61:39, InstrDecode.scala:23:55, Lookup.scala:34:39
=======
...
<<<<<<< HEAD
                io_in_bits_instr[30:21], 1'h0} : 64'h0);	// <stdin>:158:10, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, IDU.scala:48:64, :65:41, :66:45, :68:{45,56,66,81}, :69:45, :70:{56,71,82}, Lookup.scala:34:39, LookupTree.scala:8:38, Mux.scala:27:73
  assign io_isWFI = io_in_bits_instr[31:0] == 32'h10500073 & io_in_valid;	// <stdin>:158:10, IDU.scala:123:{28,49}, Lookup.scala:31:38
endmodule

module Decoder_1(	// <stdin>:864:10
  input clock,
        reset);
  ...
  always @(posedge clock) begin
    if (reset)
      c <= 64'h0;	// <stdin>:864:10, GTimer.scala:8:32
    else
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:864:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] Decoder_1: ", c);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "SrcAType is pc %x, rfSrcA %x Instr %x\n", 1'h0, 5'h0, 64'h0);	// <stdin>:864:10, Debug.scala:34:43, :35:31
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:864:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:864:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:864:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:864:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:864:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:864:10
        `INIT_RANDOM_PROLOG_	// <stdin>:864:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:864:10
        _RANDOM_0 = `RANDOM;	// <stdin>:864:10
        _RANDOM_1 = `RANDOM;	// <stdin>:864:10
        c = {_RANDOM_0, _RANDOM_1};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:864:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:864:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
endmodule

module IDU(	// <stdin>:1570:10
  input         clock,
                reset,
                io_in_0_valid,
=======
...
module Frontend_embedded(	// <stdin>:1599:10
=======
...
>>>>>>> tmp
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
<<<<<<< HEAD
      valid <= 1'h0;	// <stdin>:1599:10, Pipeline.scala:10:28
      c <= 64'h0;	// <stdin>:1599:10, GTimer.scala:8:32
      c_1 <= 64'h0;	// <stdin>:1599:10, GTimer.scala:8:32
      c_2 <= 64'h0;	// <stdin>:1599:10, GTimer.scala:8:32
      c_3 <= 64'h0;	// <stdin>:1599:10, GTimer.scala:8:32
=======
...
<<<<<<< HEAD
  `ifndef SYNTHESIS	// <stdin>:1599:10
=======
...
<<<<<<< HEAD
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:1599:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:1599:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:1599:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:1599:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:1599:10
        `INIT_RANDOM_PROLOG_	// <stdin>:1599:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:1599:10
        _RANDOM_0 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_1 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_2 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_3 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_4 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_5 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_6 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_7 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_8 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_9 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_10 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_11 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_12 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_13 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_14 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_15 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_16 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_17 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_18 = `RANDOM;	// <stdin>:1599:10
        _RANDOM_19 = `RANDOM;	// <stdin>:1599:10
=======
...
<<<<<<< HEAD
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:1599:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:1599:10
=======
...
<<<<<<< HEAD
  ...
  assign io_out_0_valid = _idu_io_out_0_valid;	// <stdin>:1599:10, Frontend.scala:24:25
  assign io_flushVec = _ifu_io_flushVec;	// <stdin>:1599:10, Frontend.scala:23:25
endmodule

module ISU(	// <stdin>:1790:10
=======
    .io_out_0_bits_data_imm          (io_out_0_bits_data_imm),
...
>>>>>>> tmp
  ...
  wire [63:0] _rf_ext_R34_data;	// RegisterFile.scala:15:21
  ...
  wire        _io_out_bits_data_srcA_T_9 = io_in_0_bits_ctrl_rfSrcA == 5'h0;	// RegisterFile.scala:16:{47,63}
  reg  [63:0] c;	// GTimer.scala:8:32
  wire [63:0] _io_out_bits_data_srcA_T_17 = (io_in_0_bits_ctrl_srcAType ? io_in_0_bits_cf_pc : 64'h0) | (srcAForwardNextCycle ?
...
<<<<<<< HEAD
                _io_out_bits_data_srcA_T_9 ? 64'h0 : _rf_ext_R33_data);	// <stdin>:1790:10, ISU.scala:39:49, :41:40, :56:32, :65:30, Mux.scala:27:73, RegisterFile.scala:15:21, :16:47
=======
                _io_out_bits_data_srcA_T_9 ? 64'h0 : _rf_ext_R33_data);	// <stdin>:1741:10, ISU.scala:39:49, :41:40, :56:32, :65:30, Mux.scala:27:73, RegisterFile.scala:15:21, :16:47
>>>>>>> tmp
...
<<<<<<< HEAD
      c <= 64'h0;	// <stdin>:1790:10, GTimer.scala:8:32
=======
      c <= 64'h0;	// <stdin>:1741:10, GTimer.scala:8:32
>>>>>>> tmp
    end
    else begin
      if (io_flush)
...
<<<<<<< HEAD
                                                                _isuFireSetMask_T_1[31:1] : 31'h0), 1'h0};	// <stdin>:1790:10, Cat.scala:33:92, Decoupled.scala:52:35, ISU.scala:30:{75,94,106}, :32:48, :83:{30,43,46}, :84:33, RegisterFile.scala:27:27, :29:{45,52}, :35:{36,38,50}
=======
...
<<<<<<< HEAD
  `ifndef SYNTHESIS	// <stdin>:1790:10
=======
  `ifndef SYNTHESIS	// <stdin>:1741:10
>>>>>>> tmp
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] ISU: ", c);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
<<<<<<< HEAD
        $fwrite(32'h80000002, "SrcA For ALU %x source %b%b%b%b srcA read(%x)=%x\n", _io_out_bits_data_srcA_T_17, io_in_0_bits_ctrl_srcAType, srcAForwardNextCycle, srcAForward & ~srcAForwardNextCycle, ~io_in_0_bits_ctrl_srcAType & ~srcAForwardNextCycle & ~srcAForward, io_in_0_bits_ctrl_rfSrcA, _io_out_bits_data_srcA_T_9 ? 64'h0 : _rf_ext_R0_data);	// <stdin>:1790:10, Debug.scala:34:43, :35:31, ISU.scala:39:49, :41:40, :56:{29,32}, :57:{46,87,90}, Mux.scala:27:73, RegisterFile.scala:15:21, :16:{41,47}
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:1790:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:1790:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:1790:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:1790:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:1790:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:1790:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:1790:10
        `INIT_RANDOM_PROLOG_	// <stdin>:1790:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:1790:10
        _RANDOM_0 = `RANDOM;	// <stdin>:1790:10
        _RANDOM_1 = `RANDOM;	// <stdin>:1790:10
        _RANDOM_2 = `RANDOM;	// <stdin>:1790:10
=======
        $fwrite(32'h80000002, "SrcA For ALU %x source %b%b%b%b srcA read(%x)=%x\n", _io_out_bits_data_srcA_T_17, io_in_0_bits_ctrl_srcAType, srcAForwardNextCycle, srcAForward & ~srcAForwardNextCycle, ~io_in_0_bits_ctrl_srcAType & ~srcAForwardNextCycle & ~srcAForward, io_in_0_bits_ctrl_rfSrcA, _io_out_bits_data_srcA_T_9 ? 64'h0 : _rf_ext_R0_data);	// <stdin>:1741:10, Debug.scala:34:43, :35:31, ISU.scala:39:49, :41:40, :56:{29,32}, :57:{46,87,90}, Mux.scala:27:73, RegisterFile.scala:15:21, :16:{41,47}
    end // always @(posedge)
    ...
    initial begin	// <stdin>:1741:10
      ...
      automatic logic [31:0] _RANDOM_1;	// <stdin>:1741:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:1741:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:1741:10
        ...
        _RANDOM_1 = `RANDOM;	// <stdin>:1741:10
        _RANDOM_2 = `RANDOM;	// <stdin>:1741:10
>>>>>>> tmp
        busy = _RANDOM_0;	// RegisterFile.scala:27:27
        c = {_RANDOM_1, _RANDOM_2};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
<<<<<<< HEAD
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:1790:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:1790:10
=======
...
>>>>>>> tmp
  ...
  rf_combMem rf_ext (	// RegisterFile.scala:15:21
    .R0_addr  (io_in_0_bits_ctrl_rfSrcA),
<<<<<<< HEAD
    .R0_en    (1'h1),	// <stdin>:1790:10
    .R0_clk   (clock),
    .R1_addr  (5'h0),	// RegisterFile.scala:16:63
    .R1_en    (1'h1),	// <stdin>:1790:10
    .R1_clk   (clock),
    .R2_addr  (5'hA),	// RegisterFile.scala:16:63
    .R2_en    (1'h1),	// <stdin>:1790:10
    .R2_clk   (clock),
    .R3_addr  (5'hB),	// RegisterFile.scala:16:63
    .R3_en    (1'h1),	// <stdin>:1790:10
    .R3_clk   (clock),
    .R4_addr  (5'hC),	// RegisterFile.scala:16:63
    .R4_en    (1'h1),	// <stdin>:1790:10
    .R4_clk   (clock),
    .R5_addr  (5'hD),	// RegisterFile.scala:16:63
    .R5_en    (1'h1),	// <stdin>:1790:10
    .R5_clk   (clock),
    .R6_addr  (5'hE),	// RegisterFile.scala:16:63
    .R6_en    (1'h1),	// <stdin>:1790:10
    .R6_clk   (clock),
    .R7_addr  (5'hF),	// RegisterFile.scala:16:63
    .R7_en    (1'h1),	// <stdin>:1790:10
    .R7_clk   (clock),
    .R8_addr  (5'h10),	// RegisterFile.scala:16:47
    .R8_en    (1'h1),	// <stdin>:1790:10
    .R8_clk   (clock),
    .R9_addr  (5'h11),	// RegisterFile.scala:16:47
    .R9_en    (1'h1),	// <stdin>:1790:10
    .R9_clk   (clock),
    .R10_addr (5'h12),	// RegisterFile.scala:16:47
    .R10_en   (1'h1),	// <stdin>:1790:10
    .R10_clk  (clock),
    .R11_addr (5'h13),	// RegisterFile.scala:16:47
    .R11_en   (1'h1),	// <stdin>:1790:10
    .R11_clk  (clock),
    .R12_addr (5'h1),	// RegisterFile.scala:16:63
    .R12_en   (1'h1),	// <stdin>:1790:10
    .R12_clk  (clock),
    .R13_addr (5'h14),	// RegisterFile.scala:16:47
    .R13_en   (1'h1),	// <stdin>:1790:10
    .R13_clk  (clock),
    .R14_addr (5'h15),	// RegisterFile.scala:16:47
    .R14_en   (1'h1),	// <stdin>:1790:10
    .R14_clk  (clock),
    .R15_addr (5'h16),	// RegisterFile.scala:16:47
    .R15_en   (1'h1),	// <stdin>:1790:10
    .R15_clk  (clock),
    .R16_addr (5'h17),	// RegisterFile.scala:16:47
    .R16_en   (1'h1),	// <stdin>:1790:10
    .R16_clk  (clock),
    .R17_addr (5'h18),	// RegisterFile.scala:16:47
    .R17_en   (1'h1),	// <stdin>:1790:10
    .R17_clk  (clock),
    .R18_addr (5'h19),	// RegisterFile.scala:16:47
    .R18_en   (1'h1),	// <stdin>:1790:10
    .R18_clk  (clock),
    .R19_addr (5'h1A),	// RegisterFile.scala:16:47
    .R19_en   (1'h1),	// <stdin>:1790:10
    .R19_clk  (clock),
    .R20_addr (5'h1B),	// RegisterFile.scala:16:47
    .R20_en   (1'h1),	// <stdin>:1790:10
    .R20_clk  (clock),
    .R21_addr (5'h1C),	// RegisterFile.scala:16:47
    .R21_en   (1'h1),	// <stdin>:1790:10
    .R21_clk  (clock),
    .R22_addr (5'h1D),	// RegisterFile.scala:16:47
    .R22_en   (1'h1),	// <stdin>:1790:10
    .R22_clk  (clock),
    .R23_addr (5'h2),	// RegisterFile.scala:16:63
    .R23_en   (1'h1),	// <stdin>:1790:10
    .R23_clk  (clock),
    .R24_addr (5'h1E),	// RegisterFile.scala:16:47
    .R24_en   (1'h1),	// <stdin>:1790:10
    .R24_clk  (clock),
    .R25_addr (5'h1F),	// RegisterFile.scala:16:47
    .R25_en   (1'h1),	// <stdin>:1790:10
    .R25_clk  (clock),
    .R26_addr (5'h3),	// RegisterFile.scala:16:63
    .R26_en   (1'h1),	// <stdin>:1790:10
    .R26_clk  (clock),
    .R27_addr (5'h4),	// RegisterFile.scala:16:63
    .R27_en   (1'h1),	// <stdin>:1790:10
    .R27_clk  (clock),
    .R28_addr (5'h5),	// RegisterFile.scala:16:63
    .R28_en   (1'h1),	// <stdin>:1790:10
    .R28_clk  (clock),
    .R29_addr (5'h6),	// RegisterFile.scala:16:63
    .R29_en   (1'h1),	// <stdin>:1790:10
    .R29_clk  (clock),
    .R30_addr (5'h7),	// RegisterFile.scala:16:63
    .R30_en   (1'h1),	// <stdin>:1790:10
    .R30_clk  (clock),
    .R31_addr (5'h8),	// RegisterFile.scala:16:63
    .R31_en   (1'h1),	// <stdin>:1790:10
    .R31_clk  (clock),
    .R32_addr (5'h9),	// RegisterFile.scala:16:63
    .R32_en   (1'h1),	// <stdin>:1790:10
    .R32_clk  (clock),
    .R33_addr (io_in_0_bits_ctrl_rfSrcA),
    .R33_en   (1'h1),	// <stdin>:1790:10
    .R33_clk  (clock),
    .R34_addr (io_in_0_bits_ctrl_rfSrcB),
    .R34_en   (1'h1),	// <stdin>:1790:10
=======
...
>>>>>>> tmp
    ...
    .R2_data  (io_gpr_regs_10),
    .R3_data  (io_gpr_regs_11),
    .R4_data  (io_gpr_regs_12),
    .R5_data  (io_gpr_regs_13),
    .R6_data  (io_gpr_regs_14),
    .R7_data  (io_gpr_regs_15),
    .R8_data  (io_gpr_regs_16),
    .R9_data  (io_gpr_regs_17),
    .R10_data (io_gpr_regs_18),
    .R11_data (io_gpr_regs_19),
    .R12_data (io_gpr_regs_1),
    .R13_data (io_gpr_regs_20),
    .R14_data (io_gpr_regs_21),
    .R15_data (io_gpr_regs_22),
    .R16_data (io_gpr_regs_23),
    .R17_data (io_gpr_regs_24),
    .R18_data (io_gpr_regs_25),
    .R19_data (io_gpr_regs_26),
    .R20_data (io_gpr_regs_27),
    .R21_data (io_gpr_regs_28),
    .R22_data (io_gpr_regs_29),
    .R23_data (io_gpr_regs_2),
    .R24_data (io_gpr_regs_30),
    .R25_data (io_gpr_regs_31),
    .R26_data (io_gpr_regs_3),
    .R27_data (io_gpr_regs_4),
    .R28_data (io_gpr_regs_5),
    .R29_data (io_gpr_regs_6),
    .R30_data (io_gpr_regs_7),
    .R31_data (io_gpr_regs_8),
    .R32_data (io_gpr_regs_9),
    .R33_data (_rf_ext_R33_data),
    .R34_data (_rf_ext_R34_data)
  );
<<<<<<< HEAD
  assign io_in_0_ready = ~io_in_0_valid | _io_in_0_ready_T_1;	// <stdin>:1790:10, Decoupled.scala:52:35, ISU.scala:88:{27,43}
  assign io_out_valid = _io_out_valid_T_1;	// <stdin>:1790:10, ISU.scala:47:53
  assign io_out_bits_cf_instr = io_in_0_bits_cf_instr;	// <stdin>:1790:10
  assign io_out_bits_cf_pc = io_in_0_bits_cf_pc;	// <stdin>:1790:10
  assign io_out_bits_cf_pnpc = io_in_0_bits_cf_pnpc;	// <stdin>:1790:10
  assign io_out_bits_cf_exceptionVec_2 = io_in_0_bits_cf_exceptionVec_2;	// <stdin>:1790:10
  assign io_out_bits_ctrl_fuType = io_in_0_bits_ctrl_fuType;	// <stdin>:1790:10
  assign io_out_bits_ctrl_fuCtrl = io_in_0_bits_ctrl_fuCtrl;	// <stdin>:1790:10
  assign io_out_bits_ctrl_rfWen = io_in_0_bits_ctrl_rfWen;	// <stdin>:1790:10
  assign io_out_bits_ctrl_rfDest = io_in_0_bits_ctrl_rfDest;	// <stdin>:1790:10
  assign io_out_bits_data_srcA = _io_out_bits_data_srcA_T_17;	// <stdin>:1790:10, Mux.scala:27:73
  assign io_out_bits_data_srcB = (io_in_0_bits_ctrl_srcBType ? io_in_0_bits_data_imm : 64'h0) | (srcBForwardNextCycle ?
                ...
                io_in_0_bits_ctrl_rfSrcB == 5'h0 ? 64'h0 : _rf_ext_R34_data);	// <stdin>:1790:10, ISU.scala:40:49, :42:40, :71:{30,33}, Mux.scala:27:73, RegisterFile.scala:15:21, :16:{47,63}
  assign io_out_bits_data_imm = io_in_0_bits_data_imm;	// <stdin>:1790:10
endmodule

module ALU(	// <stdin>:2137:10
=======
  ...
  assign io_out_bits_data_srcA = _io_out_bits_data_srcA_T_17;	// <stdin>:1741:10, Mux.scala:27:73
  assign io_out_bits_data_srcB = (io_in_0_bits_ctrl_srcBType ? io_in_0_bits_data_imm : 64'h0) | (srcBForwardNextCycle ?
                io_forward_wb_rfData : 64'h0) | (srcBForward & ~srcBForwardNextCycle ? io_wb_rfData :
                64'h0) | (io_in_0_bits_ctrl_srcBType | srcBForwardNextCycle | srcBForward |
                io_in_0_bits_ctrl_rfSrcB == 5'h0 ? 64'h0 : _rf_ext_R34_data);	// <stdin>:1741:10, ISU.scala:40:49, :42:40, :71:{30,33}, Mux.scala:27:73, RegisterFile.scala:15:21, :16:{47,63}
  assign io_out_bits_data_imm = io_in_0_bits_data_imm;	// <stdin>:1741:10
endmodule

module ALU(	// <stdin>:2088:10
>>>>>>> tmp
  input         clock,
                reset,
                io_in_valid,
...
<<<<<<< HEAD
                ~(io_in_bits_ctrl[6])};	// <stdin>:2137:10, ALU.scala:48:37, :77:27, :78:{33,42,68}, Bitwise.scala:77:12
  ...
  wire [63:0]  shsrcA = io_in_bits_ctrl == 7'h2D ? {{32{io_in_bits_srcA[31]}}, io_in_bits_srcA[31:0]} :
                io_in_bits_ctrl == 7'h25 ? {32'h0, io_in_bits_srcA[31:0]} : io_in_bits_srcA;	// ALU.scala:89:56, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, Mux.scala:81:{58,61}
  wire [5:0]   shamt = io_in_bits_ctrl[5] ? {1'h0, io_in_bits_srcB[4:0]} : io_in_bits_srcB[5:0];	// <stdin>:2137:10, ALU.scala:50:40, :93:{24,53,81}
  wire [126:0] _res_T_1 = {63'h0, shsrcA} << shamt;	// ALU.scala:93:24, :98:61, Cat.scala:33:92, Mux.scala:81:58
  wire [63:0]  _GEN = {58'h0, shamt};	// ALU.scala:93:24, :102:60
=======
                ~(io_in_bits_ctrl[6])};	// <stdin>:2088:10, ALU.scala:48:37, :77:27, :78:{33,42,68}, Bitwise.scala:77:12
  wire [63:0]  xorRes = io_in_bits_srcA ^ io_in_bits_srcB;	// ALU.scala:79:40
  wire         slt = xorRes[63] ^ ~(adderRes[64]);	// ALU.scala:78:68, :79:40, :80:{35,44}, :81:{41,50}
  wire [63:0]  shsrcA = io_in_bits_ctrl == 7'h2D ? {{32{io_in_bits_srcA[31]}}, io_in_bits_srcA[31:0]} :
  ...
  wire [5:0]   shamt = io_in_bits_ctrl[5] ? {1'h0, io_in_bits_srcB[4:0]} : io_in_bits_srcB[5:0];	// <stdin>:2088:10, ALU.scala:50:40, :91:{24,53,81}
...
<<<<<<< HEAD
                : adderRes[63:0];	// ALU.scala:78:68, :79:40, :80:{35,44}, :81:50, :95:21, :98:{61,70}, :102:60, :103:58, :104:58, :105:68, Cat.scala:33:92, Mux.scala:81:{58,61}
  wire [63:0]  target = io_in_bits_ctrl[3] ? io_cfIn_pc + io_offset : adderRes[63:0];	// ALU.scala:52:40, :78:68, :119:{25,47}
  wire         _io_redirect_target_T = (io_in_bits_ctrl[2:1] == 2'h0 & xorRes == 64'h0 | io_in_bits_ctrl[2:1] == 2'h2 & slt |
                (&(io_in_bits_ctrl[2:1])) & ~(adderRes[64])) ^ ~(io_in_bits_ctrl[0]);	// ALU.scala:53:45, :54:46, :78:68, :79:40, :80:{35,44}, :81:50, :111:68, :120:32, Bitwise.scala:77:12, LookupTree.scala:8:38, Mux.scala:27:73, :81:61
  reg  [63:0]  c_1;	// GTimer.scala:8:32
  reg  [63:0]  c_2;	// GTimer.scala:8:32
=======
  ...
  wire [63:0]  target = io_in_bits_ctrl[3] ? adderRes[63:0] : io_cfIn_pc + io_offset;	// ALU.scala:52:41, :78:68, :124:{25,61}
  reg  [63:0]  c;	// GTimer.scala:8:32
  wire         _predictWrong_T_1 = ~taken & ~(io_in_bits_ctrl[3]);	// ALU.scala:52:{36,41}, :123:76, :127:{32,39}
  reg  [63:0]  c_1;	// GTimer.scala:8:32
  wire [63:0]  _io_redirect_target_T_7 = taken | io_in_bits_ctrl[3] ? target : (&(io_cfIn_instr[1:0])) ? io_cfIn_pc + 64'h4 :
                io_cfIn_pc + 64'h2;	// ALU.scala:52:41, :123:76, :124:25, :128:{35,42}, :133:{34,58,77,95}
  wire         _T_48 = io_in_valid & io_in_bits_ctrl[4];	// ALU.scala:51:37, :135:36
  wire         _io_redirect_valid_T_1 = _T_48 & ~_predictWrong_T_1;	// ALU.scala:127:{31,39}, :135:{36,45}
  reg  [63:0]  c_2;	// GTimer.scala:8:32
  reg  [63:0]  c_3;	// GTimer.scala:8:32
  reg  [63:0]  c_4;	// GTimer.scala:8:32
  reg  [63:0]  c_5;	// GTimer.scala:8:32
  reg  [63:0]  c_6;	// GTimer.scala:8:32
>>>>>>> tmp
  always @(posedge clock) begin
    if (reset) begin
...
=======
      ...
      c_5 <= 64'h0;	// Bitwise.scala:77:12, GTimer.scala:8:32
      c_6 <= 64'h0;	// Bitwise.scala:77:12, GTimer.scala:8:32
>>>>>>> tmp
    end
    else begin
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
...
<<<<<<< HEAD
  ...
  `ifndef SYNTHESIS	// <stdin>:2137:10
    always @(posedge clock) begin	// Debug.scala:34:43
      automatic logic _T_20 = io_in_valid & (&(io_cfIn_instr[1:0])) != (&(io_cfIn_instr[1:0]));	// ALU.scala:121:{35,42}, :123:{21,45,58}
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] ALU: ", c);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "srcA %x\n", io_in_bits_srcA);	// Debug.scala:34:43, :35:31
      if (~reset & ~((&(io_cfIn_instr[1:0])) | ~(&(io_cfIn_instr[1:0])) | ~io_in_valid)) begin	// ALU.scala:121:{35,42}, :122:{15,36,57,60}
        if (`ASSERT_VERBOSE_COND_)	// ALU.scala:122:15
          $error("Assertion failed\n    at ALU.scala:122 assert(io.cfIn.instr(1, 0) === \"b11\".U || isRVC || !valid)\n");	// ALU.scala:122:15
        if (`STOP_COND_)	// ALU.scala:122:15
          $fatal;	// ALU.scala:122:15
      end
      if ((`PRINTF_COND_) & _T_20 & ~reset)	// ALU.scala:123:21, Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] ALU: ", c_1);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_20 & ~reset)	// ALU.scala:123:21, Debug.scala:34:43, :35:31
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "Redirect: target %x isBrunch %x adderRes %x\n", target, io_in_bits_ctrl[3], adderRes);	// ALU.scala:52:40, :78:68, :119:25, Debug.scala:34:43, :35:31
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2137:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2137:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2137:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2137:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2137:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2137:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2137:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2137:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2137:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2137:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2137:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2137:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2137:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2137:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2137:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2137:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2137:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2137:10
        c = {_RANDOM_0, _RANDOM_1};	// GTimer.scala:8:32
        c_1 = {_RANDOM_2, _RANDOM_3};	// GTimer.scala:8:32
        c_2 = {_RANDOM_4, _RANDOM_5};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2137:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2137:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_out_valid = io_in_valid;	// <stdin>:2137:10
  assign io_out_bits = io_in_bits_ctrl[4] ? ((&(io_cfIn_instr[1:0])) ? io_cfIn_pc + 64'h4 : io_cfIn_pc + 64'h2) :
                io_in_bits_ctrl[5] ? {{32{_GEN_0[31]}}, _GEN_0[31:0]} : _GEN_0;	// <stdin>:2137:10, ALU.scala:50:40, :51:37, :108:{25,61}, :121:{35,42}, :127:{77,95}, :136:{27,38,77,114}, BitUtils.scala:17:32, Bitwise.scala:77:12, Mux.scala:81:58
  assign io_redirect_target = _io_redirect_target_T & io_in_bits_ctrl[3] ? ((&(io_cfIn_instr[1:0])) ? io_cfIn_pc + 64'h4
                : io_cfIn_pc + 64'h2) : target;	// <stdin>:2137:10, ALU.scala:52:40, :119:25, :120:32, :121:{35,42}, :127:{34,42,58,77,95}
  assign io_redirect_valid = io_in_valid & io_in_bits_ctrl[4] & ~(_io_redirect_target_T & io_in_bits_ctrl[3]);	// <stdin>:2137:10, ALU.scala:51:37, :52:40, :120:{31,32,39}, :129:45
endmodule

module LSExecUnit(	// <stdin>:2326:10
=======
      c_3 <= c_3 + 64'h1;	// GTimer.scala:8:32, :9:24
      c_4 <= c_4 + 64'h1;	// GTimer.scala:8:32, :9:24
      c_5 <= c_5 + 64'h1;	// GTimer.scala:8:32, :9:24
      c_6 <= c_6 + 64'h1;	// GTimer.scala:8:32, :9:24
    end
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:2088:10
    always @(posedge clock) begin	// Debug.scala:34:43
      automatic logic _T_20 = io_in_valid & (&(io_cfIn_instr[1:0])) != (&(io_cfIn_instr[1:0]));	// ALU.scala:128:{35,42}, :130:{21,45,58}
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] ALU: ", c);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "isBranch %x\n", ~(io_in_bits_ctrl[3]));	// ALU.scala:52:{36,41}, Debug.scala:34:43, :35:31
      if (~reset & ~((&(io_cfIn_instr[1:0])) | ~(&(io_cfIn_instr[1:0])) | ~io_in_valid)) begin	// ALU.scala:128:{35,42}, :129:{15,36,57,60}
        if (`ASSERT_VERBOSE_COND_)	// ALU.scala:129:15
          $error("Assertion failed\n    at ALU.scala:129 assert(io.cfIn.instr(1, 0) === \"b11\".U || isRVC || !valid)\n");	// ALU.scala:129:15
        if (`STOP_COND_)	// ALU.scala:129:15
          $fatal;	// ALU.scala:129:15
      end
      if ((`PRINTF_COND_) & _T_20 & ~reset)	// ALU.scala:130:21, Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] ALU: ", c_1);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_20 & ~reset)	// ALU.scala:130:21, Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "[ERROR] pc %x inst %x rvc %x\n", io_cfIn_pc, io_cfIn_instr, ~(&(io_cfIn_instr[1:0])));	// ALU.scala:128:{35,42}, Debug.scala:34:43, :35:31
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] ALU: ", c_2);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "[BASE Info] pc %x instr %x pnpc %x caculate target %x redirect target %x\nadderRes %x redirect=valid&isBru&predictWrong(%x&%x&%x)\n", io_cfIn_pc, io_cfIn_instr, io_cfIn_pnpc, target, _io_redirect_target_T_7, adderRes, io_in_valid, io_in_bits_ctrl[4], ~_predictWrong_T_1);	// ALU.scala:51:37, :78:68, :124:25, :127:{31,39}, :133:34, Debug.scala:34:43, :35:31
      if ((`PRINTF_COND_) & _T_48 & ~reset)	// ALU.scala:135:36, Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] ALU: ", c_3);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_48 & ~reset)	// ALU.scala:135:36, Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "tgt %x valid %d npc %x pdwrong %x\n", _io_redirect_target_T_7, _io_redirect_valid_T_1, io_cfIn_pnpc, ~_predictWrong_T_1);	// ALU.scala:127:{31,39}, :133:34, :135:45, Debug.scala:34:43, :35:31
      if ((`PRINTF_COND_) & _T_48 & ~reset)	// ALU.scala:135:36, Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & _T_48 & ~reset)	// ALU.scala:135:36, Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "[BPW] pc %x tgt %x npc %x pdWrong %x type %x%x%x%x\n", io_cfIn_pc, _io_redirect_target_T_7, io_cfIn_pnpc, ~_predictWrong_T_1, ~(io_in_bits_ctrl[3]), io_in_bits_ctrl == 7'h58 | io_in_bits_ctrl == 7'h5C, io_in_bits_ctrl == 7'h5A, io_in_bits_ctrl == 7'h5E);	// ALU.scala:52:{36,41}, :127:{31,39}, :133:34, :160:{23,39,47}, :161:{22,45}, Debug.scala:34:43, :35:31
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] ALU: ", c_6);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
    ...
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2088:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2088:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:2088:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:2088:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2088:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2088:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2088:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2088:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2088:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2088:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2088:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2088:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2088:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2088:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2088:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2088:10
        _RANDOM_9 = `RANDOM;	// <stdin>:2088:10
        _RANDOM_10 = `RANDOM;	// <stdin>:2088:10
        _RANDOM_11 = `RANDOM;	// <stdin>:2088:10
        _RANDOM_12 = `RANDOM;	// <stdin>:2088:10
        _RANDOM_13 = `RANDOM;	// <stdin>:2088:10
        c = {_RANDOM_0, _RANDOM_1};	// GTimer.scala:8:32
        c_1 = {_RANDOM_2, _RANDOM_3};	// GTimer.scala:8:32
        c_2 = {_RANDOM_4, _RANDOM_5};	// GTimer.scala:8:32
        c_3 = {_RANDOM_6, _RANDOM_7};	// GTimer.scala:8:32
        c_4 = {_RANDOM_8, _RANDOM_9};	// GTimer.scala:8:32
        c_5 = {_RANDOM_10, _RANDOM_11};	// GTimer.scala:8:32
        c_6 = {_RANDOM_12, _RANDOM_13};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2088:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2088:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_out_valid = io_in_valid;	// <stdin>:2088:10
  assign io_out_bits = io_in_bits_ctrl[4] ? ((&(io_cfIn_instr[1:0])) ? io_cfIn_pc + 64'h4 : io_cfIn_pc + 64'h2) :
                io_in_bits_ctrl[5] ? {{32{_GEN_0[31]}}, _GEN_0[31:0]} : _GEN_0;	// <stdin>:2088:10, ALU.scala:50:40, :51:37, :106:{25,61}, :128:{35,42}, :133:{77,95}, :147:{27,38,77,114}, BitUtils.scala:17:32, Bitwise.scala:77:12, Mux.scala:81:58
  assign io_redirect_target = _io_redirect_target_T_7;	// <stdin>:2088:10, ALU.scala:133:34
  assign io_redirect_valid = _io_redirect_valid_T_1;	// <stdin>:2088:10, ALU.scala:135:45
endmodule

module LSExecUnit(	// <stdin>:2346:10
>>>>>>> tmp
  input         clock,
                reset,
                io_in_valid,
...
<<<<<<< HEAD
  wire        _io_ioStoreAddrMisaligned_T_2;	// UnpipelinedLSU.scala:301:54
  wire        _io_ioLoadAddrMisaligned_T_3;	// UnpipelinedLSU.scala:300:55
  wire        _io_out_valid_T_5;	// UnpipelinedLSU.scala:241:36
=======
  wire        _io_ioStoreAddrMisaligned_T_2;	// UnpipelinedLSU.scala:300:54
  wire        _io_ioLoadAddrMisaligned_T_3;	// UnpipelinedLSU.scala:299:55
  wire        _io_out_valid_T_5;	// UnpipelinedLSU.scala:240:36
>>>>>>> tmp
...
<<<<<<< HEAD
  reg  [63:0] c_1;	// GTimer.scala:8:32
  wire        _T_39 = _io_out_valid_T_5 & io_dmem_r_valid;	// Decoupled.scala:52:35, UnpipelinedLSU.scala:241:36
  wire        _T_40 = state_store & io_dmem_b_valid;	// Decoupled.scala:52:35, UnpipelinedLSU.scala:186:34
  reg  [63:0] c_2;	// GTimer.scala:8:32
  wire        _reqWmask_T_1 = io_in_bits_ctrl[1:0] == 2'h1;	// LookupTree.scala:8:38, UnpipelinedLSU.scala:191:44, :224:27
  wire        _reqWmask_T_2 = io_in_bits_ctrl[1:0] == 2'h2;	// LookupTree.scala:8:38, UnpipelinedLSU.scala:198:50, :224:27
  wire [14:0] reqWmask = {7'h0, {4'h0, {2'h0, {1'h0, ~(|(io_in_bits_ctrl[1:0]))} | {2{_reqWmask_T_1}}} |
                {4{_reqWmask_T_2}}} | {8{&(io_in_bits_ctrl[1:0])}}} << io_in_bits_srcA[2:0];	// LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:150:{20,27}, :179:32, :185:33, :224:27
  wire        wValid = io_in_valid & ~state_store & isStore & ~_io_ioLoadAddrMisaligned_T_3 &
                ~_io_ioStoreAddrMisaligned_T_2;	// UnpipelinedLSU.scala:180:29, :186:34, :205:30, :234:{71,96,99}, :300:55, :301:54
  wire        rValid = io_in_valid & _io_in_ready_T & ~isStore & ~_io_ioLoadAddrMisaligned_T_3 &
                ~_io_ioStoreAddrMisaligned_T_2;	// UnpipelinedLSU.scala:180:29, :181:27, :188:29, :234:{71,99}, :235:96, :300:55, :301:54
  assign _io_out_valid_T_5 = state_load == 2'h1;	// UnpipelinedLSU.scala:185:33, :191:44, :241:36
  wire        _T_47 = _io_ioLoadAddrMisaligned_T_3 | _io_ioStoreAddrMisaligned_T_2;	// UnpipelinedLSU.scala:244:41, :300:55, :301:54
  wire        _io_out_valid_T_10 = _T_47 | (partialLoad ? state_load == 2'h2 : (_T_39 | _T_40) & (_io_out_valid_T_5 |
                state_store));	// Decoupled.scala:52:35, UnpipelinedLSU.scala:181:36, :185:33, :186:34, :198:50, :241:36, :243:28, :244:41, :245:28, :246:36, :247:{38,54}, :248:54
  reg  [63:0] c_3;	// GTimer.scala:8:32
  reg  [63:0] rdataLatch;	// UnpipelinedLSU.scala:259:33
  wire [31:0] _GEN = (addrLatch[2:0] == 3'h1 ? rdataLatch[39:8] : 32'h0) | (addrLatch[2:0] == 3'h2 ?
                ...
                (addrLatch[2:0] == 3'h4 ? rdataLatch[63:32] : 32'h0);	// Bitwise.scala:77:12, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:179:32, :259:33, :260:46, :262:46, :263:46, :264:46, :265:46
  wire [23:0] _GEN_0 = _GEN[23:0] | (addrLatch[2:0] == 3'h5 ? rdataLatch[63:40] : 24'h0);	// LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:179:32, :259:33, :260:46, :266:46
  wire [15:0] _GEN_1 = _GEN_0[15:0] | (addrLatch[2:0] == 3'h6 ? rdataLatch[63:48] : 16'h0);	// LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:179:32, :259:33, :260:46, :267:46
  wire [31:0] _rdataPartialLoad_T_20 = (addrLatch[2:0] == 3'h0 ? rdataLatch[31:0] : 32'h0) | {_GEN[31:24], _GEN_0[23:16],
                _GEN_1[15:8], _GEN_1[7:0] | ((&(addrLatch[2:0])) ? rdataLatch[63:56] : 8'h0)};	// Bitwise.scala:77:12, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:179:32, :259:33, :260:46, :268:46
  wire        _addrAligned_T_17 = ~(|(io_in_bits_ctrl[1:0])) | io_in_bits_ctrl[1:0] == 2'h1 & ~(io_in_bits_srcA[0]) |
                ...
                io_in_bits_srcA[2:0] == 3'h0;	// LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:150:27, :185:33, :191:44, :198:50, :224:27, :287:{33,37}, :288:{33,40}, :289:40
  assign _io_ioLoadAddrMisaligned_T_3 = io_in_valid & ~isStore & ~_addrAligned_T_17;	// Mux.scala:27:73, UnpipelinedLSU.scala:180:29, :181:27, :300:{55,58}
  assign _io_ioStoreAddrMisaligned_T_2 = io_in_valid & isStore & ~_addrAligned_T_17;	// Mux.scala:27:73, UnpipelinedLSU.scala:180:29, :300:58, :301:54
  reg  [63:0] c_4;	// GTimer.scala:8:32
  always @(posedge clock) begin
    addrLatch <= io_in_bits_srcA;	// UnpipelinedLSU.scala:179:32
    rdataLatch <= io_dmem_r_bits_data;	// UnpipelinedLSU.scala:259:33
=======
  wire        _T_34 = _io_out_valid_T_5 & io_dmem_r_valid;	// Decoupled.scala:52:35, UnpipelinedLSU.scala:240:36
  wire        _T_35 = state_store & io_dmem_b_valid;	// Decoupled.scala:52:35, UnpipelinedLSU.scala:186:34
  reg  [63:0] c_1;	// GTimer.scala:8:32
  wire        _reqWmask_T_1 = io_in_bits_ctrl[1:0] == 2'h1;	// LookupTree.scala:8:38, UnpipelinedLSU.scala:191:44, :223:27
  wire        _reqWmask_T_2 = io_in_bits_ctrl[1:0] == 2'h2;	// LookupTree.scala:8:38, UnpipelinedLSU.scala:197:50, :223:27
  wire [14:0] reqWmask = {7'h0, {4'h0, {2'h0, {1'h0, ~(|(io_in_bits_ctrl[1:0]))} | {2{_reqWmask_T_1}}} |
                {4{_reqWmask_T_2}}} | {8{&(io_in_bits_ctrl[1:0])}}} << io_in_bits_srcA[2:0];	// LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:150:{20,27}, :179:32, :185:33, :223:27
  wire        wValid = io_in_valid & ~state_store & isStore & ~_io_ioLoadAddrMisaligned_T_3 &
                ~_io_ioStoreAddrMisaligned_T_2;	// UnpipelinedLSU.scala:180:29, :186:34, :204:30, :233:{71,96,99}, :299:55, :300:54
  wire        rValid = io_in_valid & _io_in_ready_T & ~isStore & ~_io_ioLoadAddrMisaligned_T_3 &
                ~_io_ioStoreAddrMisaligned_T_2;	// UnpipelinedLSU.scala:180:29, :181:27, :188:29, :233:{71,99}, :234:96, :299:55, :300:54
  assign _io_out_valid_T_5 = state_load == 2'h1;	// UnpipelinedLSU.scala:185:33, :191:44, :240:36
  wire        _T_42 = _io_ioLoadAddrMisaligned_T_3 | _io_ioStoreAddrMisaligned_T_2;	// UnpipelinedLSU.scala:243:41, :299:55, :300:54
  wire        _io_out_valid_T_10 = _T_42 | (partialLoad ? state_load == 2'h2 : (_T_34 | _T_35) & (_io_out_valid_T_5 |
                state_store));	// Decoupled.scala:52:35, UnpipelinedLSU.scala:181:36, :185:33, :186:34, :197:50, :240:36, :242:28, :243:41, :244:28, :245:36, :246:{38,54}, :247:54
  reg  [63:0] c_2;	// GTimer.scala:8:32
  reg  [63:0] rdataLatch;	// UnpipelinedLSU.scala:258:33
  wire [31:0] _GEN = (addrLatch[2:0] == 3'h1 ? rdataLatch[39:8] : 32'h0) | (addrLatch[2:0] == 3'h2 ?
                rdataLatch[47:16] : 32'h0) | (addrLatch[2:0] == 3'h3 ? rdataLatch[55:24] : 32'h0) |
                (addrLatch[2:0] == 3'h4 ? rdataLatch[63:32] : 32'h0);	// Bitwise.scala:77:12, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:179:32, :258:33, :259:46, :261:46, :262:46, :263:46, :264:46
  wire [23:0] _GEN_0 = _GEN[23:0] | (addrLatch[2:0] == 3'h5 ? rdataLatch[63:40] : 24'h0);	// LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:179:32, :258:33, :259:46, :265:46
  wire [15:0] _GEN_1 = _GEN_0[15:0] | (addrLatch[2:0] == 3'h6 ? rdataLatch[63:48] : 16'h0);	// LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:179:32, :258:33, :259:46, :266:46
  wire [31:0] _rdataPartialLoad_T_20 = (addrLatch[2:0] == 3'h0 ? rdataLatch[31:0] : 32'h0) | {_GEN[31:24], _GEN_0[23:16],
                _GEN_1[15:8], _GEN_1[7:0] | ((&(addrLatch[2:0])) ? rdataLatch[63:56] : 8'h0)};	// Bitwise.scala:77:12, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:179:32, :258:33, :259:46, :267:46
  wire        _addrAligned_T_17 = ~(|(io_in_bits_ctrl[1:0])) | io_in_bits_ctrl[1:0] == 2'h1 & ~(io_in_bits_srcA[0]) |
                io_in_bits_ctrl[1:0] == 2'h2 & io_in_bits_srcA[1:0] == 2'h0 | (&(io_in_bits_ctrl[1:0])) &
                io_in_bits_srcA[2:0] == 3'h0;	// LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:150:27, :185:33, :191:44, :197:50, :223:27, :286:{33,37}, :287:{33,40}, :288:40
  assign _io_ioLoadAddrMisaligned_T_3 = io_in_valid & ~isStore & ~_addrAligned_T_17;	// Mux.scala:27:73, UnpipelinedLSU.scala:180:29, :181:27, :299:{55,58}
  assign _io_ioStoreAddrMisaligned_T_2 = io_in_valid & isStore & ~_addrAligned_T_17;	// Mux.scala:27:73, UnpipelinedLSU.scala:180:29, :299:58, :300:54
  reg  [63:0] c_3;	// GTimer.scala:8:32
  always @(posedge clock) begin
    addrLatch <= io_in_bits_srcA;	// UnpipelinedLSU.scala:179:32
    rdataLatch <= io_dmem_r_bits_data;	// UnpipelinedLSU.scala:258:33
>>>>>>> tmp
    if (reset) begin
...
<<<<<<< HEAD
      ...
      automatic logic [3:0][1:0] _GEN_2;	// UnpipelinedLSU.scala:185:33, :188:29, :190:57, :196:44, :202:50
      _GEN_2 = {{state_load}, {2'h0}, {_io_out_valid_T_5 & io_dmem_r_valid ? {partialLoad, 1'h0} :
                                                state_load}, {io_dmem_ar_ready & rValid & ~isStore ? 2'h1 : state_load}};	// Decoupled.scala:52:35, UnpipelinedLSU.scala:179:32, :180:29, :181:{27,36}, :185:33, :188:29, :190:{44,57}, :191:44, :196:44, :198:{44,50}, :202:50, :235:96, :241:36
      state_load <= _GEN_2[state_load];	// UnpipelinedLSU.scala:185:33, :188:29, :190:57, :196:44, :202:50
      if (state_store)	// UnpipelinedLSU.scala:186:34
        state_store <= (~state_store | ~(state_store & io_dmem_b_valid)) & state_store;	// Decoupled.scala:52:35, UnpipelinedLSU.scala:186:34, :205:30, :213:{44,58}
      else	// UnpipelinedLSU.scala:186:34
        state_store <= io_dmem_aw_ready & wValid & io_dmem_w_ready & isStore | state_store;	// UnpipelinedLSU.scala:180:29, :186:34, :207:{59,71}, :208:45, :234:96
=======
    end
    else begin
      automatic logic [3:0][1:0] _GEN_2;	// UnpipelinedLSU.scala:185:33, :188:29, :190:57, :196:44, :201:50
      _GEN_2 = {{state_load}, {2'h0}, {_io_out_valid_T_5 & io_dmem_r_valid ? {partialLoad, 1'h0} :
                                                state_load}, {io_dmem_ar_ready & rValid & ~isStore ? 2'h1 : state_load}};	// Decoupled.scala:52:35, UnpipelinedLSU.scala:179:32, :180:29, :181:{27,36}, :185:33, :188:29, :190:{44,57}, :191:44, :196:44, :197:{44,50}, :201:50, :234:96, :240:36
      ...
      if (state_store)	// UnpipelinedLSU.scala:186:34
        ...
        state_store <= io_dmem_aw_ready & wValid & io_dmem_w_ready & isStore | state_store;	// UnpipelinedLSU.scala:180:29, :186:34, :206:{59,71}, :207:45, :233:96
>>>>>>> tmp
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
      c_1 <= c_1 + 64'h1;	// GTimer.scala:8:32, :9:24
      c_2 <= c_2 + 64'h1;	// GTimer.scala:8:32, :9:24
...
<<<<<<< HEAD
  ...
  `ifndef SYNTHESIS	// <stdin>:2326:10
    always @(posedge clock) begin	// Debug.scala:34:43
      automatic logic _T_28 = io_dmem_aw_ready & io_dmem_w_ready;	// UnpipelinedLSU.scala:222:28
      automatic logic _T_29 = io_dmem_ar_ready & _io_out_valid_T_5;	// UnpipelinedLSU.scala:222:59, :241:36
      automatic logic _T_23 = _T_28 | _T_29;	// UnpipelinedLSU.scala:222:{28,43,59}
      automatic logic _T_33 = _T_28 | _T_29;	// UnpipelinedLSU.scala:222:{28,59}, :225:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] LSExecUnit: ", c);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "[State] statels (%x,%x) arv %x arr %x bv %b br %b\n", state_load, state_store, rValid, io_dmem_ar_ready, io_dmem_b_valid, state_store);	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:185:33, :186:34, :235:96
      if ((`PRINTF_COND_) & _T_23 & ~reset)	// Debug.scala:34:43, UnpipelinedLSU.scala:222:43
        $fwrite(32'h80000002, "[%d] LSExecUnit: ", c_1);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_23 & ~reset)	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:222:43
        $fwrite(32'h80000002, "[LSU] addr %x, size %x, wdata_raw %x, isStore %x\n", io_in_bits_srcA, io_in_bits_ctrl[1:0], io_wdata, isStore);	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:180:29, :224:27
      if ((`PRINTF_COND_) & _T_33 & ~reset)	// Debug.scala:34:43, UnpipelinedLSU.scala:225:43
        $fwrite(32'h80000002, "[%d] LSExecUnit: ", c_2);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_33 & ~reset)	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:225:43
        $fwrite(32'h80000002, "[LSU] statels (%x,%x) Raddr %x Waddr %x rFire %x bFire %d Rdata %x\n", state_load, state_store, io_in_bits_srcA[31:0], io_in_bits_srcA[31:0], _T_39, _T_40, io_dmem_r_bits_data);	// AXI4.scala:73:27, Debug.scala:34:43, :35:31, Decoupled.scala:52:35, UnpipelinedLSU.scala:185:33, :186:34
      if ((`PRINTF_COND_) & _io_out_valid_T_10 & ~reset)	// Debug.scala:34:43, UnpipelinedLSU.scala:243:28
        $fwrite(32'h80000002, "[%d] LSExecUnit: ", c_3);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _io_out_valid_T_10 & ~reset)	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:243:28
        $fwrite(32'h80000002, "[LSU-EXECUNIT] statels (%x,%x) rResp %x wResp %x lm %x sm %x\n", state_load, state_store, _T_39, _T_40, _io_ioLoadAddrMisaligned_T_3, _io_ioStoreAddrMisaligned_T_2);	// Debug.scala:34:43, :35:31, Decoupled.scala:52:35, UnpipelinedLSU.scala:185:33, :186:34, :300:55, :301:54
      if ((`PRINTF_COND_) & _T_47 & ~reset)	// Debug.scala:34:43, UnpipelinedLSU.scala:244:41
        $fwrite(32'h80000002, "[%d] LSExecUnit: ", c_4);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_47 & ~reset)	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:244:41
    ...
    initial begin	// <stdin>:2326:10
      ...
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2326:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2326:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2326:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2326:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2326:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2326:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2326:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2326:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:2326:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:2326:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:2326:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:2326:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:2326:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:2326:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2326:10
        ...
        _RANDOM_1 = `RANDOM;	// <stdin>:2326:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2326:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2326:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2326:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2326:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2326:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2326:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2326:10
        _RANDOM_9 = `RANDOM;	// <stdin>:2326:10
        _RANDOM_10 = `RANDOM;	// <stdin>:2326:10
        _RANDOM_11 = `RANDOM;	// <stdin>:2326:10
        _RANDOM_12 = `RANDOM;	// <stdin>:2326:10
        _RANDOM_13 = `RANDOM;	// <stdin>:2326:10
        _RANDOM_14 = `RANDOM;	// <stdin>:2326:10
=======
    end
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:2346:10
    always @(posedge clock) begin	// Debug.scala:34:43
      automatic logic _T_23 = io_dmem_aw_ready & io_dmem_w_ready;	// UnpipelinedLSU.scala:221:28
      automatic logic _T_24 = io_dmem_ar_ready & _io_out_valid_T_5;	// UnpipelinedLSU.scala:221:59, :240:36
      automatic logic _T_18 = _T_23 | _T_24;	// UnpipelinedLSU.scala:221:{28,43,59}
      automatic logic _T_28 = _T_23 | _T_24;	// UnpipelinedLSU.scala:221:{28,59}, :224:43
      if ((`PRINTF_COND_) & _T_18 & ~reset)	// Debug.scala:34:43, UnpipelinedLSU.scala:221:43
        $fwrite(32'h80000002, "[%d] LSExecUnit: ", c);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_18 & ~reset)	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:221:43
        $fwrite(32'h80000002, "[LSU] addr %x, size %x, wdata_raw %x, isStore %x\n", io_in_bits_srcA, io_in_bits_ctrl[1:0], io_wdata, isStore);	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:180:29, :223:27
      if ((`PRINTF_COND_) & _T_28 & ~reset)	// Debug.scala:34:43, UnpipelinedLSU.scala:224:43
        $fwrite(32'h80000002, "[%d] LSExecUnit: ", c_1);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_28 & ~reset)	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:224:43
        $fwrite(32'h80000002, "[LSU] statels (%x,%x) Raddr %x Waddr %x rFire %x bFire %d Rdata %x\n", state_load, state_store, io_in_bits_srcA[31:0], io_in_bits_srcA[31:0], _T_34, _T_35, io_dmem_r_bits_data);	// AXI4.scala:73:27, Debug.scala:34:43, :35:31, Decoupled.scala:52:35, UnpipelinedLSU.scala:185:33, :186:34
      if ((`PRINTF_COND_) & _io_out_valid_T_10 & ~reset)	// Debug.scala:34:43, UnpipelinedLSU.scala:242:28
        $fwrite(32'h80000002, "[%d] LSExecUnit: ", c_2);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _io_out_valid_T_10 & ~reset)	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:242:28
        $fwrite(32'h80000002, "[LSU-EXECUNIT] statels (%x,%x) rResp %x wResp %x lm %x sm %x\n", state_load, state_store, _T_34, _T_35, _io_ioLoadAddrMisaligned_T_3, _io_ioStoreAddrMisaligned_T_2);	// Debug.scala:34:43, :35:31, Decoupled.scala:52:35, UnpipelinedLSU.scala:185:33, :186:34, :299:55, :300:54
      if ((`PRINTF_COND_) & _T_42 & ~reset)	// Debug.scala:34:43, UnpipelinedLSU.scala:243:41
        $fwrite(32'h80000002, "[%d] LSExecUnit: ", c_3);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_42 & ~reset)	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:243:41
        $fwrite(32'h80000002, "[EXCEPTION] misaligned addr detected\n");	// Debug.scala:34:43, :35:31
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2346:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2346:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2346:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2346:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2346:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2346:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2346:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2346:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2346:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2346:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2346:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2346:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:2346:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:2346:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:2346:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:2346:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2346:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2346:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2346:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2346:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2346:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2346:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2346:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2346:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2346:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2346:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2346:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2346:10
        _RANDOM_9 = `RANDOM;	// <stdin>:2346:10
        _RANDOM_10 = `RANDOM;	// <stdin>:2346:10
        _RANDOM_11 = `RANDOM;	// <stdin>:2346:10
        _RANDOM_12 = `RANDOM;	// <stdin>:2346:10
>>>>>>> tmp
        ...
        c_2 = {_RANDOM_6[31:3], _RANDOM_7, _RANDOM_8[2:0]};	// GTimer.scala:8:32
<<<<<<< HEAD
        c_3 = {_RANDOM_8[31:3], _RANDOM_9, _RANDOM_10[2:0]};	// GTimer.scala:8:32
        rdataLatch = {_RANDOM_10[31:3], _RANDOM_11, _RANDOM_12[2:0]};	// GTimer.scala:8:32, UnpipelinedLSU.scala:259:33
        c_4 = {_RANDOM_12[31:3], _RANDOM_13, _RANDOM_14[2:0]};	// GTimer.scala:8:32, UnpipelinedLSU.scala:259:33
      `endif // RANDOMIZE_REG_INIT
    end // initial
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_in_ready = _io_in_ready_T & ~state_store;	// <stdin>:2326:10, UnpipelinedLSU.scala:186:34, :188:29, :205:30, :251:47
  assign io_out_valid = _io_out_valid_T_10;	// <stdin>:2326:10, UnpipelinedLSU.scala:243:28
=======
        rdataLatch = {_RANDOM_8[31:3], _RANDOM_9, _RANDOM_10[2:0]};	// GTimer.scala:8:32, UnpipelinedLSU.scala:258:33
        c_3 = {_RANDOM_10[31:3], _RANDOM_11, _RANDOM_12[2:0]};	// GTimer.scala:8:32, UnpipelinedLSU.scala:258:33
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2346:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2346:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_in_ready = _io_in_ready_T & ~state_store;	// <stdin>:2346:10, UnpipelinedLSU.scala:186:34, :188:29, :204:30, :250:47
  assign io_out_valid = _io_out_valid_T_10;	// <stdin>:2346:10, UnpipelinedLSU.scala:242:28
>>>>>>> tmp
...
<<<<<<< HEAD
                64'h0) : io_dmem_r_bits_data;	// <stdin>:2326:10, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:150:20, :181:36, :278:52, :279:52, :292:27
  assign io_dmem_aw_valid = wValid;	// <stdin>:2326:10, UnpipelinedLSU.scala:234:96
  assign io_dmem_aw_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2326:10, AXI4.scala:73:27
  assign io_dmem_w_valid = wValid;	// <stdin>:2326:10, UnpipelinedLSU.scala:234:96
  assign io_dmem_w_bits_data = ((|(io_in_bits_ctrl[1:0])) ? 64'h0 : {2{{2{{2{io_wdata[7:0]}}}}}}) | (_reqWmask_T_1 ?
                ...
                ((&(io_in_bits_ctrl[1:0])) ? io_wdata : 64'h0);	// <stdin>:2326:10, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:155:48, :156:48, :157:48, :224:27
  assign io_dmem_w_bits_strb = reqWmask[7:0];	// <stdin>:2326:10, AXI4.scala:83:27, UnpipelinedLSU.scala:150:20
  assign io_dmem_b_ready = state_store;	// <stdin>:2326:10, UnpipelinedLSU.scala:186:34
  assign io_dmem_ar_valid = rValid;	// <stdin>:2326:10, UnpipelinedLSU.scala:235:96
  assign io_dmem_ar_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2326:10, AXI4.scala:73:27
  assign io_dmem_r_ready = _io_out_valid_T_5;	// <stdin>:2326:10, UnpipelinedLSU.scala:241:36
  assign io_ioLoadAddrMisaligned = _io_ioLoadAddrMisaligned_T_3;	// <stdin>:2326:10, UnpipelinedLSU.scala:300:55
  assign io_ioStoreAddrMisaligned = _io_ioStoreAddrMisaligned_T_2;	// <stdin>:2326:10, UnpipelinedLSU.scala:301:54
endmodule

module UnpipelinedLSU(	// <stdin>:2683:10
=======
                64'h0) : io_dmem_r_bits_data;	// <stdin>:2346:10, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:150:20, :181:36, :277:52, :278:52, :291:27
  assign io_dmem_aw_valid = wValid;	// <stdin>:2346:10, UnpipelinedLSU.scala:233:96
  assign io_dmem_aw_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2346:10, AXI4.scala:73:27
  assign io_dmem_w_valid = wValid;	// <stdin>:2346:10, UnpipelinedLSU.scala:233:96
  assign io_dmem_w_bits_data = ((|(io_in_bits_ctrl[1:0])) ? 64'h0 : {2{{2{{2{io_wdata[7:0]}}}}}}) | (_reqWmask_T_1 ?
                {2{{2{io_wdata[15:0]}}}} : 64'h0) | (_reqWmask_T_2 ? {2{io_wdata[31:0]}} : 64'h0) |
                ((&(io_in_bits_ctrl[1:0])) ? io_wdata : 64'h0);	// <stdin>:2346:10, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:155:48, :156:48, :157:48, :223:27
  assign io_dmem_w_bits_strb = reqWmask[7:0];	// <stdin>:2346:10, AXI4.scala:83:27, UnpipelinedLSU.scala:150:20
  assign io_dmem_b_ready = state_store;	// <stdin>:2346:10, UnpipelinedLSU.scala:186:34
  assign io_dmem_ar_valid = rValid;	// <stdin>:2346:10, UnpipelinedLSU.scala:234:96
  assign io_dmem_ar_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2346:10, AXI4.scala:73:27
  assign io_dmem_r_ready = _io_out_valid_T_5;	// <stdin>:2346:10, UnpipelinedLSU.scala:240:36
  assign io_ioLoadAddrMisaligned = _io_ioLoadAddrMisaligned_T_3;	// <stdin>:2346:10, UnpipelinedLSU.scala:299:55
  assign io_ioStoreAddrMisaligned = _io_ioStoreAddrMisaligned_T_2;	// <stdin>:2346:10, UnpipelinedLSU.scala:300:54
endmodule

module UnpipelinedLSU(	// <stdin>:2688:10
>>>>>>> tmp
  input         clock,
                reset,
                io_in_valid,
...
=======
  `ifndef SYNTHESIS	// <stdin>:2688:10
>>>>>>> tmp
    always @(posedge clock) begin	// Debug.scala:34:43
...
<<<<<<< HEAD
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2683:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2683:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2683:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2683:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2683:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2683:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2683:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2683:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2683:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2683:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2683:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2683:10
        c = {_RANDOM_0[31:2], _RANDOM_1, _RANDOM_2[1:0]};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2683:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2683:10
=======
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2688:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2688:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2688:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2688:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2688:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2688:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2688:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2688:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2688:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2688:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2688:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2688:10
        c = {_RANDOM_0[31:2], _RANDOM_1, _RANDOM_2[1:0]};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2688:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2688:10
>>>>>>> tmp
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
...
<<<<<<< HEAD
  assign io_out_valid = _lsExecUnit_io_out_valid;	// <stdin>:2683:10, UnpipelinedLSU.scala:32:32
endmodule

module Multiplier(	// <stdin>:2804:10
=======
  assign io_out_valid = _lsExecUnit_io_out_valid;	// <stdin>:2688:10, UnpipelinedLSU.scala:32:32
endmodule

module Multiplier(	// <stdin>:2809:10
>>>>>>> tmp
...
<<<<<<< HEAD
  assign io_out_bits = {{65{io_in_bits_0[64]}}, io_in_bits_0} * {{65{io_in_bits_1[64]}}, io_in_bits_1};	// <stdin>:2804:10, MDU.scala:48:44
endmodule

module Divider(	// <stdin>:2817:10
=======
  assign io_out_bits = {{65{io_in_bits_0[64]}}, io_in_bits_0} * {{65{io_in_bits_1[64]}}, io_in_bits_1};	// <stdin>:2809:10, MDU.scala:48:44
endmodule

module Divider(	// <stdin>:2822:10
>>>>>>> tmp
...
<<<<<<< HEAD
                io_in_bits_1})};	// <stdin>:2817:10, MDU.scala:57:{21,46}
endmodule

module MDU(	// <stdin>:2830:10
=======
                io_in_bits_1})};	// <stdin>:2822:10, MDU.scala:57:{21,46}
endmodule

module MDU(	// <stdin>:2835:10
>>>>>>> tmp
  input  [63:0] io_in_bits_srcA,
                io_in_bits_srcB,
  input  [6:0]  io_in_bits_ctrl,
...
<<<<<<< HEAD
  assign io_out_bits = io_in_bits_ctrl[3] ? {{32{res[31]}}, res[31:0]} : res;	// <stdin>:2830:10, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, MDU.scala:35:31, :120:18, :121:{27,44}
endmodule

module CSR(	// <stdin>:2939:10
=======
  assign io_out_bits = io_in_bits_ctrl[3] ? {{32{res[31]}}, res[31:0]} : res;	// <stdin>:2835:10, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, MDU.scala:35:31, :120:18, :121:{27,44}
endmodule

module CSR(	// <stdin>:2944:10
>>>>>>> tmp
  input         clock,
                reset,
                io_in_valid,
...
<<<<<<< HEAD
                ~(io_cfIn_instr[19:15])} : 64'h0);	// <stdin>:2939:10, CSR.scala:232:41, :235:43, :236:{43,45}, :238:43, :239:{43,45}, Cat.scala:33:92, LookupTree.scala:8:38, Mux.scala:27:73
  wire        _wen_T_4 = io_in_valid & (|io_in_bits_ctrl) & (io_in_bits_srcB[11:0] != 12'h180 | _wdata_T_22[63:60]
                == 4'h0 | _wdata_T_22[63:60] == 4'h8);	// <stdin>:2939:10, CSR.scala:230:24, :243:{44,66,93,115}, :246:{34,51,60,71}, Mux.scala:27:73
  wire        isIllegalAccess = priviledgeMode < io_in_bits_srcB[9:8] | _wen_T_4 & (&(io_in_bits_srcB[11:10])) &
                ~((_justRead_T | _justRead_T_1) & io_in_bits_srcA == 64'h0);	// <stdin>:2939:10, CSR.scala:213:37, :246:51, :247:{44,50}, :248:{46,72,80}, :249:{42,51,64,67}, :250:45, LookupTree.scala:8:38
=======
                ~(io_cfIn_instr[19:15])} : 64'h0);	// <stdin>:2944:10, CSR.scala:232:41, :235:43, :236:{43,45}, :238:43, :239:{43,45}, Cat.scala:33:92, LookupTree.scala:8:38, Mux.scala:27:73
  wire        _wen_T_4 = io_in_valid & (|io_in_bits_ctrl) & (io_in_bits_srcB[11:0] != 12'h180 | _wdata_T_22[63:60]
                == 4'h0 | _wdata_T_22[63:60] == 4'h8);	// <stdin>:2944:10, CSR.scala:230:24, :243:{44,66,93,115}, :246:{34,51,60,71}, Mux.scala:27:73
  wire        isIllegalAccess = priviledgeMode < io_in_bits_srcB[9:8] | _wen_T_4 & (&(io_in_bits_srcB[11:10])) &
                ~((_justRead_T | _justRead_T_1) & io_in_bits_srcA == 64'h0);	// <stdin>:2944:10, CSR.scala:213:37, :246:51, :247:{44,50}, :248:{46,72,80}, :249:{42,51,64,67}, :250:45, LookupTree.scala:8:38
>>>>>>> tmp
...
<<<<<<< HEAD
                mstatus : 64'h0) | (_isIllegalAddr_illegalAddr_T_8 ? mepc : 64'h0);	// <stdin>:2939:10, CSR.scala:172:34, :173:34, :175:34, :176:34, :206:27, LookupTree.scala:8:38, Mux.scala:27:73
  wire        resetSatp = _resetSatp_T & _wen_T_4;	// CSR.scala:246:51, :254:41, LookupTree.scala:8:38
  wire        _T_21 = io_in_bits_ctrl == 7'h0;	// CSR.scala:246:34, :259:52
  wire        _isEcall_T_2 = io_in_bits_srcB[11:0] == 12'h0 & _T_21;	// CSR.scala:230:24, :259:52, :260:{28,42}
  wire        _csrExpectionVec_3_T = io_in_valid & io_in_bits_srcB[11:0] == 12'h1 & _T_21;	// CSR.scala:230:24, :259:{29,52}, :272:52
=======
                mstatus : 64'h0) | (_isIllegalAddr_illegalAddr_T_8 ? mepc : 64'h0);	// <stdin>:2944:10, CSR.scala:172:34, :173:34, :175:34, :176:34, :206:27, LookupTree.scala:8:38, Mux.scala:27:73
  wire        resetSatp = _resetSatp_T & _wen_T_4;	// CSR.scala:246:51, :254:41, LookupTree.scala:8:38
...
<<<<<<< HEAD
  ...
  always @(posedge clock) begin
    if (reset) begin
      mtvec <= 64'h0;	// <stdin>:2939:10, CSR.scala:172:34
      mcause <= 64'h0;	// <stdin>:2939:10, CSR.scala:173:34
      mepc <= 64'h0;	// <stdin>:2939:10, CSR.scala:175:34
      mstatus <= 64'hA00001800;	// CSR.scala:176:34
      satp <= 64'h0;	// <stdin>:2939:10, CSR.scala:206:27
      priviledgeMode <= 2'h3;	// CSR.scala:213:37
      c <= 64'h0;	// <stdin>:2939:10, GTimer.scala:8:32
=======
  always @(posedge clock) begin
    if (reset) begin
      mtvec <= 64'h0;	// <stdin>:2944:10, CSR.scala:172:34
      mcause <= 64'h0;	// <stdin>:2944:10, CSR.scala:173:34
      mepc <= 64'h0;	// <stdin>:2944:10, CSR.scala:175:34
      mstatus <= 64'hA00001800;	// CSR.scala:176:34
      satp <= 64'h0;	// <stdin>:2944:10, CSR.scala:206:27
      priviledgeMode <= 2'h3;	// CSR.scala:213:37
>>>>>>> tmp
    end
    else begin
...
<<<<<<< HEAD
                                                                io_cfIn_exceptionVec_6 ? 4'h6 : {1'h0, io_cfIn_exceptionVec_4, 2'h0}};	// <stdin>:2939:10, CSR.scala:173:34, :243:115, :267:75, :272:52, :273:72, :274:76, :275:76, :279:{56,74}, :281:80, :284:47
        mepc <= io_cfIn_pc;	// CSR.scala:175:34
        mstatus <= {mstatus[63:13], priviledgeMode, mstatus[10:8], mstatus[3], mstatus[6:4], 1'h0,
                                                                mstatus[2:0]};	// <stdin>:2939:10, CSR.scala:176:34, :213:37, :310:39, :316:59, :329:39
=======
                                                                io_cfIn_exceptionVec_6 ? 4'h6 : {1'h0, io_cfIn_exceptionVec_4, 2'h0}};	// <stdin>:2944:10, CSR.scala:173:34, :243:115, :267:75, :272:52, :273:72, :274:76, :275:76, :279:{56,74}, :281:80, :284:47
        mepc <= io_cfIn_pc;	// CSR.scala:175:34
        mstatus <= {mstatus[63:13], priviledgeMode, mstatus[10:8], mstatus[3], mstatus[6:4], 1'h0,
                                                                mstatus[2:0]};	// <stdin>:2944:10, CSR.scala:176:34, :213:37, :310:39, :316:59, :329:39
>>>>>>> tmp
        priviledgeMode <= 2'h3;	// CSR.scala:213:37
      end
...
<<<<<<< HEAD
        if (io_in_valid & io_in_bits_srcB[11:0] == 12'h302 & _T_21) begin	// CSR.scala:230:24, :259:52, :261:27, :303:21
          mstatus <= {mstatus[63:13], 2'h0, mstatus[10:8], 1'h1, mstatus[6:4], mstatus[7], mstatus[2:0]};	// <stdin>:2939:10, CSR.scala:176:34, :279:74, :304:59, :310:39
=======
        if (io_in_valid & io_in_bits_srcB[11:0] == 12'h302 & _io_redirect_valid_T) begin	// CSR.scala:230:24, :259:52, :261:27, :303:21
          mstatus <= {mstatus[63:13], 2'h0, mstatus[10:8], 1'h1, mstatus[6:4], mstatus[7], mstatus[2:0]};	// <stdin>:2944:10, CSR.scala:176:34, :279:74, :304:59, :310:39
>>>>>>> tmp
...
<<<<<<< HEAD
  ...
  `ifndef SYNTHESIS	// <stdin>:2939:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] CSR: ", c);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "Redirect valid %b|%b|%b\n", io_in_valid & _T_21, raiseExceptionIntr, resetSatp);	// CSR.scala:254:41, :259:52, :287:64, :295:23, Debug.scala:34:43, :35:31
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2939:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2939:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:2939:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:2939:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2939:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2939:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2939:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_9 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_10 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_11 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_12 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_13 = `RANDOM;	// <stdin>:2939:10
        _RANDOM_14 = `RANDOM;	// <stdin>:2939:10
=======
    end
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:2944:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2944:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2944:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2944:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2944:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2944:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2944:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2944:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2944:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2944:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2944:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2944:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2944:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:2944:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:2944:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:2944:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:2944:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2944:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2944:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2944:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2944:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2944:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2944:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2944:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2944:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2944:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2944:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2944:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2944:10
        _RANDOM_9 = `RANDOM;	// <stdin>:2944:10
        _RANDOM_10 = `RANDOM;	// <stdin>:2944:10
        _RANDOM_11 = `RANDOM;	// <stdin>:2944:10
        _RANDOM_12 = `RANDOM;	// <stdin>:2944:10
>>>>>>> tmp
...
<<<<<<< HEAD
        c = {_RANDOM_12[31:2], _RANDOM_13, _RANDOM_14[1:0]};	// CSR.scala:213:37, GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2939:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2939:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_out_bits = _rdata_T_18;	// <stdin>:2939:10, Mux.scala:27:73
  assign io_redirect_target = resetSatp ? io_cfIn_pc + 64'h4 : raiseExceptionIntr ? mtvec : mepc;	// <stdin>:2939:10, CSR.scala:172:34, :175:34, :254:41, :287:64, :292:{34,57,67}
  assign io_redirect_valid = io_in_valid & _T_21 | raiseExceptionIntr | resetSatp;	// <stdin>:2939:10, CSR.scala:254:41, :259:52, :287:64, :290:{37,84}
  assign io_wenFix = |_GEN;	// <stdin>:2939:10, CSR.scala:279:56, :280:48
  assign io_csr_regs_0 = mstatus;	// <stdin>:2939:10, CSR.scala:176:34
  assign io_csr_regs_1 = mtvec;	// <stdin>:2939:10, CSR.scala:172:34
  assign io_csr_regs_2 = mepc;	// <stdin>:2939:10, CSR.scala:175:34
  assign io_csr_regs_3 = mcause;	// <stdin>:2939:10, CSR.scala:173:34
endmodule

module EXU(	// <stdin>:3694:10
=======
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2944:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2944:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_out_bits = _rdata_T_18;	// <stdin>:2944:10, Mux.scala:27:73
  assign io_redirect_target = resetSatp ? io_cfIn_pc + 64'h4 : raiseExceptionIntr ? mtvec : mepc;	// <stdin>:2944:10, CSR.scala:172:34, :175:34, :254:41, :287:64, :292:{34,57,67}
  assign io_redirect_valid = io_in_valid & _io_redirect_valid_T | raiseExceptionIntr | resetSatp;	// <stdin>:2944:10, CSR.scala:254:41, :259:52, :287:64, :290:{37,84}
  assign io_wenFix = |_GEN;	// <stdin>:2944:10, CSR.scala:279:56, :280:48
  assign io_csr_regs_0 = mstatus;	// <stdin>:2944:10, CSR.scala:176:34
  assign io_csr_regs_1 = mtvec;	// <stdin>:2944:10, CSR.scala:172:34
  assign io_csr_regs_2 = mepc;	// <stdin>:2944:10, CSR.scala:175:34
  assign io_csr_regs_3 = mcause;	// <stdin>:2944:10, CSR.scala:173:34
endmodule

module EXU(	// <stdin>:3682:10
>>>>>>> tmp
  input         clock,
                reset,
                io_in_valid,
  ...
  always @(posedge clock) begin
    if (reset)
<<<<<<< HEAD
      c <= 64'h0;	// <stdin>:3694:10, GTimer.scala:8:32
    else
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:3694:10
=======
      c <= 64'h0;	// <stdin>:3682:10, GTimer.scala:8:32
    else
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:3682:10
>>>>>>> tmp
    always @(posedge clock) begin	// Debug.scala:34:43
...
<<<<<<< HEAD
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3694:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3694:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3694:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3694:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3694:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3694:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3694:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3694:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3694:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3694:10
        c = {_RANDOM_0, _RANDOM_1};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3694:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3694:10
=======
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3682:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3682:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3682:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3682:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3682:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3682:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3682:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3682:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3682:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3682:10
        c = {_RANDOM_0, _RANDOM_1};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3682:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3682:10
>>>>>>> tmp
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
...
<<<<<<< HEAD
  assign io_in_ready = ~io_in_valid | _io_out_valid_T_4;	// <stdin>:3694:10, EXU.scala:91:37, :102:{24,37}
  assign io_out_valid = _io_out_valid_T_4;	// <stdin>:3694:10, EXU.scala:91:37
  assign io_out_bits_decode_cf_instr = io_in_bits_cf_instr;	// <stdin>:3694:10
  assign io_out_bits_decode_cf_pc = io_in_bits_cf_pc;	// <stdin>:3694:10
  assign io_out_bits_decode_cf_pnpc = io_in_bits_cf_pnpc;	// <stdin>:3694:10
  assign io_out_bits_decode_cf_redirect_target = _csr_io_redirect_valid ? _csr_io_redirect_target : _alu_io_redirect_target;	// <stdin>:3694:10, EXU.scala:33:25, :57:25, :84:20
  assign io_out_bits_decode_cf_redirect_valid = _csr_io_redirect_valid ? _csr_io_redirect_valid : _alu_io_redirect_valid;	// <stdin>:3694:10, EXU.scala:33:25, :57:25, :84:20
  assign io_out_bits_decode_ctrl_fuType = io_in_bits_ctrl_fuType;	// <stdin>:3694:10
  assign io_out_bits_decode_ctrl_rfWen = io_in_bits_ctrl_rfWen & (~_lsu_io_ioLoadAddrMisaligned & ~_lsu_io_ioStoreAddrMisaligned |
                ~_fuValids_1_T_3) & ~(_csr_io_wenFix & _fuValids_3_T_3);	// <stdin>:3694:10, EXU.scala:30:87, :42:25, :57:25, :75:{40,69,72,102,105,128,131,147}
  assign io_out_bits_decode_ctrl_rfDest = io_in_bits_ctrl_rfDest;	// <stdin>:3694:10
  assign io_out_bits_commits_0 = _alu_io_out_bits;	// <stdin>:3694:10, EXU.scala:33:25
  assign io_out_bits_commits_1 = _lsu_io_out_bits;	// <stdin>:3694:10, EXU.scala:42:25
  assign io_forward_valid = io_in_valid;	// <stdin>:3694:10
  assign io_forward_wb_rfWen = io_in_bits_ctrl_rfWen;	// <stdin>:3694:10
  assign io_forward_wb_rfDest = io_in_bits_ctrl_rfDest;	// <stdin>:3694:10
  assign io_forward_wb_rfData = _alu_io_out_valid ? _alu_io_out_bits : _lsu_io_out_bits;	// <stdin>:3694:10, EXU.scala:33:25, :42:25, :107:36
  assign io_forward_fuType = io_in_bits_ctrl_fuType;	// <stdin>:3694:10
endmodule

module WBU(	// <stdin>:3975:10
=======
  assign io_in_ready = ~io_in_valid | _io_out_valid_T_4;	// <stdin>:3682:10, EXU.scala:91:37, :102:{24,37}
  assign io_out_valid = _io_out_valid_T_4;	// <stdin>:3682:10, EXU.scala:91:37
  assign io_out_bits_decode_cf_instr = io_in_bits_cf_instr;	// <stdin>:3682:10
  assign io_out_bits_decode_cf_pc = io_in_bits_cf_pc;	// <stdin>:3682:10
  assign io_out_bits_decode_cf_pnpc = io_in_bits_cf_pnpc;	// <stdin>:3682:10
  assign io_out_bits_decode_cf_redirect_target = _csr_io_redirect_valid ? _csr_io_redirect_target : _alu_io_redirect_target;	// <stdin>:3682:10, EXU.scala:33:25, :57:25, :84:20
  assign io_out_bits_decode_cf_redirect_valid = _csr_io_redirect_valid ? _csr_io_redirect_valid : _alu_io_redirect_valid;	// <stdin>:3682:10, EXU.scala:33:25, :57:25, :84:20
  assign io_out_bits_decode_ctrl_fuType = io_in_bits_ctrl_fuType;	// <stdin>:3682:10
  assign io_out_bits_decode_ctrl_rfWen = io_in_bits_ctrl_rfWen & (~_lsu_io_ioLoadAddrMisaligned & ~_lsu_io_ioStoreAddrMisaligned |
                ~_fuValids_1_T_3) & ~(_csr_io_wenFix & _fuValids_3_T_3);	// <stdin>:3682:10, EXU.scala:30:87, :42:25, :57:25, :75:{40,69,72,102,105,128,131,147}
  assign io_out_bits_decode_ctrl_rfDest = io_in_bits_ctrl_rfDest;	// <stdin>:3682:10
  assign io_out_bits_commits_0 = _alu_io_out_bits;	// <stdin>:3682:10, EXU.scala:33:25
  assign io_out_bits_commits_1 = _lsu_io_out_bits;	// <stdin>:3682:10, EXU.scala:42:25
  assign io_forward_valid = io_in_valid;	// <stdin>:3682:10
  assign io_forward_wb_rfWen = io_in_bits_ctrl_rfWen;	// <stdin>:3682:10
  assign io_forward_wb_rfDest = io_in_bits_ctrl_rfDest;	// <stdin>:3682:10
  assign io_forward_wb_rfData = _alu_io_out_valid ? _alu_io_out_bits : _lsu_io_out_bits;	// <stdin>:3682:10, EXU.scala:33:25, :42:25, :107:36
  assign io_forward_fuType = io_in_bits_ctrl_fuType;	// <stdin>:3682:10
endmodule

module WBU(	// <stdin>:3963:10
>>>>>>> tmp
  input         clock,
                reset,
                io_in_valid,
...
<<<<<<< HEAD
                {io_in_bits_commits_0}};	// <stdin>:3975:10, WBU.scala:21:22
=======
                {io_in_bits_commits_0}};	// <stdin>:3963:10, WBU.scala:21:22
>>>>>>> tmp
  ...
  always @(posedge clock) begin
    if (reset)
<<<<<<< HEAD
      c <= 64'h0;	// <stdin>:3975:10, GTimer.scala:8:32
    else
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:3975:10
=======
      c <= 64'h0;	// <stdin>:3963:10, GTimer.scala:8:32
    else
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:3963:10
>>>>>>> tmp
    always @(posedge clock) begin	// Debug.scala:34:43
...
<<<<<<< HEAD
        $fwrite(32'h80000002, "[COMMIT] pc = 0x%x inst %x wen %x wdst %x wdata %x mmio %x intrNO %x\n", io_in_bits_decode_cf_pc, io_in_bits_decode_cf_instr, _io_wb_rfWen_T, io_in_bits_decode_ctrl_rfDest, _GEN_1, 1'h0, 64'h0);	// <stdin>:3975:10, Debug.scala:34:43, :35:31, WBU.scala:19:53, :21:22
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3975:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3975:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3975:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3975:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3975:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3975:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3975:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3975:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3975:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3975:10
        c = {_RANDOM_0, _RANDOM_1};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3975:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3975:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_wb_rfWen = _io_wb_rfWen_T;	// <stdin>:3975:10, WBU.scala:19:53
  assign io_wb_rfDest = io_in_bits_decode_ctrl_rfDest;	// <stdin>:3975:10
  assign io_wb_rfData = _GEN_1;	// <stdin>:3975:10, WBU.scala:21:22
  assign io_redirect_target = io_in_bits_decode_cf_redirect_target;	// <stdin>:3975:10
  assign io_redirect_valid = _io_difftest_redirect_valid_T;	// <stdin>:3975:10, WBU.scala:27:66
  assign io_difftest_commit_valid = io_in_valid;	// <stdin>:3975:10
  assign io_difftest_commit_bits_decode_cf_pnpc = io_in_bits_decode_cf_pnpc;	// <stdin>:3975:10
  assign io_difftest_redirect_target = io_in_bits_decode_cf_redirect_target;	// <stdin>:3975:10
  assign io_difftest_redirect_valid = _io_difftest_redirect_valid_T;	// <stdin>:3975:10, WBU.scala:27:66
endmodule

module Backend_inorder(	// <stdin>:4010:10
=======
        $fwrite(32'h80000002, "[COMMIT] pc = 0x%x inst %x wen %x wdst %x wdata %x mmio %x intrNO %x\n", io_in_bits_decode_cf_pc, io_in_bits_decode_cf_instr, _io_wb_rfWen_T, io_in_bits_decode_ctrl_rfDest, _GEN_1, 1'h0, 64'h0);	// <stdin>:3963:10, Debug.scala:34:43, :35:31, WBU.scala:19:53, :21:22
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3963:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3963:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3963:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3963:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3963:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3963:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3963:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3963:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3963:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3963:10
        c = {_RANDOM_0, _RANDOM_1};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3963:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3963:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_wb_rfWen = _io_wb_rfWen_T;	// <stdin>:3963:10, WBU.scala:19:53
  assign io_wb_rfDest = io_in_bits_decode_ctrl_rfDest;	// <stdin>:3963:10
  assign io_wb_rfData = _GEN_1;	// <stdin>:3963:10, WBU.scala:21:22
  assign io_redirect_target = io_in_bits_decode_cf_redirect_target;	// <stdin>:3963:10
  assign io_redirect_valid = _io_difftest_redirect_valid_T;	// <stdin>:3963:10, WBU.scala:27:66
  assign io_difftest_commit_valid = io_in_valid;	// <stdin>:3963:10
  assign io_difftest_commit_bits_decode_cf_pnpc = io_in_bits_decode_cf_pnpc;	// <stdin>:3963:10
  assign io_difftest_redirect_target = io_in_bits_decode_cf_redirect_target;	// <stdin>:3963:10
  assign io_difftest_redirect_valid = _io_difftest_redirect_valid_T;	// <stdin>:3963:10, WBU.scala:27:66
endmodule

module Backend_inorder(	// <stdin>:3998:10
>>>>>>> tmp
  input         clock,
                reset,
                io_in_0_valid,
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
<<<<<<< HEAD
      valid <= 1'h0;	// <stdin>:4010:10, Pipeline.scala:10:28
      valid_1 <= 1'h0;	// <stdin>:4010:10, Pipeline.scala:10:28
      c <= 64'h0;	// <stdin>:4010:10, GTimer.scala:8:32
      c_1 <= 64'h0;	// <stdin>:4010:10, GTimer.scala:8:32
=======
      valid <= 1'h0;	// <stdin>:3998:10, Pipeline.scala:10:28
      valid_1 <= 1'h0;	// <stdin>:3998:10, Pipeline.scala:10:28
      c <= 64'h0;	// <stdin>:3998:10, GTimer.scala:8:32
      c_1 <= 64'h0;	// <stdin>:3998:10, GTimer.scala:8:32
>>>>>>> tmp
    end
    else begin
...
<<<<<<< HEAD
  `ifndef SYNTHESIS	// <stdin>:4010:10
=======
  `ifndef SYNTHESIS	// <stdin>:3998:10
>>>>>>> tmp
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
<<<<<<< HEAD
        $fwrite(32'h80000002, "flush = %b, isu:(%d,%d), exu:(%d,%d)\n", io_flush, _isu_io_out_valid, _exu_io_in_ready, _exu_io_out_valid, 1'h1);	// <stdin>:4010:10, Backend.scala:27:25, :28:25, Debug.scala:34:43, :35:31
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4010:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4010:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_21;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_22;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_23;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_24;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_25;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_26;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_27;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_28;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_29;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_30;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_31;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_32;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_33;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_34;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_35;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_36;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_37;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_38;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_39;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_40;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_41;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_42;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_43;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_44;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_45;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_46;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_47;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_48;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_49;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_50;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_51;	// <stdin>:4010:10
      automatic logic [31:0] _RANDOM_52;	// <stdin>:4010:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4010:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4010:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4010:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_3 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_4 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_5 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_6 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_7 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_8 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_9 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_10 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_11 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_12 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_13 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_14 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_15 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_16 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_17 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_18 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_19 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_20 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_21 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_22 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_23 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_24 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_25 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_26 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_27 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_28 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_29 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_30 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_31 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_32 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_33 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_34 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_35 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_36 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_37 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_38 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_39 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_40 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_41 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_42 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_43 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_44 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_45 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_46 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_47 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_48 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_49 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_50 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_51 = `RANDOM;	// <stdin>:4010:10
        _RANDOM_52 = `RANDOM;	// <stdin>:4010:10
=======
        $fwrite(32'h80000002, "flush = %b, isu:(%d,%d), exu:(%d,%d)\n", io_flush, _isu_io_out_valid, _exu_io_in_ready, _exu_io_out_valid, 1'h1);	// <stdin>:3998:10, Backend.scala:27:25, :28:25, Debug.scala:34:43, :35:31
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3998:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3998:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_21;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_22;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_23;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_24;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_25;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_26;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_27;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_28;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_29;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_30;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_31;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_32;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_33;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_34;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_35;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_36;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_37;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_38;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_39;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_40;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_41;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_42;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_43;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_44;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_45;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_46;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_47;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_48;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_49;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_50;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_51;	// <stdin>:3998:10
      automatic logic [31:0] _RANDOM_52;	// <stdin>:3998:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3998:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3998:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3998:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_2 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_3 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_4 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_5 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_6 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_7 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_8 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_9 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_10 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_11 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_12 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_13 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_14 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_15 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_16 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_17 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_18 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_19 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_20 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_21 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_22 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_23 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_24 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_25 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_26 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_27 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_28 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_29 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_30 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_31 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_32 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_33 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_34 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_35 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_36 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_37 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_38 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_39 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_40 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_41 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_42 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_43 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_44 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_45 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_46 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_47 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_48 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_49 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_50 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_51 = `RANDOM;	// <stdin>:3998:10
        _RANDOM_52 = `RANDOM;	// <stdin>:3998:10
>>>>>>> tmp
        valid = _RANDOM_0[0];	// Pipeline.scala:10:28
...
<<<<<<< HEAD
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4010:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4010:10
=======
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3998:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3998:10
>>>>>>> tmp
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
...
<<<<<<< HEAD
module Core(	// <stdin>:4233:10
=======
module Core(	// <stdin>:4221:10
>>>>>>> tmp
  input         clock,
                reset,
                io_imem_ar_ready,
...
<<<<<<< HEAD
  wire        _frontend_io_out_0_ready_T_1 = ringBufferHead - 1'h1 != ringBufferTail & {1'h0, ringBufferHead} - 2'h2 != {1'h0,
                ringBufferTail} | ~_frontend_io_out_0_valid;	// <stdin>:4233:10, PipelineVector.scala:13:45, :14:45, :16:{75,86,137}, :33:{48,51}, TopMain.scala:31:50
=======
  wire        ringBufferAllowin = ringBufferHead - 1'h1 != ringBufferTail & {1'h0, ringBufferHead} - 2'h2 != {1'h0,
                ringBufferTail};	// <stdin>:4221:10, PipelineVector.scala:13:45, :14:45, :16:{75,86,137}
  wire [1:0]  enqueueSize = {1'h0, _frontend_io_out_0_valid} + {1'h0, _frontend_io_out_1_valid};	// <stdin>:4221:10, PipelineVector.scala:23:56, TopMain.scala:31:50
...
>>>>>>> tmp
  ...
  always @(posedge clock) begin
    if (reset) begin
<<<<<<< HEAD
      dataBuffer_0_cf_instr <= 64'h0;	// <stdin>:4233:10, PipelineVector.scala:12:41
      dataBuffer_0_cf_pc <= 64'h0;	// <stdin>:4233:10, PipelineVector.scala:12:41
      dataBuffer_0_cf_pnpc <= 64'h0;	// <stdin>:4233:10, PipelineVector.scala:12:41
      dataBuffer_0_cf_exceptionVec_2 <= 1'h0;	// <stdin>:4233:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_srcAType <= 1'h0;	// <stdin>:4233:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_srcBType <= 1'h0;	// <stdin>:4233:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_fuType <= 3'h0;	// <stdin>:4233:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_fuCtrl <= 7'h0;	// <stdin>:4233:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfSrcA <= 5'h0;	// <stdin>:4233:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfSrcB <= 5'h0;	// <stdin>:4233:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfWen <= 1'h0;	// <stdin>:4233:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfDest <= 5'h0;	// <stdin>:4233:10, PipelineVector.scala:12:41
      dataBuffer_0_data_imm <= 64'h0;	// <stdin>:4233:10, PipelineVector.scala:12:41
      ringBufferHead <= 1'h0;	// <stdin>:4233:10, PipelineVector.scala:13:45
      ringBufferTail <= 1'h0;	// <stdin>:4233:10, PipelineVector.scala:14:45
      c <= 64'h0;	// <stdin>:4233:10, GTimer.scala:8:32
    end
    else begin
      automatic logic _wen_T = _frontend_io_out_0_ready_T_1 & _frontend_io_out_0_valid;	// Decoupled.scala:52:35, PipelineVector.scala:33:48, TopMain.scala:31:50
      if (_wen_T & _frontend_io_out_0_valid) begin	// Decoupled.scala:52:35, PipelineVector.scala:12:41, :27:28, :29:41, TopMain.scala:31:50
        ...
        dataBuffer_0_cf_exceptionVec_2 <= _frontend_io_out_0_valid & _frontend_io_out_0_bits_cf_exceptionVec_2;	// PipelineVector.scala:12:41, :28:81, TopMain.scala:31:50
        dataBuffer_0_ctrl_srcAType <= _frontend_io_out_0_valid & _frontend_io_out_0_bits_ctrl_srcAType;	// PipelineVector.scala:12:41, :28:81, TopMain.scala:31:50
        dataBuffer_0_ctrl_srcBType <= _frontend_io_out_0_valid & _frontend_io_out_0_bits_ctrl_srcBType;	// PipelineVector.scala:12:41, :28:81, TopMain.scala:31:50
        ...
        dataBuffer_0_ctrl_rfWen <= _frontend_io_out_0_valid & _frontend_io_out_0_bits_ctrl_rfWen;	// PipelineVector.scala:12:41, :28:81, TopMain.scala:31:50
      ...
      ringBufferHead <= ~(_frontend_io_flushVec[1]) & (_wen_T ? ringBufferHead + _frontend_io_out_0_valid :
                                                ringBufferHead);	// Decoupled.scala:52:35, PipelineVector.scala:13:45, :27:28, :30:{40,58}, :54:30, :55:36, TopMain.scala:31:50, :42:150
=======
      dataBuffer_0_cf_instr <= 64'h0;	// <stdin>:4221:10, PipelineVector.scala:12:41
      dataBuffer_0_cf_pc <= 64'h0;	// <stdin>:4221:10, PipelineVector.scala:12:41
      dataBuffer_0_cf_pnpc <= 64'h0;	// <stdin>:4221:10, PipelineVector.scala:12:41
      dataBuffer_0_cf_exceptionVec_2 <= 1'h0;	// <stdin>:4221:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_srcAType <= 1'h0;	// <stdin>:4221:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_srcBType <= 1'h0;	// <stdin>:4221:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_fuType <= 3'h0;	// <stdin>:4221:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_fuCtrl <= 7'h0;	// <stdin>:4221:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfSrcA <= 5'h0;	// <stdin>:4221:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfSrcB <= 5'h0;	// <stdin>:4221:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfWen <= 1'h0;	// <stdin>:4221:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfDest <= 5'h0;	// <stdin>:4221:10, PipelineVector.scala:12:41
      dataBuffer_0_data_imm <= 64'h0;	// <stdin>:4221:10, PipelineVector.scala:12:41
      ringBufferHead <= 1'h0;	// <stdin>:4221:10, PipelineVector.scala:13:45
      ringBufferTail <= 1'h0;	// <stdin>:4221:10, PipelineVector.scala:14:45
      c <= 64'h0;	// <stdin>:4221:10, GTimer.scala:8:32
    end
    else begin
  ...
  `ifndef SYNTHESIS	// <stdin>:4233:10
    always @(posedge clock) begin	// PipelineVector.scala:60:27
      if ((`PRINTF_COND_) & ~reset)	// PipelineVector.scala:60:27
        $fwrite(32'h80000002, "[DPQ] size %x head %x tail %x enq %x deq %x\n", 1'h0, ringBufferHead, ringBufferTail, {1'h0, _frontend_io_out_0_valid}, {1'h0, _dequeueSize_T});	// <stdin>:4233:10, Decoupled.scala:52:35, PipelineVector.scala:13:45, :14:45, :23:56, :47:52, :60:27, TopMain.scala:31:50
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:35:31, PipelineVector.scala:60:27
        $fwrite(32'h80000002, "flush = %b, 0: frontend:(%d,%d), backend:(%d,%d); 1: frontend:(%d,%d), backend:(%d,%d)\n", _frontend_io_flushVec, _frontend_io_out_0_valid, _frontend_io_out_0_ready_T_1, _backend_io_in_0_valid_T, _backend_io_in_0_ready, 1'h0, 1'h1, _backend_io_in_1_valid_T_1, 1'h0);	// <stdin>:4233:10, Debug.scala:35:31, PipelineVector.scala:33:48, :39:46, :44:66, :60:27, TopMain.scala:31:50, :39:37
    end // always @(posedge)
    ...
    initial begin	// <stdin>:4233:10
      ...
      automatic logic [31:0] _RANDOM_8;	// <stdin>:4233:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:4233:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:4233:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:4233:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:4233:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:4233:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:4233:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:4233:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:4233:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:4233:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:4233:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:4233:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:4233:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4233:10
        ...
        _RANDOM_8 = `RANDOM;	// <stdin>:4233:10
        _RANDOM_9 = `RANDOM;	// <stdin>:4233:10
        _RANDOM_10 = `RANDOM;	// <stdin>:4233:10
        _RANDOM_11 = `RANDOM;	// <stdin>:4233:10
        _RANDOM_12 = `RANDOM;	// <stdin>:4233:10
        _RANDOM_13 = `RANDOM;	// <stdin>:4233:10
        _RANDOM_14 = `RANDOM;	// <stdin>:4233:10
        _RANDOM_15 = `RANDOM;	// <stdin>:4233:10
        _RANDOM_16 = `RANDOM;	// <stdin>:4233:10
        _RANDOM_17 = `RANDOM;	// <stdin>:4233:10
        _RANDOM_18 = `RANDOM;	// <stdin>:4233:10
        _RANDOM_19 = `RANDOM;	// <stdin>:4233:10
        _RANDOM_20 = `RANDOM;	// <stdin>:4233:10
=======
  `ifndef SYNTHESIS	// <stdin>:4221:10
    always @(posedge clock) begin	// PipelineVector.scala:60:27
      if ((`PRINTF_COND_) & ~reset)	// PipelineVector.scala:60:27
        $fwrite(32'h80000002, "[DPQ] size %x head %x tail %x enq %x deq %x\n", 1'h0, ringBufferHead, ringBufferTail, enqueueSize, {1'h0, _dequeueSize_T});	// <stdin>:4221:10, Decoupled.scala:52:35, PipelineVector.scala:13:45, :14:45, :23:56, :47:52, :60:27
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, PipelineVector.scala:60:27
        $fwrite(32'h80000002, "[%d] Core: ", c);	// Debug.scala:34:43, GTimer.scala:8:32, PipelineVector.scala:60:27
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:35:31, PipelineVector.scala:60:27
        $fwrite(32'h80000002, "flush = %b, 0: frontend:(%d,%d), backend:(%d,%d); 1: frontend:(%d,%d), backend:(%d,%d)\n", _frontend_io_flushVec, _frontend_io_out_0_valid, _frontend_io_out_0_ready_T_1, _backend_io_in_0_valid_T, _backend_io_in_0_ready, _frontend_io_out_1_valid, _frontend_io_out_1_ready_T_1, _backend_io_in_1_valid_T_1, 1'h0);	// <stdin>:4221:10, Debug.scala:35:31, PipelineVector.scala:33:48, :34:48, :39:46, :44:66, :60:27, TopMain.scala:31:50, :39:37
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4221:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4221:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:4221:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:4221:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4221:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4221:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4221:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_3 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_4 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_5 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_6 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_7 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_8 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_9 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_10 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_11 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_12 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_13 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_14 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_15 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_16 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_17 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_18 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_19 = `RANDOM;	// <stdin>:4221:10
        _RANDOM_20 = `RANDOM;	// <stdin>:4221:10
>>>>>>> tmp
...
=======
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4221:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4221:10
>>>>>>> tmp
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
...
<<<<<<< HEAD
module AXI4Lite_Arbiter(	// <stdin>:4532:10
=======
module AXI4Lite_Arbiter(	// <stdin>:4520:10
>>>>>>> tmp
  input         clock,
                reset,
                InstFetch_ar_valid,
...
<<<<<<< HEAD
  `ifndef SYNTHESIS	// <stdin>:4532:10
=======
  `ifndef SYNTHESIS	// <stdin>:4520:10
>>>>>>> tmp
    always @(posedge clock) begin	// Debug.scala:34:43
...
<<<<<<< HEAD
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4532:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4532:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4532:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4532:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4532:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4532:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:4532:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:4532:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:4532:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:4532:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:4532:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:4532:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:4532:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:4532:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:4532:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:4532:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4532:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4532:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4532:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4532:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4532:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4532:10
        _RANDOM_3 = `RANDOM;	// <stdin>:4532:10
        _RANDOM_4 = `RANDOM;	// <stdin>:4532:10
        _RANDOM_5 = `RANDOM;	// <stdin>:4532:10
        _RANDOM_6 = `RANDOM;	// <stdin>:4532:10
        _RANDOM_7 = `RANDOM;	// <stdin>:4532:10
        _RANDOM_8 = `RANDOM;	// <stdin>:4532:10
        _RANDOM_9 = `RANDOM;	// <stdin>:4532:10
        _RANDOM_10 = `RANDOM;	// <stdin>:4532:10
        _RANDOM_11 = `RANDOM;	// <stdin>:4532:10
        _RANDOM_12 = `RANDOM;	// <stdin>:4532:10
=======
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4520:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4520:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4520:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4520:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4520:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4520:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:4520:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:4520:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:4520:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:4520:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:4520:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:4520:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:4520:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:4520:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:4520:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:4520:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4520:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4520:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4520:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4520:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4520:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4520:10
        _RANDOM_3 = `RANDOM;	// <stdin>:4520:10
        _RANDOM_4 = `RANDOM;	// <stdin>:4520:10
        _RANDOM_5 = `RANDOM;	// <stdin>:4520:10
        _RANDOM_6 = `RANDOM;	// <stdin>:4520:10
        _RANDOM_7 = `RANDOM;	// <stdin>:4520:10
        _RANDOM_8 = `RANDOM;	// <stdin>:4520:10
        _RANDOM_9 = `RANDOM;	// <stdin>:4520:10
        _RANDOM_10 = `RANDOM;	// <stdin>:4520:10
        _RANDOM_11 = `RANDOM;	// <stdin>:4520:10
        _RANDOM_12 = `RANDOM;	// <stdin>:4520:10
>>>>>>> tmp
...
<<<<<<< HEAD
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4532:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4532:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign InstFetch_ar_ready = _GEN_2;	// <stdin>:4532:10, AXI4_Arbiter.scala:32:24, :34:73
  assign InstFetch_r_valid = _GEN_3;	// <stdin>:4532:10, AXI4_Arbiter.scala:32:24, :34:73
  assign InstFetch_r_bits_data = (|state) ? (_T_26 ? Arbiter_r_bits_data : 64'h0) : _GEN ? 64'h0 : Arbiter_r_bits_data;	// <stdin>:4532:10, AXI4.scala:96:27, AXI4_Arbiter.scala:30:28, :32:24, :34:73, :38:46, :44:80, :72:38, GTimer.scala:8:32
  assign LoadStore_aw_ready = Arbiter_aw_ready;	// <stdin>:4532:10
  assign LoadStore_w_ready = Arbiter_w_ready;	// <stdin>:4532:10
  assign LoadStore_b_valid = Arbiter_b_valid;	// <stdin>:4532:10
  assign LoadStore_ar_ready = _GEN_0;	// <stdin>:4532:10, AXI4_Arbiter.scala:32:24, :34:73
  assign LoadStore_r_valid = _GEN_1;	// <stdin>:4532:10, AXI4_Arbiter.scala:32:24, :34:73
  assign LoadStore_r_bits_data = (|state) ? (_T_26 ? 64'h0 : Arbiter_r_bits_data) : _GEN ? Arbiter_r_bits_data : 64'h0;	// <stdin>:4532:10, AXI4.scala:96:27, AXI4_Arbiter.scala:30:28, :32:24, :34:73, :38:46, :39:46, :44:80, GTimer.scala:8:32
  assign Arbiter_aw_valid = LoadStore_aw_valid;	// <stdin>:4532:10
  assign Arbiter_aw_bits_addr = LoadStore_aw_bits_addr;	// <stdin>:4532:10
  assign Arbiter_w_valid = LoadStore_w_valid;	// <stdin>:4532:10
  assign Arbiter_w_bits_data = LoadStore_w_bits_data;	// <stdin>:4532:10
  assign Arbiter_w_bits_strb = LoadStore_w_bits_strb;	// <stdin>:4532:10
  assign Arbiter_b_ready = LoadStore_b_ready;	// <stdin>:4532:10
  assign Arbiter_ar_valid = (|state) ? (_T_26 ? InstFetch_ar_valid : LoadStore_ar_valid) : _GEN ? LoadStore_ar_valid :
                InstFetch_ar_valid;	// <stdin>:4532:10, AXI4_Arbiter.scala:30:28, :32:24, :34:73, :38:46, :44:80, :71:38
  assign Arbiter_ar_bits_addr = (|state) ? (_T_26 ? InstFetch_ar_bits_addr : LoadStore_ar_bits_addr) : _GEN ?
                LoadStore_ar_bits_addr : InstFetch_ar_bits_addr;	// <stdin>:4532:10, AXI4_Arbiter.scala:30:28, :32:24, :34:73, :38:46, :44:80, :71:38
  assign Arbiter_r_ready = (|state) ? (_T_26 ? InstFetch_r_ready : LoadStore_r_ready) : _GEN ? LoadStore_r_ready :
                InstFetch_r_ready;	// <stdin>:4532:10, AXI4_Arbiter.scala:30:28, :32:24, :34:73, :38:46, :39:46, :44:80, :72:38
=======
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4520:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4520:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign InstFetch_ar_ready = _GEN_2;	// <stdin>:4520:10, AXI4_Arbiter.scala:32:24, :34:73
  assign InstFetch_r_valid = _GEN_3;	// <stdin>:4520:10, AXI4_Arbiter.scala:32:24, :34:73
  assign InstFetch_r_bits_data = (|state) ? (_T_26 ? Arbiter_r_bits_data : 64'h0) : _GEN ? 64'h0 : Arbiter_r_bits_data;	// <stdin>:4520:10, AXI4.scala:96:27, AXI4_Arbiter.scala:30:28, :32:24, :34:73, :38:46, :44:80, :72:38, GTimer.scala:8:32
  assign LoadStore_aw_ready = Arbiter_aw_ready;	// <stdin>:4520:10
  assign LoadStore_w_ready = Arbiter_w_ready;	// <stdin>:4520:10
  assign LoadStore_b_valid = Arbiter_b_valid;	// <stdin>:4520:10
  assign LoadStore_ar_ready = _GEN_0;	// <stdin>:4520:10, AXI4_Arbiter.scala:32:24, :34:73
  assign LoadStore_r_valid = _GEN_1;	// <stdin>:4520:10, AXI4_Arbiter.scala:32:24, :34:73
  assign LoadStore_r_bits_data = (|state) ? (_T_26 ? 64'h0 : Arbiter_r_bits_data) : _GEN ? Arbiter_r_bits_data : 64'h0;	// <stdin>:4520:10, AXI4.scala:96:27, AXI4_Arbiter.scala:30:28, :32:24, :34:73, :38:46, :39:46, :44:80, GTimer.scala:8:32
  assign Arbiter_aw_valid = LoadStore_aw_valid;	// <stdin>:4520:10
  assign Arbiter_aw_bits_addr = LoadStore_aw_bits_addr;	// <stdin>:4520:10
  assign Arbiter_w_valid = LoadStore_w_valid;	// <stdin>:4520:10
  assign Arbiter_w_bits_data = LoadStore_w_bits_data;	// <stdin>:4520:10
  assign Arbiter_w_bits_strb = LoadStore_w_bits_strb;	// <stdin>:4520:10
  assign Arbiter_b_ready = LoadStore_b_ready;	// <stdin>:4520:10
  assign Arbiter_ar_valid = (|state) ? (_T_26 ? InstFetch_ar_valid : LoadStore_ar_valid) : _GEN ? LoadStore_ar_valid :
                InstFetch_ar_valid;	// <stdin>:4520:10, AXI4_Arbiter.scala:30:28, :32:24, :34:73, :38:46, :44:80, :71:38
  assign Arbiter_ar_bits_addr = (|state) ? (_T_26 ? InstFetch_ar_bits_addr : LoadStore_ar_bits_addr) : _GEN ?
                LoadStore_ar_bits_addr : InstFetch_ar_bits_addr;	// <stdin>:4520:10, AXI4_Arbiter.scala:30:28, :32:24, :34:73, :38:46, :44:80, :71:38
  assign Arbiter_r_ready = (|state) ? (_T_26 ? InstFetch_r_ready : LoadStore_r_ready) : _GEN ? LoadStore_r_ready :
                InstFetch_r_ready;	// <stdin>:4520:10, AXI4_Arbiter.scala:30:28, :32:24, :34:73, :38:46, :39:46, :44:80, :72:38
>>>>>>> tmp
endmodule
...
<<<<<<< HEAD
module TP_SRAM(	// <stdin>:4760:10
=======
module TP_SRAM(	// <stdin>:4748:10
>>>>>>> tmp
  input         clock,
                reset,
                io_aw_valid,
...
<<<<<<< HEAD
  ...
  `ifndef SYNTHESIS	// <stdin>:4760:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] TP_SRAM: ", c);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "[State] statels %x,%x\n", state_load, state_store);	// Debug.scala:34:43, :35:31, TP_SRAM.scala:31:33, :32:34
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4760:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4760:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4760:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4760:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4760:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4760:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4760:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4760:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4760:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4760:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4760:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4760:10
        state_load = _RANDOM_0[0];	// TP_SRAM.scala:31:33
        state_store = _RANDOM_0[1];	// TP_SRAM.scala:31:33, :32:34
        c = {_RANDOM_0[31:2], _RANDOM_1, _RANDOM_2[1:0]};	// GTimer.scala:8:32, TP_SRAM.scala:31:33
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4760:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4760:10
=======
    end
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:4748:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4748:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4748:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4748:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4748:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4748:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4748:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4748:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4748:10
        state_load = _RANDOM_0[0];	// TP_SRAM.scala:31:33
        state_store = _RANDOM_0[1];	// TP_SRAM.scala:31:33, :32:34
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4748:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4748:10
>>>>>>> tmp
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
...
<<<<<<< HEAD
  assign io_aw_ready = ~state_store;	// <stdin>:4760:10, TP_SRAM.scala:32:34, :44:30
  assign io_w_ready = ~state_store;	// <stdin>:4760:10, TP_SRAM.scala:32:34, :44:30
  assign io_b_valid = state_store;	// <stdin>:4760:10, TP_SRAM.scala:32:34
  assign io_ar_ready = ~state_load;	// <stdin>:4760:10, TP_SRAM.scala:31:33, :34:29
  assign io_r_valid = state_load;	// <stdin>:4760:10, TP_SRAM.scala:31:33
endmodule

module SimTop(	// <stdin>:4840:10
=======
  assign io_aw_ready = ~state_store;	// <stdin>:4748:10, TP_SRAM.scala:32:34, :44:30
  assign io_w_ready = ~state_store;	// <stdin>:4748:10, TP_SRAM.scala:32:34, :44:30
  assign io_b_valid = state_store;	// <stdin>:4748:10, TP_SRAM.scala:32:34
  assign io_ar_ready = ~state_load;	// <stdin>:4748:10, TP_SRAM.scala:31:33, :34:29
  assign io_r_valid = state_load;	// <stdin>:4748:10, TP_SRAM.scala:31:33
endmodule

module SimTop(	// <stdin>:4813:10
>>>>>>> tmp
  input         clock,
                reset,
  output        io_commit,
...
<<<<<<< HEAD
  `ifndef SYNTHESIS	// <stdin>:4840:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4840:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4840:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4840:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4840:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4840:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4840:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4840:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4840:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4840:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4840:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4840:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4840:10
=======
  `ifndef SYNTHESIS	// <stdin>:4813:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4813:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4813:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4813:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4813:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4813:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4813:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4813:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4813:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4813:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4813:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4813:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4813:10
>>>>>>> tmp
...
<<<<<<< HEAD
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4840:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4840:10
=======
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4813:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4813:10
>>>>>>> tmp
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
...
<<<<<<< HEAD
  assign io_commit = io_commit_REG;	// <stdin>:4840:10, SimTop.scala:50:29
  assign io_pc = io_pc_REG;	// <stdin>:4840:10, SimTop.scala:51:25
  assign io_gpr_regs_0 = 64'h0;	// <stdin>:4840:10, SimTop.scala:28:29
=======
  assign io_commit = io_commit_REG;	// <stdin>:4813:10, SimTop.scala:50:29
  assign io_pc = io_pc_REG;	// <stdin>:4813:10, SimTop.scala:51:25
  assign io_gpr_regs_0 = 64'h0;	// <stdin>:4813:10, SimTop.scala:28:29
>>>>>>> tmp
endmodule
