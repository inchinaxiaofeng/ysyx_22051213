...
module MDU(	// <stdin>:2718:10
  ...
  wire [63:0]  res = io_in_bits_ctrl[2] ? (io_in_bits_ctrl[1] ? _div_io_out_bits[127:64] :
                ...
                _mul_io_out_bits[63:0];	// LookupTree.scala:8:38, MDU.scala:33:33, :90:25, :91:25, :105:45, :121:25, :123:32, :124:32, :126:25, :127:21, :128:32, :129:32, :132:22
  always @(posedge clock) begin
    if (reset)
      c <= 64'h0;	// GTimer.scala:8:32
    else
...
module WBU(	// <stdin>:3882:10
  ...
  `ifndef SYNTHESIS	// <stdin>:3882:10
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_wb_rfWen = io_in_bits_decode_ctrl_rfWen & io_in_valid;	// <stdin>:3882:10, WBU.scala:20:53
  assign io_wb_rfDest = io_in_bits_decode_ctrl_rfDest;	// <stdin>:3882:10
  assign io_wb_rfData = io_in_bits_decode_ctrl_fuType > 3'h4 ? io_in_bits_commits_0 : _GEN_0;	// <stdin>:3882:10, WBU.scala:22:22
...
module Core(	// <stdin>:4142:10
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      enqueueSize = {1'h0, _frontend_io_out_0_valid} + {1'h0, _frontend_io_out_1_valid};	// <stdin>:4142:10, PipelineVector.scala:23:56, TopMain.scala:32:50
...
module AXI4Lite_Arbiter(	// <stdin>:4442:10
  ...
  `ifndef SYNTHESIS	// <stdin>:4442:10
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign InstFetch_r_valid = _GEN_1;	// <stdin>:4442:10, AXI4_Arbiter.scala:32:24, :34:73
  assign InstFetch_r_bits_data = _T ? (_GEN ? 64'h0 : Arbiter_r_bits_data) : _T_26 ? Arbiter_r_bits_data : 64'h0;	// <stdin>:4442:10, AXI4.scala:96:27, AXI4_Arbiter.scala:32:24, :34:73, :38:46, :44:80, :72:38, GTimer.scala:8:32
  ...
  assign LoadStore_ar_ready = _T ? _GEN & Arbiter_ar_ready : ~_T_26 & Arbiter_ar_ready;	// <stdin>:4442:10, AXI4_Arbiter.scala:32:24, :34:73, :38:46, :44:80, :73:44
  assign LoadStore_r_valid = _GEN_0;	// <stdin>:4442:10, AXI4_Arbiter.scala:32:24, :34:73
  assign LoadStore_r_bits_data = _T ? (_GEN ? Arbiter_r_bits_data : 64'h0) : _T_26 ? 64'h0 : Arbiter_r_bits_data;	// <stdin>:4442:10, AXI4.scala:96:27, AXI4_Arbiter.scala:32:24, :34:73, :38:46, :39:46, :44:80, GTimer.scala:8:32
  ...
  assign Arbiter_ar_valid = _T ? (_GEN ? LoadStore_ar_valid : InstFetch_ar_valid) : _T_26 ? InstFetch_ar_valid :
                LoadStore_ar_valid;	// <stdin>:4442:10, AXI4_Arbiter.scala:32:24, :34:73, :38:46, :44:80, :71:38
  assign Arbiter_ar_bits_addr = _T ? (_GEN ? LoadStore_ar_bits_addr : InstFetch_ar_bits_addr) : _T_26 ?
                InstFetch_ar_bits_addr : LoadStore_ar_bits_addr;	// <stdin>:4442:10, AXI4_Arbiter.scala:32:24, :34:73, :38:46, :44:80, :71:38
  assign Arbiter_r_ready = _T ? (_GEN ? LoadStore_r_ready : InstFetch_r_ready) : _T_26 ? InstFetch_r_ready :
                LoadStore_r_ready;	// <stdin>:4442:10, AXI4_Arbiter.scala:32:24, :34:73, :38:46, :39:46, :44:80, :72:38
endmodule
