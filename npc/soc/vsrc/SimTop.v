...
module ALU(	// <stdin>:2088:10
  ...
  wire [63:0]  target = io_in_bits_ctrl[3] ? io_cfIn_pc + io_offset : adderRes[63:0];	// ALU.scala:52:40, :78:68, :122:{25,103}
  reg  [63:0]  c;	// GTimer.scala:8:32
  wire         _predictWrong_T_1 = ~taken & io_in_bits_ctrl[3];	// ALU.scala:52:40, :121:76, :125:{32,39}
  reg  [63:0]  c_1;	// GTimer.scala:8:32
  wire [63:0]  _io_redirect_target_T_7 = ~taken & io_in_bits_ctrl[3] ? ((&(io_cfIn_instr[1:0])) ? io_cfIn_pc + 64'h4 : io_cfIn_pc +
                64'h2) : target;	// ALU.scala:52:40, :121:76, :122:25, :125:32, :126:{35,42}, :131:{34,42,58,77,95}
  wire         _T_48 = io_in_valid & io_in_bits_ctrl[4];	// ALU.scala:51:37, :133:36
  wire         _io_redirect_valid_T_1 = _T_48 & ~_predictWrong_T_1;	// ALU.scala:125:{31,39}, :133:{36,45}
  reg  [63:0]  c_2;	// GTimer.scala:8:32
  reg  [63:0]  c_3;	// GTimer.scala:8:32
  ...
  `ifndef SYNTHESIS	// <stdin>:2088:10
    always @(posedge clock) begin	// Debug.scala:34:43
      automatic logic _T_20 = io_in_valid & (&(io_cfIn_instr[1:0])) != (&(io_cfIn_instr[1:0]));	// ALU.scala:126:{35,42}, :128:{21,45,58}
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & _T_20 & ~reset)	// ALU.scala:128:21, Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] ALU: ", c_1);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_20 & ~reset)	// ALU.scala:128:21, Debug.scala:34:43, :35:31
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "[BASE Info] pc %x instr %x pnpc %x caculate target %x redirect target %x\nredirect=valid&isBru&predictWrong(%x&%x&%x)\n", io_cfIn_pc, io_cfIn_instr, io_cfIn_pnpc, target, _io_redirect_target_T_7, io_in_valid, io_in_bits_ctrl[4], ~_predictWrong_T_1);	// ALU.scala:51:37, :122:25, :125:{31,39}, :131:34, Debug.scala:34:43, :35:31
      if ((`PRINTF_COND_) & _T_48 & ~reset)	// ALU.scala:133:36, Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] ALU: ", c_3);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_48 & ~reset)	// ALU.scala:133:36, Debug.scala:34:43, :35:31
      ...
      if ((`PRINTF_COND_) & _T_48 & ~reset)	// ALU.scala:133:36, Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "[BPW] pc %x tgt %x npc %x pdWrong %x type %x%x%x%x\n", io_cfIn_pc, _io_redirect_target_T_7, io_cfIn_pnpc, ~_predictWrong_T_1, io_in_bits_ctrl[3], io_in_bits_ctrl == 7'h58 | io_in_bits_ctrl == 7'h5C, io_in_bits_ctrl == 7'h5A, io_in_bits_ctrl == 7'h5E);	// ALU.scala:52:40, :125:{31,39}, :131:34, :158:{23,39,47}, :159:{22,45}, Debug.scala:34:43, :35:31
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
  ...
  assign io_out_bits = io_in_bits_ctrl[4] ? ((&(io_cfIn_instr[1:0])) ? io_cfIn_pc + 64'h4 : io_cfIn_pc + 64'h2) :
                io_in_bits_ctrl[5] ? {{32{_GEN_0[31]}}, _GEN_0[31:0]} : _GEN_0;	// <stdin>:2088:10, ALU.scala:50:40, :51:37, :106:{25,61}, :126:{35,42}, :131:{77,95}, :145:{27,38,77,114}, BitUtils.scala:17:32, Bitwise.scala:77:12, Mux.scala:81:58
  assign io_redirect_target = _io_redirect_target_T_7;	// <stdin>:2088:10, ALU.scala:131:34
  assign io_redirect_valid = _io_redirect_valid_T_1;	// <stdin>:2088:10, ALU.scala:133:45
endmodule
