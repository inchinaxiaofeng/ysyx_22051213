...
module ALU(	// <stdin>:2065:10
  ...
  wire         _predictWrong_T_1 = _io_redirect_target_T & io_in_bits_ctrl[3];	// ALU.scala:52:40, :120:{32,39}
  reg  [63:0]  c_1;	// GTimer.scala:8:32
  reg  [63:0]  c_2;	// GTimer.scala:8:32
  wire [63:0]  _io_redirect_target_T_7 = _io_redirect_target_T & io_in_bits_ctrl[3] ? ((&(io_cfIn_instr[1:0])) ? io_cfIn_pc + 64'h4
                : io_cfIn_pc + 64'h2) : target;	// ALU.scala:52:40, :117:25, :120:32, :122:{35,42}, :125:{34,42,58,77,95}
  reg  [63:0]  c_3;	// GTimer.scala:8:32
  always @(posedge clock) begin
    if (reset) begin
  ...
  `ifndef SYNTHESIS	// <stdin>:2065:10
    always @(posedge clock) begin	// Debug.scala:34:43
      automatic logic _T_25 = io_in_valid & (&(io_cfIn_instr[1:0])) != (&(io_cfIn_instr[1:0]));	// ALU.scala:122:{35,42}, :124:{21,45,58}
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "predictWrong: %b\n", ~_predictWrong_T_1);	// ALU.scala:120:{31,39}, Debug.scala:34:43, :35:31
      ...
      if ((`PRINTF_COND_) & _T_25 & ~reset)	// ALU.scala:124:21, Debug.scala:34:43
        $fwrite(32'h80000002, "[%d] ALU: ", c_2);	// Debug.scala:34:43, GTimer.scala:8:32
      if ((`PRINTF_COND_) & _T_25 & ~reset)	// ALU.scala:124:21, Debug.scala:34:43, :35:31
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "DEBUG HERE: target %x\n", _io_redirect_target_T_7);	// ALU.scala:125:34, Debug.scala:34:43, :35:31
    end // always @(posedge)
  ...
  assign io_redirect_target = _io_redirect_target_T_7;	// <stdin>:2065:10, ALU.scala:125:34
  assign io_redirect_valid = io_in_valid & io_in_bits_ctrl[4] & ~_predictWrong_T_1;	// <stdin>:2065:10, ALU.scala:51:37, :120:{31,39}, :128:45
endmodule

module LSExecUnit(	// <stdin>:2269:10
  input         clock,
                reset,
                io_in_valid,
  input  [63:0] io_in_bits_srcA,
  ...
  `ifndef SYNTHESIS	// <stdin>:2269:10
    always @(posedge clock) begin	// Debug.scala:34:43
    ...
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2269:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2269:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2269:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2269:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2269:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2269:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2269:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2269:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2269:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2269:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2269:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2269:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2269:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2269:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2269:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2269:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2269:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2269:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2269:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2269:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2269:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2269:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2269:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2269:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2269:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2269:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_out_valid = _io_out_valid_T_10;	// <stdin>:2269:10, UnpipelinedLSU.scala:367:28
  assign io_out_bits = partialLoad ? (io_in_bits_ctrl == 7'h0 ? {{56{_rdataPartialLoad_T_20[7]}},
                ...
                64'h0) : io_dmem_r_bits_data;	// <stdin>:2269:10, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:282:20, :313:36, :399:52, :400:52, :413:27
  assign io_dmem_aw_valid = wValid;	// <stdin>:2269:10, UnpipelinedLSU.scala:357:89
  assign io_dmem_aw_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2269:10, AXI4.scala:73:27
  assign io_dmem_w_valid = wValid;	// <stdin>:2269:10, UnpipelinedLSU.scala:357:89
  assign io_dmem_w_bits_data = ((|(io_in_bits_ctrl[1:0])) ? 64'h0 : {2{{2{{2{io_wdata[7:0]}}}}}}) | (_reqWmask_T_1 ?
                ...
                ((&(io_in_bits_ctrl[1:0])) ? io_wdata : 64'h0);	// <stdin>:2269:10, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:287:48, :288:48, :289:48, :353:24
  assign io_dmem_w_bits_strb = reqWmask[7:0];	// <stdin>:2269:10, AXI4.scala:83:27, UnpipelinedLSU.scala:282:20
  assign io_dmem_ar_valid = io_in_valid & _io_in_ready_T & ~isStore & ~_io_ioLoadAddrMisaligned_T_3 &
                ~_io_ioStoreAddrMisaligned_T_2;	// <stdin>:2269:10, UnpipelinedLSU.scala:312:29, :313:27, :329:24, :357:{64,92}, :358:90, :421:69, :422:69
  assign io_dmem_ar_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2269:10, AXI4.scala:73:27
  assign io_ioLoadAddrMisaligned = _io_ioLoadAddrMisaligned_T_3;	// <stdin>:2269:10, UnpipelinedLSU.scala:421:69
  assign io_ioStoreAddrMisaligned = _io_ioStoreAddrMisaligned_T_2;	// <stdin>:2269:10, UnpipelinedLSU.scala:422:69
endmodule

module UnpipelinedLSU(	// <stdin>:2554:10
  input         clock,
                reset,
                io_in_valid,
  input  [63:0] io_in_bits_srcA,
...
module Multiplier(	// <stdin>:2668:10
  input  [64:0]  io_in_bits_0,
                 io_in_bits_1,
  output [129:0] io_out_bits);

  assign io_out_bits = {{65{io_in_bits_0[64]}}, io_in_bits_0} * {{65{io_in_bits_1[64]}}, io_in_bits_1};	// <stdin>:2668:10, MDU.scala:48:44
endmodule

module Divider(	// <stdin>:2681:10
  ...
  assign io_out_bits = {63'h0, $signed({io_in_bits_0[63], io_in_bits_0}) / $signed({io_in_bits_1[63],
                io_in_bits_1})};	// <stdin>:2681:10, MDU.scala:57:{21,46}
endmodule

module MDU(	// <stdin>:2694:10
  input  [63:0] io_in_bits_srcA,
                io_in_bits_srcB,
  input  [6:0]  io_in_bits_ctrl,
  output [63:0] io_out_bits);
  ...
  assign io_out_bits = io_in_bits_ctrl[3] ? {{32{res[31]}}, res[31:0]} : res;	// <stdin>:2694:10, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, MDU.scala:35:31, :120:18, :121:{27,44}
endmodule

module CSR(	// <stdin>:2803:10
  input         clock,
                reset,
                io_in_valid,
  input  [63:0] io_in_bits_srcA,
  ...
  wire [63:0] _wdata_T_22 = (io_in_bits_ctrl == 7'h1 ? io_in_bits_srcA : 64'h0) | (_justRead_T ? _rdata_T_18 |
                ...
                ~(io_cfIn_instr[19:15])} : 64'h0);	// <stdin>:2803:10, CSR.scala:231:41, :234:43, :235:{43,45}, :237:43, :238:{43,45}, Cat.scala:33:92, LookupTree.scala:8:38, Mux.scala:27:73
  ...
  wire        isIllegalAccess = priviledgeMode < io_in_bits_srcB[9:8] | _wen_T_4 & (&(io_in_bits_srcB[11:10])) &
                ~((_justRead_T | _justRead_T_1) & io_in_bits_srcA == 64'h0);	// <stdin>:2803:10, CSR.scala:212:37, :245:51, :246:{44,50}, :247:{46,72,80}, :248:{42,51,64,67}, :249:45, LookupTree.scala:8:38
  ...
  assign _rdata_T_18 = (_resetSatp_T ? satp : 64'h0) | (_isIllegalAddr_illegalAddr_T_2 ? mcause : 64'h0) |
                ...
                mstatus : 64'h0) | (_isIllegalAddr_illegalAddr_T_8 ? mepc : 64'h0);	// <stdin>:2803:10, CSR.scala:171:34, :172:34, :174:34, :175:34, :205:27, LookupTree.scala:8:38, Mux.scala:27:73
  ...
  always @(posedge clock) begin
    if (reset) begin
      mtvec <= 64'h0;	// <stdin>:2803:10, CSR.scala:171:34
      mcause <= 64'h0;	// <stdin>:2803:10, CSR.scala:172:34
      mepc <= 64'h0;	// <stdin>:2803:10, CSR.scala:174:34
      mstatus <= 64'hA00001800;	// CSR.scala:175:34
      satp <= 64'h0;	// <stdin>:2803:10, CSR.scala:205:27
      ...
      if (~raiseExceptionIntr) begin	// CSR.scala:286:64
        if (_T_21)	// CSR.scala:299:21
          mstatus <= {mstatus[63:13], 2'h0, mstatus[10:8], 1'h1, mstatus[6:4], mstatus[7], mstatus[2:0]};	// <stdin>:2803:10, CSR.scala:175:34, :278:74, :300:59, :306:39
  ...
  `ifndef SYNTHESIS	// <stdin>:2803:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2803:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2803:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2803:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2803:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2803:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2803:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2803:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2803:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2803:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2803:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2803:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2803:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:2803:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:2803:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:2803:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:2803:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2803:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2803:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2803:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2803:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2803:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2803:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2803:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2803:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2803:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2803:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2803:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2803:10
        _RANDOM_9 = `RANDOM;	// <stdin>:2803:10
        _RANDOM_10 = `RANDOM;	// <stdin>:2803:10
        _RANDOM_11 = `RANDOM;	// <stdin>:2803:10
        _RANDOM_12 = `RANDOM;	// <stdin>:2803:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2803:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2803:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_out_bits = _rdata_T_18;	// <stdin>:2803:10, Mux.scala:27:73
  assign io_redirect_target = resetSatp ? io_cfIn_pc + 64'h4 : raiseExceptionIntr ? mtvec : mepc;	// <stdin>:2803:10, CSR.scala:171:34, :174:34, :253:41, :286:64, :291:{34,57,67}
  assign io_redirect_valid = io_in_valid & _io_redirect_valid_T | raiseExceptionIntr | resetSatp;	// <stdin>:2803:10, CSR.scala:253:41, :258:52, :286:64, :289:{37,84}
  assign io_wenFix = |_GEN;	// <stdin>:2803:10, CSR.scala:278:56, :279:48
  assign io_csr_regs_0 = mstatus;	// <stdin>:2803:10, CSR.scala:175:34
  assign io_csr_regs_1 = mtvec;	// <stdin>:2803:10, CSR.scala:171:34
  assign io_csr_regs_2 = mepc;	// <stdin>:2803:10, CSR.scala:174:34
  assign io_csr_regs_3 = mcause;	// <stdin>:2803:10, CSR.scala:172:34
endmodule

module EXU(	// <stdin>:3533:10
  input         clock,
                reset,
                io_in_valid,
  ...
  wire [63:0] _csr_io_redirect_target;	// EXU.scala:58:25
  wire        _csr_io_redirect_valid;	// EXU.scala:58:25
  wire        _csr_io_wenFix;	// EXU.scala:58:25
  wire        _lsu_io_out_valid;	// EXU.scala:43:25
  wire [63:0] _lsu_io_out_bits;	// EXU.scala:43:25
  wire        _lsu_io_ioLoadAddrMisaligned;	// EXU.scala:43:25
  wire        _lsu_io_ioStoreAddrMisaligned;	// EXU.scala:43:25
  ...
  reg  [63:0] c;	// GTimer.scala:8:32
  wire        _io_out_valid_T_4 = io_in_valid & (io_in_bits_ctrl_fuType == 3'h2 | ~_io_out_valid_T | _lsu_io_out_valid);	// EXU.scala:30:63, :43:25, :87:37, Mux.scala:81:58
  always @(posedge clock) begin
    if (reset)
      c <= 64'h0;	// <stdin>:3533:10, GTimer.scala:8:32
    else
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:3533:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
    ...
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3533:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3533:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3533:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3533:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3533:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3533:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3533:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3533:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3533:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3533:10
        c = {_RANDOM_0, _RANDOM_1};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3533:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3533:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  UnpipelinedLSU lsu (	// EXU.scala:43:25
    .clock                    (clock),
    .reset                    (reset),
  ...
  MDU mdu (	// EXU.scala:53:25
    .io_in_bits_srcA (io_in_bits_data_srcA),
    .io_in_bits_srcB (io_in_bits_data_srcB),
    .io_in_bits_ctrl (io_in_bits_ctrl_fuCtrl),
    .io_out_bits     (io_out_bits_commits_2)
  );
  CSR csr (	// EXU.scala:58:25
    .clock                  (clock),
    .reset                  (reset),
    ...
    .io_cfIn_exceptionVec_4 (_lsu_io_ioLoadAddrMisaligned),	// EXU.scala:43:25
    .io_cfIn_exceptionVec_6 (_lsu_io_ioStoreAddrMisaligned),	// EXU.scala:43:25
    .io_instrValid          (io_in_valid & ~io_flush),	// EXU.scala:30:90, :63:42
  ...
  assign io_in_ready = ~io_in_valid | _io_out_valid_T_4;	// <stdin>:3533:10, EXU.scala:87:37, :98:{24,37}
  assign io_out_valid = _io_out_valid_T_4;	// <stdin>:3533:10, EXU.scala:87:37
  assign io_out_bits_decode_cf_instr = io_in_bits_cf_instr;	// <stdin>:3533:10
  assign io_out_bits_decode_cf_pc = io_in_bits_cf_pc;	// <stdin>:3533:10
  assign io_out_bits_decode_cf_redirect_target = _csr_io_redirect_valid ? _csr_io_redirect_target : _alu_io_redirect_target;	// <stdin>:3533:10, EXU.scala:33:25, :58:25, :85:20
  assign io_out_bits_decode_cf_redirect_valid = _csr_io_redirect_valid ? _csr_io_redirect_valid : _alu_io_redirect_valid;	// <stdin>:3533:10, EXU.scala:33:25, :58:25, :85:20
  assign io_out_bits_decode_ctrl_fuType = io_in_bits_ctrl_fuType;	// <stdin>:3533:10
  assign io_out_bits_decode_ctrl_rfWen = io_in_bits_ctrl_rfWen & (~_lsu_io_ioLoadAddrMisaligned & ~_lsu_io_ioStoreAddrMisaligned |
                ~_fuValids_1_T_3) & ~(_csr_io_wenFix & _fuValids_3_T_3);	// <stdin>:3533:10, EXU.scala:30:87, :43:25, :58:25, :76:{57,86,89,119,122,145,148,164}
  assign io_out_bits_decode_ctrl_rfDest = io_in_bits_ctrl_rfDest;	// <stdin>:3533:10
  assign io_out_bits_commits_0 = _alu_io_out_bits;	// <stdin>:3533:10, EXU.scala:33:25
  assign io_out_bits_commits_1 = _lsu_io_out_bits;	// <stdin>:3533:10, EXU.scala:43:25
  assign io_forward_valid = io_in_valid;	// <stdin>:3533:10
  assign io_forward_wb_rfWen = io_in_bits_ctrl_rfWen;	// <stdin>:3533:10
  assign io_forward_wb_rfDest = io_in_bits_ctrl_rfDest;	// <stdin>:3533:10
  assign io_forward_wb_rfData = _alu_io_out_valid ? _alu_io_out_bits : _lsu_io_out_bits;	// <stdin>:3533:10, EXU.scala:33:25, :43:25, :103:36
  assign io_forward_fuType = io_in_bits_ctrl_fuType;	// <stdin>:3533:10
endmodule

module WBU(	// <stdin>:3812:10
  input         clock,
                reset,
                io_in_valid,
  ...
  wire [4:0][63:0] _GEN = {{64'h0}, {io_in_bits_commits_3}, {io_in_bits_commits_2}, {io_in_bits_commits_1},
                {io_in_bits_commits_0}};	// <stdin>:3812:10, WBU.scala:19:22
  ...
  always @(posedge clock) begin
    if (reset) begin
      c <= 64'h0;	// <stdin>:3812:10, GTimer.scala:8:32
      c_1 <= 64'h0;	// <stdin>:3812:10, GTimer.scala:8:32
    end
    else begin
      c <= c + 64'h1;	// GTimer.scala:8:32, :9:24
      c_1 <= c_1 + 64'h1;	// GTimer.scala:8:32, :9:24
  ...
  `ifndef SYNTHESIS	// <stdin>:3812:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & io_in_valid & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "[COMMIT] pc = 0x%x inst %x wen %x wdst %x wdata %x mmio %x intrNO %x\n", io_in_bits_decode_cf_pc, io_in_bits_decode_cf_instr, _io_wb_rfWen_T, io_in_bits_decode_ctrl_rfDest, _GEN_1, 1'h0, 64'h0);	// <stdin>:3812:10, Debug.scala:34:43, :35:31, WBU.scala:17:53, :19:22
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3812:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3812:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3812:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3812:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3812:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:3812:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:3812:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3812:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3812:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3812:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3812:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3812:10
        _RANDOM_2 = `RANDOM;	// <stdin>:3812:10
        _RANDOM_3 = `RANDOM;	// <stdin>:3812:10
        c = {_RANDOM_0, _RANDOM_1};	// GTimer.scala:8:32
        c_1 = {_RANDOM_2, _RANDOM_3};	// GTimer.scala:8:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3812:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3812:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_wb_rfWen = _io_wb_rfWen_T;	// <stdin>:3812:10, WBU.scala:17:53
  assign io_wb_rfDest = io_in_bits_decode_ctrl_rfDest;	// <stdin>:3812:10
  assign io_wb_rfData = _GEN_1;	// <stdin>:3812:10, WBU.scala:19:22
  assign io_redirect_target = io_in_bits_decode_cf_redirect_target;	// <stdin>:3812:10
  assign io_redirect_valid = io_in_bits_decode_cf_redirect_valid & io_in_valid;	// <stdin>:3812:10, WBU.scala:25:66
endmodule

module Backend_inorder(	// <stdin>:3858:10
  input         clock,
                reset,
                io_in_0_valid,
  input  [63:0] io_in_0_bits_cf_instr,
  ...
  always @(posedge clock) begin
    ...
    if (reset) begin
      valid <= 1'h0;	// <stdin>:3858:10, Pipeline.scala:10:28
      valid_1 <= 1'h0;	// <stdin>:3858:10, Pipeline.scala:10:28
      c <= 64'h0;	// <stdin>:3858:10, GTimer.scala:8:32
      c_1 <= 64'h0;	// <stdin>:3858:10, GTimer.scala:8:32
      c_2 <= 64'h0;	// <stdin>:3858:10, GTimer.scala:8:32
    end
    else begin
  ...
  `ifndef SYNTHESIS	// <stdin>:3858:10
    always @(posedge clock) begin	// Debug.scala:34:43
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:34:43, :35:31
        $fwrite(32'h80000002, "flush = %b, isu:(%d,%d), exu:(%d,%d)\n", io_flush, _isu_io_out_valid, _exu_io_in_ready, _exu_io_out_valid, 1'h1);	// <stdin>:3858:10, Backend.scala:25:25, :26:25, Debug.scala:34:43, :35:31
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3858:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3858:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_21;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_22;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_23;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_24;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_25;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_26;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_27;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_28;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_29;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_30;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_31;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_32;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_33;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_34;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_35;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_36;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_37;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_38;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_39;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_40;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_41;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_42;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_43;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_44;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_45;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_46;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_47;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_48;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_49;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_50;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_51;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_52;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_53;	// <stdin>:3858:10
      automatic logic [31:0] _RANDOM_54;	// <stdin>:3858:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3858:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3858:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3858:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_2 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_3 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_4 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_5 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_6 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_7 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_8 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_9 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_10 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_11 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_12 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_13 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_14 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_15 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_16 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_17 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_18 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_19 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_20 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_21 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_22 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_23 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_24 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_25 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_26 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_27 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_28 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_29 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_30 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_31 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_32 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_33 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_34 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_35 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_36 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_37 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_38 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_39 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_40 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_41 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_42 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_43 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_44 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_45 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_46 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_47 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_48 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_49 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_50 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_51 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_52 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_53 = `RANDOM;	// <stdin>:3858:10
        _RANDOM_54 = `RANDOM;	// <stdin>:3858:10
        valid = _RANDOM_0[0];	// Pipeline.scala:10:28
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3858:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3858:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  ...
  assign io_redirect_target = _wbu_io_redirect_target;	// <stdin>:3858:10, Backend.scala:27:25
  assign io_redirect_valid = _wbu_io_redirect_valid;	// <stdin>:3858:10, Backend.scala:27:25
endmodule
...
module Core(	// <stdin>:4092:10
  ...
  wire        ringBufferAllowin = ringBufferHead - 1'h1 != ringBufferTail & {1'h0, ringBufferHead} - 2'h2 != {1'h0,
                ringBufferTail};	// <stdin>:4092:10, PipelineVector.scala:13:45, :14:45, :16:{75,86,137}
  wire [1:0]  enqueueSize = {1'h0, _frontend_io_out_0_valid} + {1'h0, _frontend_io_out_1_valid};	// <stdin>:4092:10, PipelineVector.scala:23:56, TopMain.scala:29:50
  ...
  always @(posedge clock) begin
    if (reset) begin
      dataBuffer_0_cf_instr <= 64'h0;	// <stdin>:4092:10, PipelineVector.scala:12:41
      dataBuffer_0_cf_pc <= 64'h0;	// <stdin>:4092:10, PipelineVector.scala:12:41
      dataBuffer_0_cf_exceptionVec_2 <= 1'h0;	// <stdin>:4092:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_srcAType <= 1'h0;	// <stdin>:4092:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_srcBType <= 1'h0;	// <stdin>:4092:10, PipelineVector.scala:12:41
      ...
      dataBuffer_0_ctrl_rfWen <= 1'h0;	// <stdin>:4092:10, PipelineVector.scala:12:41
      dataBuffer_0_ctrl_rfDest <= 5'h0;	// PipelineVector.scala:12:{41,83}
      dataBuffer_0_data_imm <= 64'h0;	// <stdin>:4092:10, PipelineVector.scala:12:41
      ringBufferHead <= 1'h0;	// <stdin>:4092:10, PipelineVector.scala:13:45
      ringBufferTail <= 1'h0;	// <stdin>:4092:10, PipelineVector.scala:14:45
      c <= 64'h0;	// <stdin>:4092:10, GTimer.scala:8:32
    end
    else begin
  ...
  `ifndef SYNTHESIS	// <stdin>:4092:10
    always @(posedge clock) begin	// PipelineVector.scala:60:27
      if ((`PRINTF_COND_) & ~reset)	// PipelineVector.scala:60:27
        $fwrite(32'h80000002, "[DPQ] size %x head %x tail %x enq %x deq %x\n", 1'h0, ringBufferHead, ringBufferTail, enqueueSize, {1'h0, _dequeueSize_T});	// <stdin>:4092:10, Decoupled.scala:52:35, PipelineVector.scala:13:45, :14:45, :23:56, :47:52, :60:27
      ...
      if ((`PRINTF_COND_) & ~reset)	// Debug.scala:35:31, PipelineVector.scala:60:27
        $fwrite(32'h80000002, "flush = %b, 0: frontend:(%d,%d), backend:(%d,%d); 1: frontend:(%d,%d), backend:(%d,%d)\n", _frontend_io_flushVec, _frontend_io_out_0_valid, _frontend_io_out_0_ready_T_1, _backend_io_in_0_valid_T, _backend_io_in_0_ready, _frontend_io_out_1_valid, _frontend_io_out_1_ready_T_1, _backend_io_in_1_valid_T_1, 1'h0);	// <stdin>:4092:10, Debug.scala:35:31, PipelineVector.scala:33:48, :34:48, :39:46, :44:66, :60:27, TopMain.scala:29:50, :37:37
    end // always @(posedge)
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:4092:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:4092:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:4092:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:4092:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:4092:10
        `INIT_RANDOM_PROLOG_	// <stdin>:4092:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:4092:10
        _RANDOM_0 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_1 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_2 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_3 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_4 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_5 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_6 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_7 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_8 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_9 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_10 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_11 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_12 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_13 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_14 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_15 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_16 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_17 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_18 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_19 = `RANDOM;	// <stdin>:4092:10
        _RANDOM_20 = `RANDOM;	// <stdin>:4092:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:4092:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:4092:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
...
module SimTop(	// <stdin>:4496:10
  ...
  assign io_gpr_regs_0 = 64'h0;	// <stdin>:4496:10, SimTop.scala:26:29
endmodule
