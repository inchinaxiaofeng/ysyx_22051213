...
module LSExecUnit(	// <stdin>:2254:10
  ...
  reg  [63:0] c_2;	// GTimer.scala:8:32
  wire        _reqWmask_T_1 = io_in_bits_ctrl[1:0] == 2'h1;	// LookupTree.scala:8:38, UnpipelinedLSU.scala:193:44, :225:13
  wire        _reqWmask_T_2 = io_in_bits_ctrl[1:0] == 2'h2;	// LookupTree.scala:8:38, UnpipelinedLSU.scala:199:50, :225:13
  wire [14:0] reqWmask = {7'h0, {4'h0, {2'h0, {1'h0, ~(|(io_in_bits_ctrl[1:0]))} | {2{_reqWmask_T_1}}} |
                {4{_reqWmask_T_2}}} | {8{&(io_in_bits_ctrl[1:0])}}} << io_in_bits_srcA[2:0];	// LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:152:{20,27}, :181:32, :187:33, :225:13
  ...
  wire        _addrAligned_T_17 = ~(|(io_in_bits_ctrl[1:0])) | io_in_bits_ctrl[1:0] == 2'h1 & ~(io_in_bits_srcA[0]) |
                ...
                io_in_bits_srcA[2:0] == 3'h0;	// LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:152:27, :187:33, :193:44, :199:50, :225:13, :289:{33,37}, :290:{33,40}, :291:40
  ...
  `ifndef SYNTHESIS	// <stdin>:2254:10
    always @(posedge clock) begin	// Debug.scala:34:43
      ...
      if ((`PRINTF_COND_) & _T_23 & ~reset)	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:223:43
        $fwrite(32'h80000002, "[LSU] addr %x, size %x, wdata_raw %x, isStore %x\n", io_in_bits_srcA, io_in_bits_ctrl[1:0], io_wdata, isStore);	// Debug.scala:34:43, :35:31, UnpipelinedLSU.scala:182:29, :225:13
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_in_ready = _io_in_ready_T & ~state_store;	// <stdin>:2254:10, UnpipelinedLSU.scala:188:34, :236:44, :237:43, :253:47
  assign io_out_valid = _io_out_valid_T_10;	// <stdin>:2254:10, UnpipelinedLSU.scala:245:28
  assign io_out_bits = partialLoad ? (io_in_bits_ctrl == 7'h0 ? {{56{_rdataPartialLoad_T_20[7]}},
                ...
                64'h0) : io_dmem_r_bits_data;	// <stdin>:2254:10, BitUtils.scala:17:32, Bitwise.scala:77:12, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:152:20, :183:36, :280:52, :281:52, :294:27
  assign io_dmem_aw_valid = wValid;	// <stdin>:2254:10, UnpipelinedLSU.scala:236:96
  assign io_dmem_aw_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2254:10, AXI4.scala:73:27
  assign io_dmem_w_valid = wValid;	// <stdin>:2254:10, UnpipelinedLSU.scala:236:96
  assign io_dmem_w_bits_data = ((|(io_in_bits_ctrl[1:0])) ? 64'h0 : {2{{2{{2{io_wdata[7:0]}}}}}}) | (_reqWmask_T_1 ?
                ...
                ((&(io_in_bits_ctrl[1:0])) ? io_wdata : 64'h0);	// <stdin>:2254:10, Cat.scala:33:92, GTimer.scala:8:32, LookupTree.scala:8:38, Mux.scala:27:73, UnpipelinedLSU.scala:157:48, :158:48, :159:48, :225:13
  ...
  assign io_dmem_ar_valid = rValid;	// <stdin>:2254:10, UnpipelinedLSU.scala:237:96
  assign io_dmem_ar_bits_addr = io_in_bits_srcA[31:0];	// <stdin>:2254:10, AXI4.scala:73:27
  assign io_dmem_r_ready = _io_out_valid_T_5;	// <stdin>:2254:10, UnpipelinedLSU.scala:243:36
  assign io_ioLoadAddrMisaligned = _io_ioLoadAddrMisaligned_T_3;	// <stdin>:2254:10, UnpipelinedLSU.scala:302:55
  assign io_ioStoreAddrMisaligned = _io_ioStoreAddrMisaligned_T_2;	// <stdin>:2254:10, UnpipelinedLSU.scala:303:54
endmodule
