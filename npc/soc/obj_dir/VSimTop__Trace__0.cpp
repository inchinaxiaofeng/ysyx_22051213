...
void VSimTop___024root__trace_chg_sub_0(VSimTop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgQData(oldp+45,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__csr__DOT__mtvec),64);
        bufp->chgQData(oldp+47,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__csr__DOT__mcause),64);
        bufp->chgQData(oldp+49,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__csr__DOT__mepc),64);
        bufp->chgQData(oldp+51,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__csr__DOT__mstatus),64);
        bufp->chgQData(oldp+53,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__csr__DOT__satp),64);
        bufp->chgCData(oldp+55,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__csr__DOT__priviledgeMode),2);
        bufp->chgQData(oldp+56,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__lsu__DOT__c),64);
        bufp->chgQData(oldp+58,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__lsu__DOT__c_1),64);
        ...
        bufp->chgQData(oldp+70,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__lsu__DOT__lsExecUnit__DOT__c_3),64);
        bufp->chgQData(oldp+72,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__lsu__DOT__lsExecUnit__DOT__rdataLatch),64);
        bufp->chgQData(oldp+74,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__lsu__DOT__lsExecUnit__DOT__c_4),64);
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgIData(oldp+104,(((IData)(vlSelf->SimTop__DOT__arbiter__DOT___GEN)
        ...
        bufp->chgQData(oldp+109,((QData)((IData)(((IData)(vlSelf->SimTop__DOT__arbiter__DOT___GEN)
                                                   ? (IData)(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__lsu__DOT____Vcellinp__lsExecUnit__io_in_bits_srcA)
    ...
    bufp->chgBit(oldp+341,(vlSelf->io_commit));
    bufp->chgQData(oldp+342,(vlSelf->io_pc),64);
    bufp->chgQData(oldp+344,(vlSelf->io_gpr_regs_0),64);
    bufp->chgQData(oldp+346,(vlSelf->io_gpr_regs_1),64);
    bufp->chgQData(oldp+348,(vlSelf->io_gpr_regs_2),64);
    bufp->chgQData(oldp+350,(vlSelf->io_gpr_regs_3),64);
    bufp->chgQData(oldp+352,(vlSelf->io_gpr_regs_4),64);
    bufp->chgQData(oldp+354,(vlSelf->io_gpr_regs_5),64);
    bufp->chgQData(oldp+356,(vlSelf->io_gpr_regs_6),64);
    bufp->chgQData(oldp+358,(vlSelf->io_gpr_regs_7),64);
    bufp->chgQData(oldp+360,(vlSelf->io_gpr_regs_8),64);
    bufp->chgQData(oldp+362,(vlSelf->io_gpr_regs_9),64);
    bufp->chgQData(oldp+364,(vlSelf->io_gpr_regs_10),64);
    bufp->chgQData(oldp+366,(vlSelf->io_gpr_regs_11),64);
    bufp->chgQData(oldp+368,(vlSelf->io_gpr_regs_12),64);
    bufp->chgQData(oldp+370,(vlSelf->io_gpr_regs_13),64);
    bufp->chgQData(oldp+372,(vlSelf->io_gpr_regs_14),64);
    bufp->chgQData(oldp+374,(vlSelf->io_gpr_regs_15),64);
    bufp->chgQData(oldp+376,(vlSelf->io_gpr_regs_16),64);
    bufp->chgQData(oldp+378,(vlSelf->io_gpr_regs_17),64);
    bufp->chgQData(oldp+380,(vlSelf->io_gpr_regs_18),64);
    bufp->chgQData(oldp+382,(vlSelf->io_gpr_regs_19),64);
    bufp->chgQData(oldp+384,(vlSelf->io_gpr_regs_20),64);
    bufp->chgQData(oldp+386,(vlSelf->io_gpr_regs_21),64);
    bufp->chgQData(oldp+388,(vlSelf->io_gpr_regs_22),64);
    bufp->chgQData(oldp+390,(vlSelf->io_gpr_regs_23),64);
    bufp->chgQData(oldp+392,(vlSelf->io_gpr_regs_24),64);
    bufp->chgQData(oldp+394,(vlSelf->io_gpr_regs_25),64);
    bufp->chgQData(oldp+396,(vlSelf->io_gpr_regs_26),64);
    bufp->chgQData(oldp+398,(vlSelf->io_gpr_regs_27),64);
    bufp->chgQData(oldp+400,(vlSelf->io_gpr_regs_28),64);
    bufp->chgQData(oldp+402,(vlSelf->io_gpr_regs_29),64);
    bufp->chgQData(oldp+404,(vlSelf->io_gpr_regs_30),64);
    bufp->chgQData(oldp+406,(vlSelf->io_gpr_regs_31),64);
    bufp->chgQData(oldp+408,(vlSelf->io_csr_regs_0),64);
    bufp->chgQData(oldp+410,(vlSelf->io_csr_regs_1),64);
    bufp->chgQData(oldp+412,(vlSelf->io_csr_regs_2),64);
    bufp->chgQData(oldp+414,(vlSelf->io_csr_regs_3),64);
    bufp->chgBit(oldp+416,(((IData)(vlSelf->SimTop__DOT__arbiter__DOT___GEN)
    ...
    bufp->chgQData(oldp+421,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT___lsu_io_out_bits),64);
    bufp->chgQData(oldp+423,(vlSelf->SimTop__DOT__core__DOT__backend__DOT___exu_io_forward_wb_rfData),64);
    bufp->chgQData(oldp+425,((((IData)(vlSelf->SimTop__DOT__core__DOT__dataBuffer_0_ctrl_srcAType)
                                ...
                                : 0ULL) | (((IData)(vlSelf->SimTop__DOT__core__DOT__backend__DOT__isu__DOT__srcAForwardNextCycle)
                                           ...
                                           | ((((~ (IData)(vlSelf->SimTop__DOT__core__DOT__backend__DOT__isu__DOT__srcAForwardNextCycle)) 
                                              ...
                                              | (((IData)(vlSelf->SimTop__DOT__core__DOT__dataBuffer_0_ctrl_srcAType) 
                                                 ...
                                                 [vlSelf->SimTop__DOT__core__DOT__dataBuffer_0_ctrl_rfSrcA]))))),64);
    bufp->chgQData(oldp+427,((((IData)(vlSelf->SimTop__DOT__core__DOT__dataBuffer_0_ctrl_srcBType)
