...
void VSimTop___024root__trace_chg_sub_0(VSimTop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgQData(oldp+149,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__alu__DOT___io_redirect_target_T_7),64);
        bufp->chgBit(oldp+151,(((IData)(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT____Vcellinp__alu__io_in_valid) 
                                & ((~ (IData)(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__alu__DOT____VdfgTmp_h2f5e54fc__0)) 
                                   & ((IData)(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu_io_in_bits_r_ctrl_fuCtrl) 
                                      >> 4U)))));
        ...
        bufp->chgQData(oldp+161,(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__alu__DOT__target),64);
        ...
        bufp->chgBit(oldp+290,(((0U == (IData)(vlSelf->SimTop__DOT__core__DOT__frontend__DOT__idu__DOT__decoder1__DOT__decodeList_0)) 
                                & (IData)(vlSelf->SimTop__DOT__core__DOT__frontend__DOT__valid))));
        bufp->chgBit(oldp+291,(((0x37U != (0x7fU & (IData)(vlSelf->SimTop__DOT__core__DOT__frontend__DOT__idu_io_in_0_bits_r_instr))) 
                                & (IData)(vlSelf->SimTop__DOT__core__DOT__frontend__DOT__idu__DOT__decoder1__DOT___srcAType_T_19))));
        bufp->chgBit(oldp+292,(vlSelf->SimTop__DOT__core__DOT__frontend__DOT__idu__DOT__decoder1__DOT___srcBType_T_19));
        bufp->chgCData(oldp+293,(vlSelf->SimTop__DOT__core__DOT__frontend__DOT__idu__DOT__decoder1__DOT__decodeList_1),3);
        bufp->chgCData(oldp+294,(((0U == (IData)(vlSelf->SimTop__DOT__core__DOT__frontend__DOT__idu__DOT__decoder1__DOT__decodeList_1))
        ...
        bufp->chgCData(oldp+295,(((IData)(vlSelf->SimTop__DOT__core__DOT__frontend__DOT__idu__DOT__decoder1__DOT___srcAType_T_19)
                                   ? 0U : (0x1fU & (IData)(
                                                           (vlSelf->SimTop__DOT__core__DOT__frontend__DOT__idu_io_in_0_bits_r_instr 
                                                            >> 0xfU))))),5);
        bufp->chgCData(oldp+296,(((IData)(vlSelf->SimTop__DOT__core__DOT__frontend__DOT__idu__DOT__decoder1__DOT___srcBType_T_19)
                                   ? 0U : (0x1fU & (IData)(
                                                           (vlSelf->SimTop__DOT__core__DOT__frontend__DOT__idu_io_in_0_bits_r_instr 
                                                            >> 0x14U))))),5);
        bufp->chgBit(oldp+297,(vlSelf->SimTop__DOT__core__DOT___frontend_io_out_0_bits_ctrl_rfWen));
        bufp->chgCData(oldp+298,(((IData)(vlSelf->SimTop__DOT__core__DOT___frontend_io_out_0_bits_ctrl_rfWen)
                                   ? (0x1fU & (IData)(
                                                      (vlSelf->SimTop__DOT__core__DOT__frontend__DOT__idu_io_in_0_bits_r_instr 
                                                       >> 7U)))
                                   : 0U)),5);
        bufp->chgQData(oldp+299,(vlSelf->SimTop__DOT__core__DOT___frontend_io_out_0_bits_data_imm),64);
        bufp->chgCData(oldp+301,((0xfU & (- (IData)((IData)(vlSelf->SimTop__DOT__core__DOT__backend__DOT____Vcellinp__isu__io_flush))))),4);
    ...
    bufp->chgQData(oldp+324,(vlSelf->io_gpr_regs_0),64);
    bufp->chgQData(oldp+326,(vlSelf->io_gpr_regs_1),64);
    bufp->chgQData(oldp+328,(vlSelf->io_gpr_regs_2),64);
    bufp->chgQData(oldp+330,(vlSelf->io_gpr_regs_3),64);
    bufp->chgQData(oldp+332,(vlSelf->io_gpr_regs_4),64);
    bufp->chgQData(oldp+334,(vlSelf->io_gpr_regs_5),64);
    bufp->chgQData(oldp+336,(vlSelf->io_gpr_regs_6),64);
    bufp->chgQData(oldp+338,(vlSelf->io_gpr_regs_7),64);
    bufp->chgQData(oldp+340,(vlSelf->io_gpr_regs_8),64);
    bufp->chgQData(oldp+342,(vlSelf->io_gpr_regs_9),64);
    bufp->chgQData(oldp+344,(vlSelf->io_gpr_regs_10),64);
    bufp->chgQData(oldp+346,(vlSelf->io_gpr_regs_11),64);
    bufp->chgQData(oldp+348,(vlSelf->io_gpr_regs_12),64);
    bufp->chgQData(oldp+350,(vlSelf->io_gpr_regs_13),64);
    bufp->chgQData(oldp+352,(vlSelf->io_gpr_regs_14),64);
    bufp->chgQData(oldp+354,(vlSelf->io_gpr_regs_15),64);
    bufp->chgQData(oldp+356,(vlSelf->io_gpr_regs_16),64);
    bufp->chgQData(oldp+358,(vlSelf->io_gpr_regs_17),64);
    bufp->chgQData(oldp+360,(vlSelf->io_gpr_regs_18),64);
    bufp->chgQData(oldp+362,(vlSelf->io_gpr_regs_19),64);
    bufp->chgQData(oldp+364,(vlSelf->io_gpr_regs_20),64);
    bufp->chgQData(oldp+366,(vlSelf->io_gpr_regs_21),64);
    bufp->chgQData(oldp+368,(vlSelf->io_gpr_regs_22),64);
    bufp->chgQData(oldp+370,(vlSelf->io_gpr_regs_23),64);
    bufp->chgQData(oldp+372,(vlSelf->io_gpr_regs_24),64);
    bufp->chgQData(oldp+374,(vlSelf->io_gpr_regs_25),64);
    bufp->chgQData(oldp+376,(vlSelf->io_gpr_regs_26),64);
    bufp->chgQData(oldp+378,(vlSelf->io_gpr_regs_27),64);
    bufp->chgQData(oldp+380,(vlSelf->io_gpr_regs_28),64);
    bufp->chgQData(oldp+382,(vlSelf->io_gpr_regs_29),64);
    bufp->chgQData(oldp+384,(vlSelf->io_gpr_regs_30),64);
    bufp->chgQData(oldp+386,(vlSelf->io_gpr_regs_31),64);
    bufp->chgQData(oldp+388,(vlSelf->io_csr_regs_0),64);
    bufp->chgQData(oldp+390,(vlSelf->io_csr_regs_1),64);
    bufp->chgQData(oldp+392,(vlSelf->io_csr_regs_2),64);
    bufp->chgQData(oldp+394,(vlSelf->io_csr_regs_3),64);
    bufp->chgQData(oldp+396,(vlSelf->SimTop__DOT___TP_SRAM_io_r_bits_data),64);
    bufp->chgBit(oldp+398,((((1U & (~ (IData)(vlSelf->SimTop__DOT__core__DOT__ringBufferHead))) 
                             != (IData)(vlSelf->SimTop__DOT__core__DOT__ringBufferTail)) 
                            & ((3U & ((IData)(vlSelf->SimTop__DOT__core__DOT__ringBufferHead) 
                                      - (IData)(2U))) 
                               != (IData)(vlSelf->SimTop__DOT__core__DOT__ringBufferTail)))));
    bufp->chgBit(oldp+399,((((IData)(vlSelf->SimTop__DOT__core__DOT__ringBufferHead) 
                             != (1U & (~ (IData)(vlSelf->SimTop__DOT__core__DOT__ringBufferTail)))) 
                            & (IData)(vlSelf->SimTop__DOT__core__DOT___backend_io_in_0_valid_T))));
    bufp->chgQData(oldp+400,(((IData)(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT___csr_io_redirect_valid)
    ...
    bufp->chgQData(oldp+402,(((IData)(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__csr__DOT__resetSatp)
                               ? (4ULL + vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu_io_in_bits_r_cf_pc)
                               : ((IData)(vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__csr__DOT__raiseExceptionIntr)
                                   ? vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__csr__DOT__mtvec
                                   : vlSelf->SimTop__DOT__core__DOT__backend__DOT__exu__DOT__csr__DOT__mepc))),64);
    bufp->chgQData(oldp+404,((((IData)(vlSelf->SimTop__DOT__core__DOT__dataBuffer_0_ctrl_srcAType)
                                ...
                                : 0ULL) | (((IData)(vlSelf->SimTop__DOT__core__DOT__backend__DOT__isu__DOT__srcAForwardNextCycle)
                                           ...
                                           | ((((~ (IData)(vlSelf->SimTop__DOT__core__DOT__backend__DOT__isu__DOT__srcAForwardNextCycle)) 
                                              ...
                                              | (((IData)(vlSelf->SimTop__DOT__core__DOT__dataBuffer_0_ctrl_srcAType) 
                                                 ...
                                                 [vlSelf->SimTop__DOT__core__DOT__dataBuffer_0_ctrl_rfSrcA]))))),64);
    bufp->chgQData(oldp+406,((((IData)(vlSelf->SimTop__DOT__core__DOT__dataBuffer_0_ctrl_srcBType)
