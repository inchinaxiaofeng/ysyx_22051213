file://<WORKSPACE>/npc/playground/src/module/fu/UnpipelinedLSU.scala
...
action parameters:
offset: 6316
uri: file://<WORKSPACE>/npc/playground/src/module/fu/UnpipelinedLSU.scala
text:
```scala
package module.fu
...
// =========== new try ==================
	...
	switch (state) {
		is (s_idle) {
			...
			}.elsewhen(dmem.aw.ready && dmem.w.ready)
		}
	}
// =========== end try ==================
