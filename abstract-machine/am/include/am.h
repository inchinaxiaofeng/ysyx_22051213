...
typedef struct Context Context; // 与体系结构相关的处理器上下文（processor context）
...
void     halt        (int code) __attribute__((__noreturn__)); // 停止或暂停处理器执行的指令。

// -------------------- IOE: Input/Output Devices --------------------
bool     ioe_init    (void);
void     ioe_read    (int reg, void *buf);
void     ioe_write   (int reg, void *buf); //在nemu的macro中有定义
#include "amdev.h"
